...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkRowQuery(PyObject *dict); }
extern "C" { PyObject *PyvtkRowQuery_ClassNew(); }


static PyObject *
PyvtkRowQuery_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkRowQuery::IsTypeOf(temp0);
...
static PyObject *
PyvtkRowQuery_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
  ...
  {
    vtkRowQuery *tempr = vtkRowQuery::SafeDownCast(temp0);
...
static PyObject *
PyvtkRowQuery_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkRowQuery::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkRowQuery_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkRowQuery::GetNumberOfGenerationsFromBase(temp0));
...
PyvtkRowQuery_GetFieldType(PyObject *self, PyObject *args)
{
  ...
  if (op && !ap.IsPureVirtual() && ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = op->GetFieldType(temp0);
...
PyvtkRowQuery_GetFieldIndex(PyObject *self, PyObject *args)
{
  ...
  {
    int tempr = (ap.IsBound() ?
      op->GetFieldIndex(temp0) :
      op->vtkRowQuery::GetFieldIndex(temp0));
...
PyvtkRowQuery_DataValue(PyObject *self, PyObject *args)
{
  ...
  if (op && !ap.IsPureVirtual() && ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    vtkVariant tempr = op->DataValue(temp0);
...
PyvtkRowQuery_GetCaseSensitiveFieldNames(PyObject *self, PyObject *args)
{
  ...
  {
    bool tempr = (ap.IsBound() ?
      op->GetCaseSensitiveFieldNames() :
      op->vtkRowQuery::GetCaseSensitiveFieldNames());
...
static PyMethodDef PyvtkRowQuery_Methods[] = {
  ...
  {"DataValue", PyvtkRowQuery_DataValue, METH_VARARGS,
   "DataValue(self, c:int) -> vtkVariant\nC++: virtual vtkVariant DataValue(vtkIdType c)\n\nReturn data in current row, field c\n"},
  {"HasError", PyvtkRowQuery_HasError, METH_VARARGS,
   "HasError(self) -> bool\nC++: virtual bool HasError()\n\nReturns true if an error is set, otherwise false.\n"},
  {"GetLastErrorText", PyvtkRowQuery_GetLastErrorText, METH_VARARGS,
   "GetLastErrorText(self) -> str\nC++: virtual const char *GetLastErrorText()\n\nGet the last error text from the query\n"},
  {"SetCaseSensitiveFieldNames", PyvtkRowQuery_SetCaseSensitiveFieldNames, METH_VARARGS,
  ...
  {"GetCaseSensitiveFieldNames", PyvtkRowQuery_GetCaseSensitiveFieldNames, METH_VARARGS,
   "GetCaseSensitiveFieldNames(self) -> bool\nC++: virtual bool GetCaseSensitiveFieldNames()\n\n"},
  {"CaseSensitiveFieldNamesOn", PyvtkRowQuery_CaseSensitiveFieldNamesOn, METH_VARARGS,
   "CaseSensitiveFieldNamesOn(self) -> None\nC++: virtual void CaseSensitiveFieldNamesOn()\n\n"},
  {"CaseSensitiveFieldNamesOff", PyvtkRowQuery_CaseSensitiveFieldNamesOff, METH_VARARGS,
...
static PyTypeObject PyvtkRowQuery_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkIOSQL.vtkRowQuery", // tp_name
...
PyObject *PyvtkRowQuery_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkRowQuery_Type, PyvtkRowQuery_Methods,
    "vtkRowQuery",
 nullptr);
...
{
  PyObject *o;
  o = PyvtkRowQuery_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkRowQuery", o) != 0)
  {
    Py_DECREF(o);
  }
