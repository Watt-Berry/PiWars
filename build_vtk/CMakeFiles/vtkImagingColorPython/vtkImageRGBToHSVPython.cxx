...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkImageRGBToHSV(PyObject *dict); }
extern "C" { PyObject *PyvtkImageRGBToHSV_ClassNew(); }


static PyObject *
PyvtkImageRGBToHSV_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkImageRGBToHSV_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkImageRGBToHSV_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkImageRGBToHSV::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkImageRGBToHSV_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkImageRGBToHSV::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkImageRGBToHSV_Methods[] = {
  ...
  {"SafeDownCast", PyvtkImageRGBToHSV_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkImageRGBToHSV\nC++: static vtkImageRGBToHSV *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkImageRGBToHSV_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkImageRGBToHSV\nC++: vtkImageRGBToHSV *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkImageRGBToHSV_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkImageRGBToHSV_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkImageRGBToHSV_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkImagingColor.vtkImageRGBToHSV", // tp_name
