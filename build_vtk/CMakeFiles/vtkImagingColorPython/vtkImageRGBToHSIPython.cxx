...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkImageRGBToHSI(PyObject *dict); }
extern "C" { PyObject *PyvtkImageRGBToHSI_ClassNew(); }


static PyObject *
PyvtkImageRGBToHSI_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkImageRGBToHSI::IsTypeOf(temp0);
...
static PyObject *
PyvtkImageRGBToHSI_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkImageRGBToHSI_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkImageRGBToHSI::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkImageRGBToHSI_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkImageRGBToHSI::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkImageRGBToHSI_Methods[] = {
  {"IsTypeOf", PyvtkImageRGBToHSI_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkImageRGBToHSI_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkImageRGBToHSI_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkImageRGBToHSI\nC++: static vtkImageRGBToHSI *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkImageRGBToHSI_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkImageRGBToHSI\nC++: vtkImageRGBToHSI *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkImageRGBToHSI_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkImageRGBToHSI_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SetMaximum", PyvtkImageRGBToHSI_SetMaximum, METH_VARARGS,
  ...
  {"GetMaximum", PyvtkImageRGBToHSI_GetMaximum, METH_VARARGS,
...
static PyTypeObject PyvtkImageRGBToHSI_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkImagingColor.vtkImageRGBToHSI", // tp_name
...
PyObject *PyvtkImageRGBToHSI_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkImageRGBToHSI_Type, PyvtkImageRGBToHSI_Methods,
    "vtkImageRGBToHSI",
 &PyvtkImageRGBToHSI_StaticNew);
...
{
  PyObject *o;
  o = PyvtkImageRGBToHSI_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkImageRGBToHSI", o) != 0)
  {
    Py_DECREF(o);
  }
