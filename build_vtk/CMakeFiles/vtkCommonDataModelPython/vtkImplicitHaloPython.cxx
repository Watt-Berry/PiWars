...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkImplicitHalo(PyObject *dict); }
extern "C" { PyObject *PyvtkImplicitHalo_ClassNew(); }
...
static PyObject *
PyvtkImplicitHalo_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkImplicitHalo::IsTypeOf(temp0);
...
static PyObject *
PyvtkImplicitHalo_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkImplicitHalo_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkImplicitHalo::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkImplicitHalo_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkImplicitHalo::GetNumberOfGenerationsFromBase(temp0));
...
PyvtkImplicitHalo_EvaluateFunction_s2(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp1, "vtkDataArray"))
  {
    ...
    {
      op->vtkImplicitHalo::EvaluateFunction(temp0, temp1);
    }
...
static PyObject *
PyvtkImplicitHalo_EvaluateFunction_s3(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "EvaluateFunction");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkImplicitHalo *op = static_cast<vtkImplicitHalo *>(vp);
...
PyvtkImplicitHalo_EvaluateFunction(PyObject *self, PyObject *args)
{
  ...
  switch(nargs)
  {
    ...
    case 3:
      return PyvtkImplicitHalo_EvaluateFunction_s3(self, args);
  }
...
static PyMethodDef PyvtkImplicitHalo_Methods[] = {
  {"IsTypeOf", PyvtkImplicitHalo_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkImplicitHalo_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkImplicitHalo_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkImplicitHalo\nC++: static vtkImplicitHalo *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkImplicitHalo_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkImplicitHalo\nC++: vtkImplicitHalo *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkImplicitHalo_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkImplicitHalo_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"EvaluateFunction", PyvtkImplicitHalo_EvaluateFunction, METH_VARARGS,
  ...
  {"EvaluateGradient", PyvtkImplicitHalo_EvaluateGradient, METH_VARARGS,
  ...
  {"SetRadius", PyvtkImplicitHalo_SetRadius, METH_VARARGS,
   "SetRadius(self, _arg:float) -> None\nC++: virtual void SetRadius(double _arg)\n\nRadius of the sphere.\n"},
  {"GetRadius", PyvtkImplicitHalo_GetRadius, METH_VARARGS,
   "GetRadius(self) -> float\nC++: virtual double GetRadius()\n\n"},
  {"SetCenter", PyvtkImplicitHalo_SetCenter, METH_VARARGS,
  ...
  {"GetCenter", PyvtkImplicitHalo_GetCenter, METH_VARARGS,
   "GetCenter(self) -> (float, float, float)\nC++: virtual double *GetCenter()\n\n"},
  {"SetFadeOut", PyvtkImplicitHalo_SetFadeOut, METH_VARARGS,
   "SetFadeOut(self, _arg:float) -> None\nC++: virtual void SetFadeOut(double _arg)\n\nFadeOut ratio. Valid values are between 0.0 and 1.0.\n"},
  {"GetFadeOut", PyvtkImplicitHalo_GetFadeOut, METH_VARARGS,
   "GetFadeOut(self) -> float\nC++: virtual double GetFadeOut()\n\n"},
...
static PyTypeObject PyvtkImplicitHalo_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonDataModel.vtkImplicitHalo", // tp_name
...
PyObject *PyvtkImplicitHalo_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkImplicitHalo_Type, PyvtkImplicitHalo_Methods,
    "vtkImplicitHalo",
 &PyvtkImplicitHalo_StaticNew);
...
{
  PyObject *o;
  o = PyvtkImplicitHalo_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkImplicitHalo", o) != 0)
  {
    Py_DECREF(o);
  }
