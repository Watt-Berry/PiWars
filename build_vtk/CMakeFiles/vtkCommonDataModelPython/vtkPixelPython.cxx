...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkPixel(PyObject *dict); }
extern "C" { PyObject *PyvtkPixel_ClassNew(); }
...
static PyObject *
PyvtkPixel_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkPixel::IsTypeOf(temp0);
...
static PyObject *
PyvtkPixel_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPixel_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkPixel::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkPixel_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkPixel::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkPixel_Inflate(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkPixel_ComputeBoundingSphere(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp0, size0))
  {
    ...
    double tempr = (ap.IsBound() ?
      ...
      op->vtkPixel::ComputeBoundingSphere(temp0));
...
static PyObject *
PyvtkPixel_InterpolationFunctions(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPixel_InterpolationDerivs(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPixel_ComputeNormal(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "ComputeNormal");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkPixel *op = static_cast<vtkPixel *>(vp);
      ...
      ap.GetArray(temp0, size0))
  {
    ...
    int tempr = (ap.IsBound() ?
      op->ComputeNormal(temp0) :
      op->vtkPixel::ComputeNormal(temp0));
...
static PyMethodDef PyvtkPixel_Methods[] = {
  {"IsTypeOf", PyvtkPixel_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkPixel_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkPixel_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkPixel\nC++: static vtkPixel *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkPixel_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkPixel\nC++: vtkPixel *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkPixel_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkPixel_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetCellType", PyvtkPixel_GetCellType, METH_VARARGS,
   "GetCellType(self) -> int\nC++: int GetCellType() override;\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {"GetCellDimension", PyvtkPixel_GetCellDimension, METH_VARARGS,
   "GetCellDimension(self) -> int\nC++: int GetCellDimension() override;\n\nReturn the topological dimensional of the cell (0,1,2, or 3).\n"},
  {"GetNumberOfEdges", PyvtkPixel_GetNumberOfEdges, METH_VARARGS,
   "GetNumberOfEdges(self) -> int\nC++: int GetNumberOfEdges() override;\n\nReturn the number of edges in the cell.\n"},
  {"GetNumberOfFaces", PyvtkPixel_GetNumberOfFaces, METH_VARARGS,
   "GetNumberOfFaces(self) -> int\nC++: int GetNumberOfFaces() override;\n\nReturn the number of faces in the cell.\n"},
  {"GetEdge", PyvtkPixel_GetEdge, METH_VARARGS,
   "GetEdge(self, edgeId:int) -> vtkCell\nC++: vtkCell *GetEdge(int edgeId) override;\n\nReturn the edge cell from the edgeId of the cell.\n"},
  {"GetFace", PyvtkPixel_GetFace, METH_VARARGS,
  ...
  {"CellBoundary", PyvtkPixel_CellBoundary, METH_VARARGS,
  ...
  {"Contour", PyvtkPixel_Contour, METH_VARARGS,
  ...
  {"Clip", PyvtkPixel_Clip, METH_VARARGS,
  ...
  {"EvaluatePosition", PyvtkPixel_EvaluatePosition, METH_VARARGS,
  ...
  {"EvaluateLocation", PyvtkPixel_EvaluateLocation, METH_VARARGS,
  ...
  {"Inflate", PyvtkPixel_Inflate, METH_VARARGS,
   "Inflate(self, dist:float) -> int\nC++: int Inflate(double dist) override;\n\nInflates this pixel by a distance of dist by moving the edges of\nthe pixel by that distance. Since a pixel lies in 3D, the\ndegenerate case where the pixel is homogeneous to a line are\ndiscarted because of normal direction ambiguity. Hence, if you\nshrink a 2D pixel so it loses thickness in one dimension.\ninflating it back to its previous form is impossible.\n\nA degenerate pixel of dimension 1 is inflated the same way a\nsegment would be inflated. A degenerate pixel of dimension 0 is\nuntouched.\n\n\\return 1\n"},
  {"ComputeBoundingSphere", PyvtkPixel_ComputeBoundingSphere, METH_VARARGS,
  ...
  {"GetParametricCenter", PyvtkPixel_GetParametricCenter, METH_VARARGS,
   "GetParametricCenter(self, pcoords:[float, float, float]) -> int\nC++: int GetParametricCenter(double pcoords[3]) override;\n\nReturn the center of the triangle in parametric coordinates.\n"},
  {"IntersectWithLine", PyvtkPixel_IntersectWithLine, METH_VARARGS,
  ...
  {"Triangulate", PyvtkPixel_Triangulate, METH_VARARGS,
  ...
  {"Derivatives", PyvtkPixel_Derivatives, METH_VARARGS,
  ...
  {"GetParametricCoords", PyvtkPixel_GetParametricCoords, METH_VARARGS,
  ...
  {"InterpolationFunctions", PyvtkPixel_InterpolationFunctions, METH_VARARGS,
  ...
  {"InterpolationDerivs", PyvtkPixel_InterpolationDerivs, METH_VARARGS,
  ...
  {"InterpolateFunctions", PyvtkPixel_InterpolateFunctions, METH_VARARGS,
  ...
  {"InterpolateDerivs", PyvtkPixel_InterpolateDerivs, METH_VARARGS,
  ...
  {"ComputeNormal", PyvtkPixel_ComputeNormal, METH_VARARGS,
   "ComputeNormal(self, n:[float, float, float]) -> int\nC++: int ComputeNormal(double n[3])\n\nvtkPixel's normal cannot be computed using\nvtkPolygon::ComputeNormal because its points are not sorted such\nthat circulating on them forms the pixel. This is a convenient\nmethod so one can compute normals on a pixel.\n"},
...
static PyTypeObject PyvtkPixel_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonDataModel.vtkPixel", // tp_name
...
PyObject *PyvtkPixel_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkPixel_Type, PyvtkPixel_Methods,
    "vtkPixel",
 &PyvtkPixel_StaticNew);
...
{
  PyObject *o;
  o = PyvtkPixel_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkPixel", o) != 0)
  {
    Py_DECREF(o);
  }
