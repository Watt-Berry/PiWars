...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkStructuredPoints(PyObject *dict); }
extern "C" { PyObject *PyvtkStructuredPoints_ClassNew(); }
...
static PyObject *
PyvtkStructuredPoints_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkStructuredPoints_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkStructuredPoints_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkStructuredPoints::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkStructuredPoints_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkStructuredPoints::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkStructuredPoints_Methods[] = {
  ...
  {"SafeDownCast", PyvtkStructuredPoints_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkStructuredPoints\nC++: static vtkStructuredPoints *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkStructuredPoints_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkStructuredPoints\nC++: vtkStructuredPoints *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkStructuredPoints_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkStructuredPoints_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static const char *PyvtkStructuredPoints_Doc =
  ...
  "extent to exactly match the update extent. Normal image data allows\n"
...
static PyTypeObject PyvtkStructuredPoints_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkCommonDataModel.vtkStructuredPoints", // tp_name
