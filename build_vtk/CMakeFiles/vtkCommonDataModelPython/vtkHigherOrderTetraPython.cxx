// python wrapper for vtkHigherOrderTetra
//
...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkHigherOrderTetra(PyObject *dict); }
...
static PyObject *
PyvtkHigherOrderTetra_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkHigherOrderTetra::IsTypeOf(temp0);
...
static PyObject *
PyvtkHigherOrderTetra_IsA(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "IsA");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkHigherOrderTetra *op = static_cast<vtkHigherOrderTetra *>(vp);
      ...
      ap.GetValue(temp0))
  {
    int tempr = (ap.IsBound() ?
      op->IsA(temp0) :
      op->vtkHigherOrderTetra::IsA(temp0));
...
static PyObject *
PyvtkHigherOrderTetra_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
  ...
  {
    vtkHigherOrderTetra *tempr = vtkHigherOrderTetra::SafeDownCast(temp0);
...
static PyObject *
PyvtkHigherOrderTetra_NewInstance(PyObject *self, PyObject *args)
{
  ...
  {
    vtkHigherOrderTetra *tempr = (ap.IsBound() ?
      op->NewInstance() :
      op->vtkHigherOrderTetra::NewInstance());
...
static PyObject *
PyvtkHigherOrderTetra_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkHigherOrderTetra::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkHigherOrderTetra_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderTetra::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkHigherOrderTetra_GetCellType(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkHigherOrderTetra_GetCellDimension(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      op->GetCellDimension() :
      op->vtkHigherOrderTetra::GetCellDimension());
...
static PyObject *
PyvtkHigherOrderTetra_RequiresInitialization(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderTetra::RequiresInitialization());
...
static PyObject *
PyvtkHigherOrderTetra_GetNumberOfEdges(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      op->GetNumberOfEdges() :
      op->vtkHigherOrderTetra::GetNumberOfEdges());
...
static PyObject *
PyvtkHigherOrderTetra_GetNumberOfFaces(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      op->GetNumberOfFaces() :
      op->vtkHigherOrderTetra::GetNumberOfFaces());
...
static PyObject *
PyvtkHigherOrderTetra_GetEdge(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkHigherOrderTetra_GetFace(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkHigherOrderTetra_Initialize(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    ...
    {
      op->vtkHigherOrderTetra::Initialize();
    }
...
static PyObject *
PyvtkHigherOrderTetra_CellBoundary(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp2, "vtkIdList"))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderTetra::CellBoundary(temp0, temp1, temp2));
...
static PyObject *
PyvtkHigherOrderTetra_EvaluatePosition(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp5, size5))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderTetra::EvaluatePosition(temp0, temp1, temp2, temp3, temp4, temp5));
...
static PyObject *
PyvtkHigherOrderTetra_EvaluateLocation(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp3, size3))
  {
    ...
    {
      op->vtkHigherOrderTetra::EvaluateLocation(temp0, temp1, temp2, temp3);
    }
...
static PyObject *
PyvtkHigherOrderTetra_Contour(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp10, "vtkCellData"))
  {
    ...
    {
      op->vtkHigherOrderTetra::Contour(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9, temp10);
    }
...
static PyObject *
PyvtkHigherOrderTetra_Clip(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp9))
  {
    ...
    {
      op->vtkHigherOrderTetra::Clip(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9);
    }
...
static PyObject *
PyvtkHigherOrderTetra_IntersectWithLine(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp6))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderTetra::IntersectWithLine(temp0, temp1, temp2, temp3, temp4, temp5, temp6));
...
static PyObject *
PyvtkHigherOrderTetra_Triangulate(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp2, "vtkPoints"))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderTetra::Triangulate(temp0, temp1, temp2));
...
static PyObject *
PyvtkHigherOrderTetra_Derivatives(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp4, size4))
  {
    ...
    {
      op->vtkHigherOrderTetra::Derivatives(temp0, temp1, temp2, temp3, temp4);
    }
...
static PyObject *
PyvtkHigherOrderTetra_SetParametricCoords(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    ...
    {
      op->vtkHigherOrderTetra::SetParametricCoords();
    }
...
static PyObject *
PyvtkHigherOrderTetra_GetParametricCoords(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    ...
    double *tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderTetra::GetParametricCoords());
...
static PyObject *
PyvtkHigherOrderTetra_GetParametricCenter(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp0, size0))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderTetra::GetParametricCenter(temp0));
...
static PyObject *
PyvtkHigherOrderTetra_GetParametricDistance(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp0, size0))
  {
    double tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderTetra::GetParametricDistance(temp0));
...
static PyObject *
PyvtkHigherOrderTetra_InterpolateFunctions(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkHigherOrderTetra_InterpolateDerivs(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkHigherOrderTetra_GetOrder(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    long long tempr = (ap.IsBound() ?
      op->GetOrder() :
      op->vtkHigherOrderTetra::GetOrder());
...
static PyObject *
PyvtkHigherOrderTetra_ComputeOrder_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    long long tempr = (ap.IsBound() ?
      op->ComputeOrder() :
      op->vtkHigherOrderTetra::ComputeOrder());
...
static PyObject *
PyvtkHigherOrderTetra_ComputeOrder_s2(PyObject * /*unused*/, PyObject *args)
{
  vtkPythonArgs ap(args, "ComputeOrder");
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkHigherOrderTetra::ComputeOrder(temp0);
...
static PyObject *
PyvtkHigherOrderTetra_ComputeOrder(PyObject *self, PyObject *args)
{
  ...
  {
    case 0:
      return PyvtkHigherOrderTetra_ComputeOrder_s1(self, args);
    case 1:
      return PyvtkHigherOrderTetra_ComputeOrder_s2(self, args);
  }

  vtkPythonArgs::ArgCountError(nargs, "ComputeOrder");
  return nullptr;
}


static PyObject *
PyvtkHigherOrderTetra_PointCountSupportsUniformOrder(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    bool tempr = vtkHigherOrderTetra::PointCountSupportsUniformOrder(temp0);
...
static PyObject *
PyvtkHigherOrderTetra_ToBarycentricIndex(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp1, size1))
  {
    ...
    {
      op->vtkHigherOrderTetra::ToBarycentricIndex(temp0, temp1);
    }
...
static PyObject *
PyvtkHigherOrderTetra_ToIndex(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp0, size0))
  {
    long long tempr = (ap.IsBound() ?
      op->ToIndex(temp0) :
      op->vtkHigherOrderTetra::ToIndex(temp0));
...
static PyObject *
PyvtkHigherOrderTetra_BarycentricIndex(PyObject * /*unused*/, PyObject *args)
{
      ...
      ap.GetValue(temp2))
  {
    ...
    vtkHigherOrderTetra::BarycentricIndex(temp0, temp1, temp2);
...
static PyObject *
PyvtkHigherOrderTetra_Index(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(2) &&
      ...
      ap.GetValue(temp1))
  {
    long long tempr = vtkHigherOrderTetra::Index(temp0, temp1);
...
static PyObject *
PyvtkHigherOrderTetra_GetEdgeCell(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkHigherOrderTetra_GetFaceCell(PyObject *self, PyObject *args)
{
  ...
  if (op && !ap.IsPureVirtual() && ap.CheckArgCount(0))
  {
    vtkHigherOrderTriangle *tempr = op->GetFaceCell();
...
static PyMethodDef PyvtkHigherOrderTetra_Methods[] = {
  {"IsTypeOf", PyvtkHigherOrderTetra_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkHigherOrderTetra_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkHigherOrderTetra_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkHigherOrderTetra\nC++: static vtkHigherOrderTetra *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkHigherOrderTetra_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkHigherOrderTetra\nC++: vtkHigherOrderTetra *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkHigherOrderTetra_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkHigherOrderTetra_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetCellType", PyvtkHigherOrderTetra_GetCellType, METH_VARARGS,
   "GetCellType(self) -> int\nC++: int GetCellType() override = 0;\n\nReturn the type of cell.\n"},
  {"GetCellDimension", PyvtkHigherOrderTetra_GetCellDimension, METH_VARARGS,
   "GetCellDimension(self) -> int\nC++: int GetCellDimension() override;\n\nReturn the topological dimensional of the cell (0,1,2, or 3).\n"},
  {"RequiresInitialization", PyvtkHigherOrderTetra_RequiresInitialization, METH_VARARGS,
  ...
  {"GetNumberOfEdges", PyvtkHigherOrderTetra_GetNumberOfEdges, METH_VARARGS,
   "GetNumberOfEdges(self) -> int\nC++: int GetNumberOfEdges() override;\n\nReturn the number of edges in the cell.\n"},
  {"GetNumberOfFaces", PyvtkHigherOrderTetra_GetNumberOfFaces, METH_VARARGS,
   "GetNumberOfFaces(self) -> int\nC++: int GetNumberOfFaces() override;\n\nReturn the number of faces in the cell.\n"},
  {"GetEdge", PyvtkHigherOrderTetra_GetEdge, METH_VARARGS,
   "GetEdge(self, edgeId:int) -> vtkCell\nC++: vtkCell *GetEdge(int edgeId) override = 0;\n\nReturn the edge cell from the edgeId of the cell.\n"},
  {"GetFace", PyvtkHigherOrderTetra_GetFace, METH_VARARGS,
  ...
  {"Initialize", PyvtkHigherOrderTetra_Initialize, METH_VARARGS,
   "Initialize(self) -> None\nC++: void Initialize() override;\n\n"},
  {"CellBoundary", PyvtkHigherOrderTetra_CellBoundary, METH_VARARGS,
  ...
  {"EvaluatePosition", PyvtkHigherOrderTetra_EvaluatePosition, METH_VARARGS,
  ...
  {"EvaluateLocation", PyvtkHigherOrderTetra_EvaluateLocation, METH_VARARGS,
  ...
  {"Contour", PyvtkHigherOrderTetra_Contour, METH_VARARGS,
  ...
  {"Clip", PyvtkHigherOrderTetra_Clip, METH_VARARGS,
  ...
  {"IntersectWithLine", PyvtkHigherOrderTetra_IntersectWithLine, METH_VARARGS,
  ...
  {"Triangulate", PyvtkHigherOrderTetra_Triangulate, METH_VARARGS,
  ...
  {"Derivatives", PyvtkHigherOrderTetra_Derivatives, METH_VARARGS,
  ...
  {"SetParametricCoords", PyvtkHigherOrderTetra_SetParametricCoords, METH_VARARGS,
   "SetParametricCoords(self) -> None\nC++: void SetParametricCoords()\n\n"},
  {"GetParametricCoords", PyvtkHigherOrderTetra_GetParametricCoords, METH_VARARGS,
  ...
  {"GetParametricCenter", PyvtkHigherOrderTetra_GetParametricCenter, METH_VARARGS,
  ...
  {"GetParametricDistance", PyvtkHigherOrderTetra_GetParametricDistance, METH_VARARGS,
  ...
  {"InterpolateFunctions", PyvtkHigherOrderTetra_InterpolateFunctions, METH_VARARGS,
  ...
  {"InterpolateDerivs", PyvtkHigherOrderTetra_InterpolateDerivs, METH_VARARGS,
   "InterpolateDerivs(self, pcoords:(float, float, float),\n    derivs:[float, ...]) -> None\nC++: void InterpolateDerivs(const double pcoords[3],\n    double *derivs) override = 0;\n\n"},
  {"GetOrder", PyvtkHigherOrderTetra_GetOrder, METH_VARARGS,
   "GetOrder(self) -> int\nC++: vtkIdType GetOrder()\n\n"},
  {"ComputeOrder", PyvtkHigherOrderTetra_ComputeOrder, METH_VARARGS,
   "ComputeOrder(self) -> int\nC++: vtkIdType ComputeOrder()\nComputeOrder(nPoints:int) -> int\nC++: static vtkIdType ComputeOrder(vtkIdType nPoints)\n\n"},
  {"PointCountSupportsUniformOrder", PyvtkHigherOrderTetra_PointCountSupportsUniformOrder, METH_VARARGS,
  ...
  {"ToBarycentricIndex", PyvtkHigherOrderTetra_ToBarycentricIndex, METH_VARARGS,
   "ToBarycentricIndex(self, index:int, bindex:[int, ...]) -> None\nC++: void ToBarycentricIndex(vtkIdType index, vtkIdType *bindex)\n\n"},
  {"ToIndex", PyvtkHigherOrderTetra_ToIndex, METH_VARARGS,
   "ToIndex(self, bindex:(int, ...)) -> int\nC++: vtkIdType ToIndex(const vtkIdType *bindex)\n\n"},
  {"BarycentricIndex", PyvtkHigherOrderTetra_BarycentricIndex, METH_VARARGS,
  ...
  {"Index", PyvtkHigherOrderTetra_Index, METH_VARARGS,
   "Index(bindex:(int, ...), order:int) -> int\nC++: static vtkIdType Index(const vtkIdType *bindex,\n    vtkIdType order)\n\n"},
  {"GetEdgeCell", PyvtkHigherOrderTetra_GetEdgeCell, METH_VARARGS,
   "GetEdgeCell(self) -> vtkHigherOrderCurve\nC++: virtual vtkHigherOrderCurve *GetEdgeCell()\n\n"},
  {"GetFaceCell", PyvtkHigherOrderTetra_GetFaceCell, METH_VARARGS,
   "GetFaceCell(self) -> vtkHigherOrderTriangle\nC++: virtual vtkHigherOrderTriangle *GetFaceCell()\n\n"},
  {nullptr, nullptr, 0, nullptr}
};

static const char *PyvtkHigherOrderTetra_Doc =
  "vtkHigherOrderTetra - A 3D cell that represents an arbitrary order\nHigherOrder tetrahedron\n\n"
  "Superclass: vtkNonLinearCell\n\n"
  "vtkHigherOrderTetra is a concrete implementation of vtkCell to\n"
  "represent a 3D tetrahedron using HigherOrder shape functions of user\n"
  "specified order.\n\n"
...
static PyTypeObject PyvtkHigherOrderTetra_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonDataModel.vtkHigherOrderTetra", // tp_name
  ...
  PyvtkHigherOrderTetra_Doc, // tp_doc
...
PyObject *PyvtkHigherOrderTetra_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkHigherOrderTetra_Type, PyvtkHigherOrderTetra_Methods,
    "vtkHigherOrderTetra",
 nullptr);
...
void PyVTKAddFile_vtkHigherOrderTetra(
  PyObject *dict)
{
  PyObject *o;
  o = PyvtkHigherOrderTetra_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkHigherOrderTetra", o) != 0)
  {
    Py_DECREF(o);
  }
