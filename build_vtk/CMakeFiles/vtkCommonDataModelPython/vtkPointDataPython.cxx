...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkPointData(PyObject *dict); }
extern "C" { PyObject *PyvtkPointData_ClassNew(); }
...
static PyObject *
PyvtkPointData_ExtendedNew(PyObject * /*unused*/, PyObject *args)
{
  ...
  {
    vtkPointData *tempr = vtkPointData::ExtendedNew();
...
static PyObject *
PyvtkPointData_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPointData_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPointData_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkPointData::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkPointData_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkPointData::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkPointData_Methods[] = {
  {"ExtendedNew", PyvtkPointData_ExtendedNew, METH_VARARGS,
   "ExtendedNew() -> vtkPointData\nC++: static vtkPointData *ExtendedNew()\n\n"},
  ...
  {"SafeDownCast", PyvtkPointData_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkPointData\nC++: static vtkPointData *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkPointData_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkPointData\nC++: vtkPointData *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkPointData_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkPointData_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static const char *PyvtkPointData_Doc =
  ...
  "By default, `GhostTypesToSkip` is set to `DUPLICATEPOINT |\n"
  "HIDDENPOINT`. See `vtkDataSetAttributes` for the definition of those\n"
  "constants.\n\n";
...
static PyTypeObject PyvtkPointData_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkCommonDataModel.vtkPointData", // tp_name
