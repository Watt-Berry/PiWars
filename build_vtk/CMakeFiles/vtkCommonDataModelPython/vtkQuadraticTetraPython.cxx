...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkQuadraticTetra(PyObject *dict); }
extern "C" { PyObject *PyvtkQuadraticTetra_ClassNew(); }
...
static PyObject *
PyvtkQuadraticTetra_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkQuadraticTetra::IsTypeOf(temp0);
...
static PyObject *
PyvtkQuadraticTetra_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkQuadraticTetra_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkQuadraticTetra::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkQuadraticTetra_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkQuadraticTetra::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkQuadraticTetra_StableClip(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp9))
  {
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkQuadraticTetra::StableClip(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9));
...
static PyObject *
PyvtkQuadraticTetra_InterpolationFunctions(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkQuadraticTetra_InterpolationDerivs(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkQuadraticTetra_GetEdgeArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkQuadraticTetra::GetEdgeArray(temp0);
...
static PyObject *
PyvtkQuadraticTetra_GetFaceArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkQuadraticTetra::GetFaceArray(temp0);
...
static PyMethodDef PyvtkQuadraticTetra_Methods[] = {
  {"IsTypeOf", PyvtkQuadraticTetra_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkQuadraticTetra_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkQuadraticTetra_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkQuadraticTetra\nC++: static vtkQuadraticTetra *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkQuadraticTetra_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkQuadraticTetra\nC++: vtkQuadraticTetra *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkQuadraticTetra_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkQuadraticTetra_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetCellType", PyvtkQuadraticTetra_GetCellType, METH_VARARGS,
   "GetCellType(self) -> int\nC++: int GetCellType() override;\n\nImplement the vtkCell API. See the vtkCell API for descriptions\nof these methods.\n"},
  {"GetCellDimension", PyvtkQuadraticTetra_GetCellDimension, METH_VARARGS,
   "GetCellDimension(self) -> int\nC++: int GetCellDimension() override;\n\nReturn the topological dimensional of the cell (0,1,2, or 3).\n"},
  {"GetNumberOfEdges", PyvtkQuadraticTetra_GetNumberOfEdges, METH_VARARGS,
   "GetNumberOfEdges(self) -> int\nC++: int GetNumberOfEdges() override;\n\nReturn the number of edges in the cell.\n"},
  {"GetNumberOfFaces", PyvtkQuadraticTetra_GetNumberOfFaces, METH_VARARGS,
   "GetNumberOfFaces(self) -> int\nC++: int GetNumberOfFaces() override;\n\nReturn the number of faces in the cell.\n"},
  {"GetEdge", PyvtkQuadraticTetra_GetEdge, METH_VARARGS,
   "GetEdge(self, __a:int) -> vtkCell\nC++: vtkCell *GetEdge(int) override;\n\nReturn the edge cell from the edgeId of the cell.\n"},
  {"GetFace", PyvtkQuadraticTetra_GetFace, METH_VARARGS,
  ...
  {"CellBoundary", PyvtkQuadraticTetra_CellBoundary, METH_VARARGS,
  ...
  {"Contour", PyvtkQuadraticTetra_Contour, METH_VARARGS,
  ...
  {"EvaluatePosition", PyvtkQuadraticTetra_EvaluatePosition, METH_VARARGS,
  ...
  {"EvaluateLocation", PyvtkQuadraticTetra_EvaluateLocation, METH_VARARGS,
  ...
  {"Triangulate", PyvtkQuadraticTetra_Triangulate, METH_VARARGS,
  ...
  {"Derivatives", PyvtkQuadraticTetra_Derivatives, METH_VARARGS,
  ...
  {"GetParametricCoords", PyvtkQuadraticTetra_GetParametricCoords, METH_VARARGS,
  ...
  {"Clip", PyvtkQuadraticTetra_Clip, METH_VARARGS,
  ...
  {"StableClip", PyvtkQuadraticTetra_StableClip, METH_VARARGS,
   "StableClip(self, value:float, cellScalars:vtkDataArray,\n    locator:vtkIncrementalPointLocator, tetras:vtkCellArray,\n    inPd:vtkPointData, outPd:vtkPointData, inCd:vtkCellData,\n    cellId:int, outCd:vtkCellData, insideOut:int) -> bool\nC++: bool StableClip(double value, vtkDataArray *cellScalars,\n    vtkIncrementalPointLocator *locator, vtkCellArray *tetras,\n    vtkPointData *inPd, vtkPointData *outPd, vtkCellData *inCd,\n    vtkIdType cellId, vtkCellData *outCd, int insideOut) override;\n\nClip this edge using scalar value provided. Like contouring,\nexcept that it cuts the tetra to produce new tetras.\n\nReturns true if newly inserted cell is a quadratic tetra, false\notherwise.\n\n@see vtkNonLinearCell::StableClip\n"},
  {"IntersectWithLine", PyvtkQuadraticTetra_IntersectWithLine, METH_VARARGS,
  ...
  {"GetParametricCenter", PyvtkQuadraticTetra_GetParametricCenter, METH_VARARGS,
  ...
  {"GetParametricDistance", PyvtkQuadraticTetra_GetParametricDistance, METH_VARARGS,
  ...
  {"InterpolationFunctions", PyvtkQuadraticTetra_InterpolationFunctions, METH_VARARGS,
  ...
  {"InterpolationDerivs", PyvtkQuadraticTetra_InterpolationDerivs, METH_VARARGS,
  ...
  {"InterpolateFunctions", PyvtkQuadraticTetra_InterpolateFunctions, METH_VARARGS,
  ...
  {"InterpolateDerivs", PyvtkQuadraticTetra_InterpolateDerivs, METH_VARARGS,
  ...
  {"GetEdgeArray", PyvtkQuadraticTetra_GetEdgeArray, METH_VARARGS,
  ...
  {"GetFaceArray", PyvtkQuadraticTetra_GetFaceArray, METH_VARARGS,
...
static const char *PyvtkQuadraticTetra_Doc =
  ...
  "Note that this class uses an internal linear tessellation for some\n"
...
static PyTypeObject PyvtkQuadraticTetra_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonDataModel.vtkQuadraticTetra", // tp_name
  ...
  PyvtkQuadraticTetra_Doc, // tp_doc
...
PyObject *PyvtkQuadraticTetra_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkQuadraticTetra_Type, PyvtkQuadraticTetra_Methods,
    "vtkQuadraticTetra",
 &PyvtkQuadraticTetra_StaticNew);
...
{
  PyObject *o;
  o = PyvtkQuadraticTetra_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkQuadraticTetra", o) != 0)
  {
    Py_DECREF(o);
  }
