...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkHexahedron(PyObject *dict); }
extern "C" { PyObject *PyvtkHexahedron_ClassNew(); }
...
static PyObject *
PyvtkHexahedron_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkHexahedron_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkHexahedron_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkHexahedron::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkHexahedron_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkHexahedron::GetNumberOfGenerationsFromBase(temp0));
...
PyvtkHexahedron_GetEdgePoints(PyObject *self, PyObject *args)
{
                      ...
                      "0 <= edgeId && edgeId < GetNumberOfEdges()"))
  {
    ...
    {
      op->vtkHexahedron::GetEdgePoints(temp0, temp1c);
    }
...
PyvtkHexahedron_GetFacePoints(PyObject *self, PyObject *args)
{
                      ...
                      "0 <= faceId && faceId < GetNumberOfFaces()"))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkHexahedron::GetFacePoints(temp0, temp1c));
...
static PyObject *
PyvtkHexahedron_GetEdgeToAdjacentFaces(PyObject *self, PyObject *args)
{
                      ...
                      "0 <= edgeId && edgeId < GetNumberOfEdges()"))
  {
    ...
    {
      op->vtkHexahedron::GetEdgeToAdjacentFaces(temp0, temp1c);
    }
...
static PyObject *
PyvtkHexahedron_GetFaceToAdjacentFaces(PyObject *self, PyObject *args)
{
                      ...
                      "0 <= faceId && faceId < GetNumberOfFaces()"))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkHexahedron::GetFaceToAdjacentFaces(temp0, temp1c));
...
static PyObject *
PyvtkHexahedron_GetPointToIncidentEdges(PyObject *self, PyObject *args)
{
                      ...
                      "0 <= pointId && pointId < GetNumberOfPoints()"))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkHexahedron::GetPointToIncidentEdges(temp0, temp1c));
...
static PyObject *
PyvtkHexahedron_GetPointToIncidentFaces(PyObject *self, PyObject *args)
{
                      ...
                      "0 <= pointId && pointId < GetNumberOfPoints()"))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkHexahedron::GetPointToIncidentFaces(temp0, temp1c));
...
static PyObject *
PyvtkHexahedron_GetPointToOneRingPoints(PyObject *self, PyObject *args)
{
                      ...
                      "0 <= pointId && pointId < GetNumberOfPoints()"))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkHexahedron::GetPointToOneRingPoints(temp0, temp1c));
...
static PyObject *
PyvtkHexahedron_GetCentroid(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp0, size0))
  {
    ...
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkHexahedron::GetCentroid(temp0));
...
static PyObject *
PyvtkHexahedron_GetTriangleCases(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int *tempr = vtkHexahedron::GetTriangleCases(temp0);
...
static PyObject *
PyvtkHexahedron_InterpolationFunctions(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkHexahedron_InterpolationDerivs(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkHexahedron_GetEdgeArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkHexahedron::GetEdgeArray(temp0);
...
static PyObject *
PyvtkHexahedron_GetFaceArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkHexahedron::GetFaceArray(temp0);
...
static PyObject *
PyvtkHexahedron_GetEdgeToAdjacentFacesArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkHexahedron::GetEdgeToAdjacentFacesArray(temp0);
...
static PyObject *
PyvtkHexahedron_GetFaceToAdjacentFacesArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkHexahedron::GetFaceToAdjacentFacesArray(temp0);
...
static PyObject *
PyvtkHexahedron_GetPointToIncidentEdgesArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkHexahedron::GetPointToIncidentEdgesArray(temp0);
...
static PyObject *
PyvtkHexahedron_GetPointToIncidentFacesArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkHexahedron::GetPointToIncidentFacesArray(temp0);
...
static PyObject *
PyvtkHexahedron_GetPointToOneRingPointsArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkHexahedron::GetPointToOneRingPointsArray(temp0);
...
static PyObject *
PyvtkHexahedron_ComputeCentroid(PyObject * /*unused*/, PyObject *args)
{
      ...
      ap.GetArray(temp2, size2))
  {
    ...
    bool tempr = vtkHexahedron::ComputeCentroid(temp0, temp1, temp2);
...
static PyMethodDef PyvtkHexahedron_Methods[] = {
  ...
  {"SafeDownCast", PyvtkHexahedron_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkHexahedron\nC++: static vtkHexahedron *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkHexahedron_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkHexahedron\nC++: vtkHexahedron *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkHexahedron_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkHexahedron_GetNumberOfGenerationsFromBase, METH_VARARGS,
  ...
  {"GetEdgeToAdjacentFaces", PyvtkHexahedron_GetEdgeToAdjacentFaces, METH_VARARGS,
  ...
  {"GetFaceToAdjacentFaces", PyvtkHexahedron_GetFaceToAdjacentFaces, METH_VARARGS,
  ...
  {"GetPointToIncidentEdges", PyvtkHexahedron_GetPointToIncidentEdges, METH_VARARGS,
  ...
  {"GetPointToIncidentFaces", PyvtkHexahedron_GetPointToIncidentFaces, METH_VARARGS,
  ...
  {"GetPointToOneRingPoints", PyvtkHexahedron_GetPointToOneRingPoints, METH_VARARGS,
  ...
  {"GetCentroid", PyvtkHexahedron_GetCentroid, METH_VARARGS,
  ...
  {"GetTriangleCases", PyvtkHexahedron_GetTriangleCases, METH_VARARGS,
...
static PyTypeObject PyvtkHexahedron_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkCommonDataModel.vtkHexahedron", // tp_name
