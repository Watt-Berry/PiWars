...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkTriangleStrip(PyObject *dict); }
extern "C" { PyObject *PyvtkTriangleStrip_ClassNew(); }
...
static PyObject *
PyvtkTriangleStrip_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkTriangleStrip::IsTypeOf(temp0);
...
static PyObject *
PyvtkTriangleStrip_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkTriangleStrip_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkTriangleStrip::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkTriangleStrip_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkTriangleStrip::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkTriangleStrip_DecomposeStrip(PyObject * /*unused*/, PyObject *args)
{
...
static PyMethodDef PyvtkTriangleStrip_Methods[] = {
  {"IsTypeOf", PyvtkTriangleStrip_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkTriangleStrip_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkTriangleStrip_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkTriangleStrip\nC++: static vtkTriangleStrip *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkTriangleStrip_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkTriangleStrip\nC++: vtkTriangleStrip *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkTriangleStrip_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkTriangleStrip_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetCellType", PyvtkTriangleStrip_GetCellType, METH_VARARGS,
   "GetCellType(self) -> int\nC++: int GetCellType() override;\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {"GetCellDimension", PyvtkTriangleStrip_GetCellDimension, METH_VARARGS,
   "GetCellDimension(self) -> int\nC++: int GetCellDimension() override;\n\nReturn the topological dimensional of the cell (0,1,2, or 3).\n"},
  {"GetNumberOfEdges", PyvtkTriangleStrip_GetNumberOfEdges, METH_VARARGS,
   "GetNumberOfEdges(self) -> int\nC++: int GetNumberOfEdges() override;\n\nReturn the number of edges in the cell.\n"},
  {"GetNumberOfFaces", PyvtkTriangleStrip_GetNumberOfFaces, METH_VARARGS,
   "GetNumberOfFaces(self) -> int\nC++: int GetNumberOfFaces() override;\n\nReturn the number of faces in the cell.\n"},
  {"GetEdge", PyvtkTriangleStrip_GetEdge, METH_VARARGS,
   "GetEdge(self, edgeId:int) -> vtkCell\nC++: vtkCell *GetEdge(int edgeId) override;\n\nReturn the edge cell from the edgeId of the cell.\n"},
  {"GetFace", PyvtkTriangleStrip_GetFace, METH_VARARGS,
  ...
  {"CellBoundary", PyvtkTriangleStrip_CellBoundary, METH_VARARGS,
  ...
  {"Contour", PyvtkTriangleStrip_Contour, METH_VARARGS,
  ...
  {"Clip", PyvtkTriangleStrip_Clip, METH_VARARGS,
  ...
  {"EvaluatePosition", PyvtkTriangleStrip_EvaluatePosition, METH_VARARGS,
  ...
  {"EvaluateLocation", PyvtkTriangleStrip_EvaluateLocation, METH_VARARGS,
  ...
  {"IntersectWithLine", PyvtkTriangleStrip_IntersectWithLine, METH_VARARGS,
  ...
  {"Triangulate", PyvtkTriangleStrip_Triangulate, METH_VARARGS,
  ...
  {"Derivatives", PyvtkTriangleStrip_Derivatives, METH_VARARGS,
  ...
  {"IsPrimaryCell", PyvtkTriangleStrip_IsPrimaryCell, METH_VARARGS,
  ...
  {"GetParametricCenter", PyvtkTriangleStrip_GetParametricCenter, METH_VARARGS,
   "GetParametricCenter(self, pcoords:[float, float, float]) -> int\nC++: int GetParametricCenter(double pcoords[3]) override;\n\nReturn the center of the point cloud in parametric coordinates.\n"},
  {"DecomposeStrip", PyvtkTriangleStrip_DecomposeStrip, METH_VARARGS,
   "DecomposeStrip(npts:int, pts:(int, ...), tris:vtkCellArray)\n    -> None\nC++: static void DecomposeStrip(int npts, const vtkIdType *pts,\n    vtkCellArray *tris)\n\nGiven a triangle strip, decompose it into a list of (triangle)\npolygons. The polygons are appended to the end of the list of\ntriangles.\n"},
...
static PyTypeObject PyvtkTriangleStrip_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonDataModel.vtkTriangleStrip", // tp_name
...
PyObject *PyvtkTriangleStrip_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkTriangleStrip_Type, PyvtkTriangleStrip_Methods,
    "vtkTriangleStrip",
 &PyvtkTriangleStrip_StaticNew);
...
{
  PyObject *o;
  o = PyvtkTriangleStrip_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkTriangleStrip", o) != 0)
  {
    Py_DECREF(o);
  }
