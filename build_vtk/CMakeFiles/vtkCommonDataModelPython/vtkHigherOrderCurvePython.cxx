// python wrapper for vtkHigherOrderCurve
//
...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkHigherOrderCurve(PyObject *dict); }
extern "C" { PyObject *PyvtkHigherOrderCurve_ClassNew(); }
...
static PyObject *
PyvtkHigherOrderCurve_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkHigherOrderCurve::IsTypeOf(temp0);
...
static PyObject *
PyvtkHigherOrderCurve_IsA(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "IsA");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkHigherOrderCurve *op = static_cast<vtkHigherOrderCurve *>(vp);
      ...
      ap.GetValue(temp0))
  {
    int tempr = (ap.IsBound() ?
      op->IsA(temp0) :
      op->vtkHigherOrderCurve::IsA(temp0));
...
static PyObject *
PyvtkHigherOrderCurve_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
  ...
  {
    vtkHigherOrderCurve *tempr = vtkHigherOrderCurve::SafeDownCast(temp0);
...
static PyObject *
PyvtkHigherOrderCurve_NewInstance(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    vtkHigherOrderCurve *tempr = (ap.IsBound() ?
      op->NewInstance() :
      op->vtkHigherOrderCurve::NewInstance());
...
static PyObject *
PyvtkHigherOrderCurve_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkHigherOrderCurve::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkHigherOrderCurve_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderCurve::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkHigherOrderCurve_GetCellType(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkHigherOrderCurve_GetCellDimension(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      op->GetCellDimension() :
      op->vtkHigherOrderCurve::GetCellDimension());
...
static PyObject *
PyvtkHigherOrderCurve_RequiresInitialization(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderCurve::RequiresInitialization());
...
static PyObject *
PyvtkHigherOrderCurve_GetNumberOfEdges(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      op->GetNumberOfEdges() :
      op->vtkHigherOrderCurve::GetNumberOfEdges());
...
static PyObject *
PyvtkHigherOrderCurve_GetNumberOfFaces(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      op->GetNumberOfFaces() :
      op->vtkHigherOrderCurve::GetNumberOfFaces());
...
static PyObject *
PyvtkHigherOrderCurve_GetEdge(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    vtkCell *tempr = (ap.IsBound() ?
      op->GetEdge(temp0) :
      op->vtkHigherOrderCurve::GetEdge(temp0));
...
static PyObject *
PyvtkHigherOrderCurve_GetFace(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    vtkCell *tempr = (ap.IsBound() ?
      op->GetFace(temp0) :
      op->vtkHigherOrderCurve::GetFace(temp0));
...
static PyObject *
PyvtkHigherOrderCurve_Initialize(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    ...
    {
      op->vtkHigherOrderCurve::Initialize();
    }
...
static PyObject *
PyvtkHigherOrderCurve_CellBoundary(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp2, "vtkIdList"))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderCurve::CellBoundary(temp0, temp1, temp2));
...
static PyObject *
PyvtkHigherOrderCurve_EvaluatePosition(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp5, size5))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderCurve::EvaluatePosition(temp0, temp1, temp2, temp3, temp4, temp5));
...
static PyObject *
PyvtkHigherOrderCurve_EvaluateLocation(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp3, size3))
  {
    ...
    {
      op->vtkHigherOrderCurve::EvaluateLocation(temp0, temp1, temp2, temp3);
    }
...
static PyObject *
PyvtkHigherOrderCurve_Contour(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp10, "vtkCellData"))
  {
    ...
    {
      op->vtkHigherOrderCurve::Contour(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9, temp10);
    }
...
static PyObject *
PyvtkHigherOrderCurve_Clip(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp9))
  {
    ...
    {
      op->vtkHigherOrderCurve::Clip(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9);
    }
...
static PyObject *
PyvtkHigherOrderCurve_IntersectWithLine(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp6))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderCurve::IntersectWithLine(temp0, temp1, temp2, temp3, temp4, temp5, temp6));
...
static PyObject *
PyvtkHigherOrderCurve_Triangulate(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp2, "vtkPoints"))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderCurve::Triangulate(temp0, temp1, temp2));
...
static PyObject *
PyvtkHigherOrderCurve_Derivatives(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp4, size4))
  {
    ...
    {
      op->vtkHigherOrderCurve::Derivatives(temp0, temp1, temp2, temp3, temp4);
    }
...
static PyObject *
PyvtkHigherOrderCurve_SetParametricCoords(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    ...
    {
      op->vtkHigherOrderCurve::SetParametricCoords();
    }
...
static PyObject *
PyvtkHigherOrderCurve_GetParametricCoords(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    ...
    double *tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderCurve::GetParametricCoords());
...
static PyObject *
PyvtkHigherOrderCurve_GetParametricCenter(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp0, size0))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderCurve::GetParametricCenter(temp0));
...
static PyObject *
PyvtkHigherOrderCurve_GetParametricDistance(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp0, size0))
  {
    double tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderCurve::GetParametricDistance(temp0));
...
static PyObject *
PyvtkHigherOrderCurve_GetOrder_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    const int *tempr = (ap.IsBound() ?
      op->GetOrder() :
      op->vtkHigherOrderCurve::GetOrder());
...
static PyObject *
PyvtkHigherOrderCurve_GetOrder_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "GetOrder");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkHigherOrderCurve *op = static_cast<vtkHigherOrderCurve *>(vp);
      ...
      ap.GetValue(temp0))
  {
    int tempr = (ap.IsBound() ?
      op->GetOrder(temp0) :
      op->vtkHigherOrderCurve::GetOrder(temp0));
...
static PyObject *
PyvtkHigherOrderCurve_GetOrder(PyObject *self, PyObject *args)
{
  ...
  {
    case 0:
      return PyvtkHigherOrderCurve_GetOrder_s1(self, args);
    case 1:
      return PyvtkHigherOrderCurve_GetOrder_s2(self, args);
  }
...
static PyObject *
PyvtkHigherOrderCurve_PointCountSupportsUniformOrder(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    bool tempr = vtkHigherOrderCurve::PointCountSupportsUniformOrder(temp0);
...
static PyObject *
PyvtkHigherOrderCurve_InterpolateFunctions(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkHigherOrderCurve_InterpolateDerivs(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkHigherOrderCurve_SubCellCoordinatesFromId_s1(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp1))
  {
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderCurve::SubCellCoordinatesFromId(*temp0, temp1));
...
static PyObject *
PyvtkHigherOrderCurve_SubCellCoordinatesFromId_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "SubCellCoordinatesFromId");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkHigherOrderCurve *op = static_cast<vtkHigherOrderCurve *>(vp);
...
static PyMethodDef PyvtkHigherOrderCurve_SubCellCoordinatesFromId_Methods[] = {
  {"SubCellCoordinatesFromId", PyvtkHigherOrderCurve_SubCellCoordinatesFromId_s1, METH_VARARGS,
   "@Wi &vtkVector3i"},
  {"SubCellCoordinatesFromId", PyvtkHigherOrderCurve_SubCellCoordinatesFromId_s2, METH_VARARGS,
   "@ii"},
  {nullptr, nullptr, 0, nullptr}
};

static PyObject *
PyvtkHigherOrderCurve_SubCellCoordinatesFromId(PyObject *self, PyObject *args)
{
  PyMethodDef *methods = PyvtkHigherOrderCurve_SubCellCoordinatesFromId_Methods;
  int nargs = vtkPythonArgs::GetArgCount(self, args);
...
static PyObject *
PyvtkHigherOrderCurve_PointIndexFromIJK(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp2))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderCurve::PointIndexFromIJK(temp0, temp1, temp2));
...
static PyObject *
PyvtkHigherOrderCurve_TransformApproxToCellParams(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp1, size1))
  {
    ...
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderCurve::TransformApproxToCellParams(temp0, temp1));
...
static PyMethodDef PyvtkHigherOrderCurve_Methods[] = {
  {"IsTypeOf", PyvtkHigherOrderCurve_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkHigherOrderCurve_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkHigherOrderCurve_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkHigherOrderCurve\nC++: static vtkHigherOrderCurve *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkHigherOrderCurve_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkHigherOrderCurve\nC++: vtkHigherOrderCurve *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkHigherOrderCurve_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkHigherOrderCurve_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetCellType", PyvtkHigherOrderCurve_GetCellType, METH_VARARGS,
   "GetCellType(self) -> int\nC++: int GetCellType() override = 0;\n\nReturn the type of cell.\n"},
  {"GetCellDimension", PyvtkHigherOrderCurve_GetCellDimension, METH_VARARGS,
   "GetCellDimension(self) -> int\nC++: int GetCellDimension() override;\n\nReturn the topological dimensional of the cell (0,1,2, or 3).\n"},
  {"RequiresInitialization", PyvtkHigherOrderCurve_RequiresInitialization, METH_VARARGS,
  ...
  {"GetNumberOfEdges", PyvtkHigherOrderCurve_GetNumberOfEdges, METH_VARARGS,
   "GetNumberOfEdges(self) -> int\nC++: int GetNumberOfEdges() override;\n\nReturn the number of edges in the cell.\n"},
  {"GetNumberOfFaces", PyvtkHigherOrderCurve_GetNumberOfFaces, METH_VARARGS,
   "GetNumberOfFaces(self) -> int\nC++: int GetNumberOfFaces() override;\n\nReturn the number of faces in the cell.\n"},
  {"GetEdge", PyvtkHigherOrderCurve_GetEdge, METH_VARARGS,
   "GetEdge(self, __a:int) -> vtkCell\nC++: vtkCell *GetEdge(int) override;\n\nReturn the edge cell from the edgeId of the cell.\n"},
  {"GetFace", PyvtkHigherOrderCurve_GetFace, METH_VARARGS,
  ...
  {"Initialize", PyvtkHigherOrderCurve_Initialize, METH_VARARGS,
   "Initialize(self) -> None\nC++: void Initialize() override;\n\n"},
  {"CellBoundary", PyvtkHigherOrderCurve_CellBoundary, METH_VARARGS,
  ...
  {"EvaluatePosition", PyvtkHigherOrderCurve_EvaluatePosition, METH_VARARGS,
  ...
  {"EvaluateLocation", PyvtkHigherOrderCurve_EvaluateLocation, METH_VARARGS,
  ...
  {"Contour", PyvtkHigherOrderCurve_Contour, METH_VARARGS,
  ...
  {"Clip", PyvtkHigherOrderCurve_Clip, METH_VARARGS,
  ...
  {"IntersectWithLine", PyvtkHigherOrderCurve_IntersectWithLine, METH_VARARGS,
  ...
  {"Triangulate", PyvtkHigherOrderCurve_Triangulate, METH_VARARGS,
  ...
  {"Derivatives", PyvtkHigherOrderCurve_Derivatives, METH_VARARGS,
  ...
  {"SetParametricCoords", PyvtkHigherOrderCurve_SetParametricCoords, METH_VARARGS,
   "SetParametricCoords(self) -> None\nC++: void SetParametricCoords()\n\n"},
  {"GetParametricCoords", PyvtkHigherOrderCurve_GetParametricCoords, METH_VARARGS,
  ...
  {"GetParametricCenter", PyvtkHigherOrderCurve_GetParametricCenter, METH_VARARGS,
  ...
  {"GetParametricDistance", PyvtkHigherOrderCurve_GetParametricDistance, METH_VARARGS,
  ...
  {"InterpolateDerivs", PyvtkHigherOrderCurve_InterpolateDerivs, METH_VARARGS,
   "InterpolateDerivs(self, pcoords:(float, float, float),\n    derivs:[float, ...]) -> None\nC++: void InterpolateDerivs(const double pcoords[3],\n    double *derivs) override = 0;\n\n"},
  {"SubCellCoordinatesFromId", PyvtkHigherOrderCurve_SubCellCoordinatesFromId, METH_VARARGS,
   "SubCellCoordinatesFromId(self, ijk:vtkVector3i, subId:int) -> bool\nC++: bool SubCellCoordinatesFromId(vtkVector3i &ijk, int subId)\nSubCellCoordinatesFromId(self, i:int, subId:int) -> bool\nC++: bool SubCellCoordinatesFromId(int &i, int subId)\n\n"},
  {"PointIndexFromIJK", PyvtkHigherOrderCurve_PointIndexFromIJK, METH_VARARGS,
   "PointIndexFromIJK(self, i:int, __b:int, __c:int) -> int\nC++: int PointIndexFromIJK(int i, int, int)\n\n"},
  {"TransformApproxToCellParams", PyvtkHigherOrderCurve_TransformApproxToCellParams, METH_VARARGS,
   "TransformApproxToCellParams(self, subCell:int, pcoords:[float,\n    ...]) -> bool\nC++: bool TransformApproxToCellParams(int subCell,\n    double *pcoords)\n\n"},
  {nullptr, nullptr, 0, nullptr}
};

static const char *PyvtkHigherOrderCurve_Doc =
  "vtkHigherOrderCurve\n\n"
...
static PyTypeObject PyvtkHigherOrderCurve_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonDataModel.vtkHigherOrderCurve", // tp_name
  ...
  PyvtkHigherOrderCurve_Doc, // tp_doc
...
PyObject *PyvtkHigherOrderCurve_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkHigherOrderCurve_Type, PyvtkHigherOrderCurve_Methods,
    "vtkHigherOrderCurve",
 nullptr);
...
void PyVTKAddFile_vtkHigherOrderCurve(
  PyObject *dict)
{
  PyObject *o;
  o = PyvtkHigherOrderCurve_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkHigherOrderCurve", o) != 0)
  {
    Py_DECREF(o);
  }
