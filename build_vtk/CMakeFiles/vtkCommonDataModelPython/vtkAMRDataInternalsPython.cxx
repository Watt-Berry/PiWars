...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkAMRDataInternals(PyObject *dict); }
extern "C" { PyObject *PyvtkAMRDataInternals_ClassNew(); }


static PyObject *
PyvtkAMRDataInternals_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkAMRDataInternals_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkAMRDataInternals_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkAMRDataInternals::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkAMRDataInternals_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkAMRDataInternals::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkAMRDataInternals_CompositeShallowCopy(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp0, "vtkObject"))
  {
    ...
    {
      op->vtkAMRDataInternals::CompositeShallowCopy(temp0);
    }
...
static PyMethodDef PyvtkAMRDataInternals_Methods[] = {
  ...
  {"SafeDownCast", PyvtkAMRDataInternals_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkAMRDataInternals\nC++: static vtkAMRDataInternals *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkAMRDataInternals_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkAMRDataInternals\nC++: vtkAMRDataInternals *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkAMRDataInternals_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkAMRDataInternals_GetNumberOfGenerationsFromBase, METH_VARARGS,
  ...
  {"Insert", PyvtkAMRDataInternals_Insert, METH_VARARGS,
   "Insert(self, index:int, grid:vtkUniformGrid) -> None\nC++: void Insert(unsigned int index, vtkUniformGrid *grid)\n\n"},
  {"GetDataSet", PyvtkAMRDataInternals_GetDataSet, METH_VARARGS,
   "GetDataSet(self, compositeIndex:int) -> vtkUniformGrid\nC++: vtkUniformGrid *GetDataSet(unsigned int compositeIndex)\n\n"},
  {"CompositeShallowCopy", PyvtkAMRDataInternals_CompositeShallowCopy, METH_VARARGS,
   "CompositeShallowCopy(self, src:vtkObject) -> None\nC++: void CompositeShallowCopy(vtkObject *src)\n\n"},
  {"ShallowCopy", PyvtkAMRDataInternals_ShallowCopy, METH_VARARGS,
   "ShallowCopy(self, src:vtkObject) -> None\nC++: void ShallowCopy(vtkObject *src)\n\n"},
...
static PyTypeObject PyvtkAMRDataInternals_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkCommonDataModel.vtkAMRDataInternals", // tp_name
