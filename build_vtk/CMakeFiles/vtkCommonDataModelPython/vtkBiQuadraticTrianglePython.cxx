...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkBiQuadraticTriangle(PyObject *dict); }
extern "C" { PyObject *PyvtkBiQuadraticTriangle_ClassNew(); }
...
static PyObject *
PyvtkBiQuadraticTriangle_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkBiQuadraticTriangle::IsTypeOf(temp0);
...
static PyObject *
PyvtkBiQuadraticTriangle_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkBiQuadraticTriangle_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkBiQuadraticTriangle::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkBiQuadraticTriangle_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkBiQuadraticTriangle::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkBiQuadraticTriangle_InterpolationFunctions(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkBiQuadraticTriangle_InterpolationDerivs(PyObject * /*unused*/, PyObject *args)
{
  vtkPythonArgs ap(args, "InterpolationDerivs");

  const size_t size0 = 3;
  double temp0[3];
  const size_t size1 = 14;
  double temp1[14];
  double save1[14];
  PyObject *result = nullptr;
...
static PyMethodDef PyvtkBiQuadraticTriangle_Methods[] = {
  {"IsTypeOf", PyvtkBiQuadraticTriangle_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkBiQuadraticTriangle_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkBiQuadraticTriangle_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkBiQuadraticTriangle\nC++: static vtkBiQuadraticTriangle *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkBiQuadraticTriangle_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkBiQuadraticTriangle\nC++: vtkBiQuadraticTriangle *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkBiQuadraticTriangle_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkBiQuadraticTriangle_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetCellType", PyvtkBiQuadraticTriangle_GetCellType, METH_VARARGS,
   "GetCellType(self) -> int\nC++: int GetCellType() override;\n\nImplement the vtkCell API. See the vtkCell API for descriptions\nof these methods.\n"},
  {"GetCellDimension", PyvtkBiQuadraticTriangle_GetCellDimension, METH_VARARGS,
   "GetCellDimension(self) -> int\nC++: int GetCellDimension() override;\n\nReturn the topological dimensional of the cell (0,1,2, or 3).\n"},
  {"GetNumberOfEdges", PyvtkBiQuadraticTriangle_GetNumberOfEdges, METH_VARARGS,
   "GetNumberOfEdges(self) -> int\nC++: int GetNumberOfEdges() override;\n\nReturn the number of edges in the cell.\n"},
  {"GetNumberOfFaces", PyvtkBiQuadraticTriangle_GetNumberOfFaces, METH_VARARGS,
   "GetNumberOfFaces(self) -> int\nC++: int GetNumberOfFaces() override;\n\nReturn the number of faces in the cell.\n"},
  {"GetEdge", PyvtkBiQuadraticTriangle_GetEdge, METH_VARARGS,
   "GetEdge(self, edgeId:int) -> vtkCell\nC++: vtkCell *GetEdge(int edgeId) override;\n\nReturn the edge cell from the edgeId of the cell.\n"},
  {"GetFace", PyvtkBiQuadraticTriangle_GetFace, METH_VARARGS,
  ...
  {"CellBoundary", PyvtkBiQuadraticTriangle_CellBoundary, METH_VARARGS,
  ...
  {"Contour", PyvtkBiQuadraticTriangle_Contour, METH_VARARGS,
  ...
  {"EvaluatePosition", PyvtkBiQuadraticTriangle_EvaluatePosition, METH_VARARGS,
  ...
  {"EvaluateLocation", PyvtkBiQuadraticTriangle_EvaluateLocation, METH_VARARGS,
  ...
  {"Triangulate", PyvtkBiQuadraticTriangle_Triangulate, METH_VARARGS,
  ...
  {"Derivatives", PyvtkBiQuadraticTriangle_Derivatives, METH_VARARGS,
  ...
  {"GetParametricCoords", PyvtkBiQuadraticTriangle_GetParametricCoords, METH_VARARGS,
  ...
  {"Clip", PyvtkBiQuadraticTriangle_Clip, METH_VARARGS,
  ...
  {"IntersectWithLine", PyvtkBiQuadraticTriangle_IntersectWithLine, METH_VARARGS,
  ...
  {"GetParametricCenter", PyvtkBiQuadraticTriangle_GetParametricCenter, METH_VARARGS,
  ...
  {"GetParametricDistance", PyvtkBiQuadraticTriangle_GetParametricDistance, METH_VARARGS,
  ...
  {"InterpolationFunctions", PyvtkBiQuadraticTriangle_InterpolationFunctions, METH_VARARGS,
  ...
  {"InterpolationDerivs", PyvtkBiQuadraticTriangle_InterpolationDerivs, METH_VARARGS,
...
static const char *PyvtkBiQuadraticTriangle_Doc =
  ...
  "vtkBiQuadraticQuadraticWedge vtkBiQuadraticQuadraticHexahedron@par\n"
  "Thanks:\n"
...
static PyTypeObject PyvtkBiQuadraticTriangle_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonDataModel.vtkBiQuadraticTriangle", // tp_name
  ...
  PyvtkBiQuadraticTriangle_Doc, // tp_doc
...
PyObject *PyvtkBiQuadraticTriangle_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkBiQuadraticTriangle_Type, PyvtkBiQuadraticTriangle_Methods,
    "vtkBiQuadraticTriangle",
 &PyvtkBiQuadraticTriangle_StaticNew);
...
{
  PyObject *o;
  o = PyvtkBiQuadraticTriangle_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkBiQuadraticTriangle", o) != 0)
  {
    Py_DECREF(o);
  }
