...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkCubicLine(PyObject *dict); }
extern "C" { PyObject *PyvtkCubicLine_ClassNew(); }
...
static PyObject *
PyvtkCubicLine_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkCubicLine::IsTypeOf(temp0);
...
static PyObject *
PyvtkCubicLine_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkCubicLine_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkCubicLine::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkCubicLine_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkCubicLine::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkCubicLine_InterpolationFunctions(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkCubicLine_InterpolationDerivs(PyObject * /*unused*/, PyObject *args)
{
...
static PyMethodDef PyvtkCubicLine_Methods[] = {
  {"IsTypeOf", PyvtkCubicLine_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkCubicLine_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkCubicLine_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkCubicLine\nC++: static vtkCubicLine *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkCubicLine_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkCubicLine\nC++: vtkCubicLine *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkCubicLine_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkCubicLine_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetCellType", PyvtkCubicLine_GetCellType, METH_VARARGS,
   "GetCellType(self) -> int\nC++: int GetCellType() override;\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {"GetCellDimension", PyvtkCubicLine_GetCellDimension, METH_VARARGS,
   "GetCellDimension(self) -> int\nC++: int GetCellDimension() override;\n\nReturn the topological dimensional of the cell (0,1,2, or 3).\n"},
  {"GetNumberOfEdges", PyvtkCubicLine_GetNumberOfEdges, METH_VARARGS,
   "GetNumberOfEdges(self) -> int\nC++: int GetNumberOfEdges() override;\n\nReturn the number of edges in the cell.\n"},
  {"GetNumberOfFaces", PyvtkCubicLine_GetNumberOfFaces, METH_VARARGS,
   "GetNumberOfFaces(self) -> int\nC++: int GetNumberOfFaces() override;\n\nReturn the number of faces in the cell.\n"},
  {"GetEdge", PyvtkCubicLine_GetEdge, METH_VARARGS,
   "GetEdge(self, __a:int) -> vtkCell\nC++: vtkCell *GetEdge(int) override;\n\nReturn the edge cell from the edgeId of the cell.\n"},
  {"GetFace", PyvtkCubicLine_GetFace, METH_VARARGS,
  ...
  {"CellBoundary", PyvtkCubicLine_CellBoundary, METH_VARARGS,
  ...
  {"Contour", PyvtkCubicLine_Contour, METH_VARARGS,
  ...
  {"EvaluatePosition", PyvtkCubicLine_EvaluatePosition, METH_VARARGS,
  ...
  {"EvaluateLocation", PyvtkCubicLine_EvaluateLocation, METH_VARARGS,
  ...
  {"Triangulate", PyvtkCubicLine_Triangulate, METH_VARARGS,
  ...
  {"Derivatives", PyvtkCubicLine_Derivatives, METH_VARARGS,
  ...
  {"GetParametricCoords", PyvtkCubicLine_GetParametricCoords, METH_VARARGS,
  ...
  {"GetParametricDistance", PyvtkCubicLine_GetParametricDistance, METH_VARARGS,
  ...
  {"Clip", PyvtkCubicLine_Clip, METH_VARARGS,
  ...
  {"GetParametricCenter", PyvtkCubicLine_GetParametricCenter, METH_VARARGS,
   "GetParametricCenter(self, pcoords:[float, float, float]) -> int\nC++: int GetParametricCenter(double pcoords[3]) override;\n\nReturn the center of the triangle in parametric coordinates.\n"},
  {"IntersectWithLine", PyvtkCubicLine_IntersectWithLine, METH_VARARGS,
  ...
  {"InterpolationFunctions", PyvtkCubicLine_InterpolationFunctions, METH_VARARGS,
  ...
  {"InterpolationDerivs", PyvtkCubicLine_InterpolationDerivs, METH_VARARGS,
   "InterpolationDerivs(pcoords:(float, float, float), derivs:[float,\n    float, float, float]) -> None\nC++: static void InterpolationDerivs(const double pcoords[3],\n    double derivs[4])\n\n"},
  {"InterpolateFunctions", PyvtkCubicLine_InterpolateFunctions, METH_VARARGS,
...
static const char *PyvtkCubicLine_Doc =
  ...
  "accordance with most standard documentations.@par Thanks:\n"
...
static PyTypeObject PyvtkCubicLine_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonDataModel.vtkCubicLine", // tp_name
...
PyObject *PyvtkCubicLine_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkCubicLine_Type, PyvtkCubicLine_Methods,
    "vtkCubicLine",
 &PyvtkCubicLine_StaticNew);
...
{
  PyObject *o;
  o = PyvtkCubicLine_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkCubicLine", o) != 0)
  {
    Py_DECREF(o);
  }
