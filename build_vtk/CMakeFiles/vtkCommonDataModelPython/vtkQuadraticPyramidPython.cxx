...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkQuadraticPyramid(PyObject *dict); }
extern "C" { PyObject *PyvtkQuadraticPyramid_ClassNew(); }
...
static PyObject *
PyvtkQuadraticPyramid_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkQuadraticPyramid::IsTypeOf(temp0);
...
static PyObject *
PyvtkQuadraticPyramid_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkQuadraticPyramid_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkQuadraticPyramid::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkQuadraticPyramid_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkQuadraticPyramid::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkQuadraticPyramid_InterpolationFunctions(PyObject * /*unused*/, PyObject *args)
{
  vtkPythonArgs ap(args, "InterpolationFunctions");

  const size_t size0 = 3;
  double temp0[3];
  const size_t size1 = 13;
  double temp1[13];
  double save1[13];
  PyObject *result = nullptr;
...
static PyObject *
PyvtkQuadraticPyramid_InterpolationDerivs(PyObject * /*unused*/, PyObject *args)
{
  vtkPythonArgs ap(args, "InterpolationDerivs");

  const size_t size0 = 3;
  double temp0[3];
  const size_t size1 = 39;
  double temp1[39];
  double save1[39];
  PyObject *result = nullptr;
...
static PyObject *
PyvtkQuadraticPyramid_GetEdgeArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkQuadraticPyramid::GetEdgeArray(temp0);
...
static PyObject *
PyvtkQuadraticPyramid_GetFaceArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkQuadraticPyramid::GetFaceArray(temp0);
...
static PyMethodDef PyvtkQuadraticPyramid_Methods[] = {
  {"IsTypeOf", PyvtkQuadraticPyramid_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkQuadraticPyramid_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkQuadraticPyramid_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkQuadraticPyramid\nC++: static vtkQuadraticPyramid *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkQuadraticPyramid_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkQuadraticPyramid\nC++: vtkQuadraticPyramid *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkQuadraticPyramid_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkQuadraticPyramid_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetCellType", PyvtkQuadraticPyramid_GetCellType, METH_VARARGS,
   "GetCellType(self) -> int\nC++: int GetCellType() override;\n\nImplement the vtkCell API. See the vtkCell API for descriptions\nof these methods.\n"},
  {"GetCellDimension", PyvtkQuadraticPyramid_GetCellDimension, METH_VARARGS,
   "GetCellDimension(self) -> int\nC++: int GetCellDimension() override;\n\nReturn the topological dimensional of the cell (0,1,2, or 3).\n"},
  {"GetNumberOfEdges", PyvtkQuadraticPyramid_GetNumberOfEdges, METH_VARARGS,
   "GetNumberOfEdges(self) -> int\nC++: int GetNumberOfEdges() override;\n\nReturn the number of edges in the cell.\n"},
  {"GetNumberOfFaces", PyvtkQuadraticPyramid_GetNumberOfFaces, METH_VARARGS,
   "GetNumberOfFaces(self) -> int\nC++: int GetNumberOfFaces() override;\n\nReturn the number of faces in the cell.\n"},
  {"GetEdge", PyvtkQuadraticPyramid_GetEdge, METH_VARARGS,
   "GetEdge(self, edgeId:int) -> vtkCell\nC++: vtkCell *GetEdge(int edgeId) override;\n\nReturn the edge cell from the edgeId of the cell.\n"},
  {"GetFace", PyvtkQuadraticPyramid_GetFace, METH_VARARGS,
  ...
  {"CellBoundary", PyvtkQuadraticPyramid_CellBoundary, METH_VARARGS,
  ...
  {"Contour", PyvtkQuadraticPyramid_Contour, METH_VARARGS,
  ...
  {"EvaluatePosition", PyvtkQuadraticPyramid_EvaluatePosition, METH_VARARGS,
  ...
  {"EvaluateLocation", PyvtkQuadraticPyramid_EvaluateLocation, METH_VARARGS,
  ...
  {"Triangulate", PyvtkQuadraticPyramid_Triangulate, METH_VARARGS,
  ...
  {"Derivatives", PyvtkQuadraticPyramid_Derivatives, METH_VARARGS,
  ...
  {"GetParametricCoords", PyvtkQuadraticPyramid_GetParametricCoords, METH_VARARGS,
  ...
  {"Clip", PyvtkQuadraticPyramid_Clip, METH_VARARGS,
  ...
  {"IntersectWithLine", PyvtkQuadraticPyramid_IntersectWithLine, METH_VARARGS,
  ...
  {"GetParametricCenter", PyvtkQuadraticPyramid_GetParametricCenter, METH_VARARGS,
  ...
  {"InterpolationFunctions", PyvtkQuadraticPyramid_InterpolationFunctions, METH_VARARGS,
  ...
  {"InterpolationDerivs", PyvtkQuadraticPyramid_InterpolationDerivs, METH_VARARGS,
  ...
  {"InterpolateFunctions", PyvtkQuadraticPyramid_InterpolateFunctions, METH_VARARGS,
  ...
  {"InterpolateDerivs", PyvtkQuadraticPyramid_InterpolateDerivs, METH_VARARGS,
  ...
  {"GetEdgeArray", PyvtkQuadraticPyramid_GetEdgeArray, METH_VARARGS,
  ...
  {"GetFaceArray", PyvtkQuadraticPyramid_GetFaceArray, METH_VARARGS,
...
static PyTypeObject PyvtkQuadraticPyramid_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonDataModel.vtkQuadraticPyramid", // tp_name
  ...
  PyvtkQuadraticPyramid_Doc, // tp_doc
...
PyObject *PyvtkQuadraticPyramid_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkQuadraticPyramid_Type, PyvtkQuadraticPyramid_Methods,
    "vtkQuadraticPyramid",
 &PyvtkQuadraticPyramid_StaticNew);
...
{
  PyObject *o;
  o = PyvtkQuadraticPyramid_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkQuadraticPyramid", o) != 0)
  {
    Py_DECREF(o);
  }
