// python wrapper for vtkHigherOrderHexahedron
//
...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkHigherOrderHexahedron(PyObject *dict); }
...
static PyObject *
PyvtkHigherOrderHexahedron_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkHigherOrderHexahedron::IsTypeOf(temp0);
...
static PyObject *
PyvtkHigherOrderHexahedron_IsA(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "IsA");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkHigherOrderHexahedron *op = static_cast<vtkHigherOrderHexahedron *>(vp);
      ...
      ap.GetValue(temp0))
  {
    int tempr = (ap.IsBound() ?
      op->IsA(temp0) :
      op->vtkHigherOrderHexahedron::IsA(temp0));
...
static PyObject *
PyvtkHigherOrderHexahedron_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
  ...
  {
    vtkHigherOrderHexahedron *tempr = vtkHigherOrderHexahedron::SafeDownCast(temp0);
...
static PyObject *
PyvtkHigherOrderHexahedron_NewInstance(PyObject *self, PyObject *args)
{
  ...
  {
    vtkHigherOrderHexahedron *tempr = (ap.IsBound() ?
      op->NewInstance() :
      op->vtkHigherOrderHexahedron::NewInstance());
...
static PyObject *
PyvtkHigherOrderHexahedron_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkHigherOrderHexahedron::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkHigherOrderHexahedron_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderHexahedron::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkHigherOrderHexahedron_GetCellType(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkHigherOrderHexahedron_GetCellDimension(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      op->GetCellDimension() :
      op->vtkHigherOrderHexahedron::GetCellDimension());
...
static PyObject *
PyvtkHigherOrderHexahedron_RequiresInitialization(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderHexahedron::RequiresInitialization());
...
static PyObject *
PyvtkHigherOrderHexahedron_GetNumberOfEdges(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      op->GetNumberOfEdges() :
      op->vtkHigherOrderHexahedron::GetNumberOfEdges());
...
static PyObject *
PyvtkHigherOrderHexahedron_GetNumberOfFaces(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    int tempr = (ap.IsBound() ?
      op->GetNumberOfFaces() :
      op->vtkHigherOrderHexahedron::GetNumberOfFaces());
...
static PyObject *
PyvtkHigherOrderHexahedron_GetEdge(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkHigherOrderHexahedron_GetFace(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkHigherOrderHexahedron_Initialize(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    ...
    {
      op->vtkHigherOrderHexahedron::Initialize();
    }
...
static PyObject *
PyvtkHigherOrderHexahedron_CellBoundary(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp2, "vtkIdList"))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderHexahedron::CellBoundary(temp0, temp1, temp2));
...
static PyObject *
PyvtkHigherOrderHexahedron_EvaluatePosition(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp5, size5))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderHexahedron::EvaluatePosition(temp0, temp1, temp2, temp3, temp4, temp5));
...
static PyObject *
PyvtkHigherOrderHexahedron_EvaluateLocation(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp3, size3))
  {
    ...
    {
      op->vtkHigherOrderHexahedron::EvaluateLocation(temp0, temp1, temp2, temp3);
    }
...
static PyObject *
PyvtkHigherOrderHexahedron_Contour(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp10, "vtkCellData"))
  {
    ...
    {
      op->vtkHigherOrderHexahedron::Contour(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9, temp10);
    }
...
static PyObject *
PyvtkHigherOrderHexahedron_Clip(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp9))
  {
    ...
    {
      op->vtkHigherOrderHexahedron::Clip(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9);
    }
...
static PyObject *
PyvtkHigherOrderHexahedron_IntersectWithLine(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp6))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderHexahedron::IntersectWithLine(temp0, temp1, temp2, temp3, temp4, temp5, temp6));
...
static PyObject *
PyvtkHigherOrderHexahedron_Triangulate(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp2, "vtkPoints"))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderHexahedron::Triangulate(temp0, temp1, temp2));
...
static PyObject *
PyvtkHigherOrderHexahedron_Derivatives(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp4, size4))
  {
    ...
    {
      op->vtkHigherOrderHexahedron::Derivatives(temp0, temp1, temp2, temp3, temp4);
    }
...
static PyObject *
PyvtkHigherOrderHexahedron_SetParametricCoords(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    ...
    {
      op->vtkHigherOrderHexahedron::SetParametricCoords();
    }
...
static PyObject *
PyvtkHigherOrderHexahedron_GetParametricCoords(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    ...
    double *tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderHexahedron::GetParametricCoords());
...
static PyObject *
PyvtkHigherOrderHexahedron_GetParametricCenter(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp0, size0))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderHexahedron::GetParametricCenter(temp0));
...
static PyObject *
PyvtkHigherOrderHexahedron_GetParametricDistance(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp0, size0))
  {
    double tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderHexahedron::GetParametricDistance(temp0));
...
static PyObject *
PyvtkHigherOrderHexahedron_SetOrderFromCellData(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp2))
  {
    ...
    {
      op->vtkHigherOrderHexahedron::SetOrderFromCellData(temp0, temp1, temp2);
    }
...
static PyObject *
PyvtkHigherOrderHexahedron_SetUniformOrderFromNumPoints(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    ...
    {
      op->vtkHigherOrderHexahedron::SetUniformOrderFromNumPoints(temp0);
    }
...
static PyObject *
PyvtkHigherOrderHexahedron_SetOrder(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp2))
  {
    ...
    {
      op->vtkHigherOrderHexahedron::SetOrder(temp0, temp1, temp2);
    }
...
static PyObject *
PyvtkHigherOrderHexahedron_GetOrder_s1(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    const int *tempr = (ap.IsBound() ?
      op->GetOrder() :
      op->vtkHigherOrderHexahedron::GetOrder());
...
static PyObject *
PyvtkHigherOrderHexahedron_GetOrder_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "GetOrder");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkHigherOrderHexahedron *op = static_cast<vtkHigherOrderHexahedron *>(vp);
      ...
      ap.GetValue(temp0))
  {
    int tempr = (ap.IsBound() ?
      op->GetOrder(temp0) :
      op->vtkHigherOrderHexahedron::GetOrder(temp0));
...
static PyObject *
PyvtkHigherOrderHexahedron_GetOrder(PyObject *self, PyObject *args)
{
  ...
  {
    case 0:
      return PyvtkHigherOrderHexahedron_GetOrder_s1(self, args);
    case 1:
      return PyvtkHigherOrderHexahedron_GetOrder_s2(self, args);
  }
...
static PyObject *
PyvtkHigherOrderHexahedron_PointCountSupportsUniformOrder(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    bool tempr = vtkHigherOrderHexahedron::PointCountSupportsUniformOrder(temp0);
...
static PyObject *
PyvtkHigherOrderHexahedron_InterpolateFunctions(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkHigherOrderHexahedron_InterpolateDerivs(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkHigherOrderHexahedron_SubCellCoordinatesFromId_s1(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp1))
  {
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderHexahedron::SubCellCoordinatesFromId(*temp0, temp1));
...
static PyObject *
PyvtkHigherOrderHexahedron_SubCellCoordinatesFromId_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "SubCellCoordinatesFromId");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkHigherOrderHexahedron *op = static_cast<vtkHigherOrderHexahedron *>(vp);
      ...
      ap.GetValue(temp3))
  {
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderHexahedron::SubCellCoordinatesFromId(temp0, temp1, temp2, temp3));
...
static PyObject *
PyvtkHigherOrderHexahedron_SubCellCoordinatesFromId(PyObject *self, PyObject *args)
{
  int nargs = vtkPythonArgs::GetArgCount(self, args);
  ...
  {
    case 2:
      return PyvtkHigherOrderHexahedron_SubCellCoordinatesFromId_s1(self, args);
    case 4:
      return PyvtkHigherOrderHexahedron_SubCellCoordinatesFromId_s2(self, args);
  }
...
static PyObject *
PyvtkHigherOrderHexahedron_PointIndexFromIJK_s1(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(4) &&
      ...
      ap.GetArray(temp3, size3))
  {
    int tempr = vtkHigherOrderHexahedron::PointIndexFromIJK(temp0, temp1, temp2, temp3);
...
static PyObject *
PyvtkHigherOrderHexahedron_PointIndexFromIJK_s2(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp2))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderHexahedron::PointIndexFromIJK(temp0, temp1, temp2));
...
static PyMethodDef PyvtkHigherOrderHexahedron_PointIndexFromIJK_Methods[] = {
  {"PointIndexFromIJK", PyvtkHigherOrderHexahedron_PointIndexFromIJK_s1, METH_VARARGS | METH_STATIC,
   "iiiP *i"},
  {nullptr, nullptr, 0, nullptr}
};

static PyObject *
PyvtkHigherOrderHexahedron_PointIndexFromIJK(PyObject *self, PyObject *args)
{
  PyMethodDef *methods = PyvtkHigherOrderHexahedron_PointIndexFromIJK_Methods;
  int nargs = vtkPythonArgs::GetArgCount(args);

  switch(nargs)
  {
    case 3:
      return PyvtkHigherOrderHexahedron_PointIndexFromIJK_s2(self, args);
    case 4:
...
static PyObject *
PyvtkHigherOrderHexahedron_TransformApproxToCellParams(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp1, size1))
  {
    ...
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderHexahedron::TransformApproxToCellParams(temp0, temp1));
...
static PyObject *
PyvtkHigherOrderHexahedron_TransformFaceToCellParams(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp1, size1))
  {
    ...
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkHigherOrderHexahedron::TransformFaceToCellParams(temp0, temp1));
...
static PyObject *
PyvtkHigherOrderHexahedron_GetEdgeCell(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkHigherOrderHexahedron_GetFaceCell(PyObject *self, PyObject *args)
{
  ...
  if (op && !ap.IsPureVirtual() && ap.CheckArgCount(0))
  {
    vtkHigherOrderQuadrilateral *tempr = op->GetFaceCell();
...
static PyObject *
PyvtkHigherOrderHexahedron_GetInterpolation(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkHigherOrderHexahedron_NodeNumberingMappingFromVTK8To9(PyObject * /*unused*/, PyObject *args)
{
  vtkPythonArgs ap(args, "NodeNumberingMappingFromVTK8To9");
  ...
  if (ap.CheckArgCount(2) &&
      ...
      ap.GetValue(temp1))
  {
    long long tempr = vtkHigherOrderHexahedron::NodeNumberingMappingFromVTK8To9(temp0, temp1);
...
static PyMethodDef PyvtkHigherOrderHexahedron_Methods[] = {
  {"IsTypeOf", PyvtkHigherOrderHexahedron_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkHigherOrderHexahedron_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkHigherOrderHexahedron_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkHigherOrderHexahedron\nC++: static vtkHigherOrderHexahedron *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkHigherOrderHexahedron_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkHigherOrderHexahedron\nC++: vtkHigherOrderHexahedron *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkHigherOrderHexahedron_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkHigherOrderHexahedron_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetCellType", PyvtkHigherOrderHexahedron_GetCellType, METH_VARARGS,
   "GetCellType(self) -> int\nC++: int GetCellType() override = 0;\n\nReturn the type of cell.\n"},
  {"GetCellDimension", PyvtkHigherOrderHexahedron_GetCellDimension, METH_VARARGS,
   "GetCellDimension(self) -> int\nC++: int GetCellDimension() override;\n\nReturn the topological dimensional of the cell (0,1,2, or 3).\n"},
  {"RequiresInitialization", PyvtkHigherOrderHexahedron_RequiresInitialization, METH_VARARGS,
  ...
  {"GetNumberOfEdges", PyvtkHigherOrderHexahedron_GetNumberOfEdges, METH_VARARGS,
   "GetNumberOfEdges(self) -> int\nC++: int GetNumberOfEdges() override;\n\nReturn the number of edges in the cell.\n"},
  {"GetNumberOfFaces", PyvtkHigherOrderHexahedron_GetNumberOfFaces, METH_VARARGS,
   "GetNumberOfFaces(self) -> int\nC++: int GetNumberOfFaces() override;\n\nReturn the number of faces in the cell.\n"},
  {"GetEdge", PyvtkHigherOrderHexahedron_GetEdge, METH_VARARGS,
   "GetEdge(self, edgeId:int) -> vtkCell\nC++: vtkCell *GetEdge(int edgeId) override = 0;\n\nReturn the edge cell from the edgeId of the cell.\n"},
  {"GetFace", PyvtkHigherOrderHexahedron_GetFace, METH_VARARGS,
  ...
  {"Initialize", PyvtkHigherOrderHexahedron_Initialize, METH_VARARGS,
   "Initialize(self) -> None\nC++: void Initialize() override;\n\n"},
  {"CellBoundary", PyvtkHigherOrderHexahedron_CellBoundary, METH_VARARGS,
  ...
  {"EvaluatePosition", PyvtkHigherOrderHexahedron_EvaluatePosition, METH_VARARGS,
  ...
  {"EvaluateLocation", PyvtkHigherOrderHexahedron_EvaluateLocation, METH_VARARGS,
  ...
  {"Contour", PyvtkHigherOrderHexahedron_Contour, METH_VARARGS,
  ...
  {"Clip", PyvtkHigherOrderHexahedron_Clip, METH_VARARGS,
  ...
  {"IntersectWithLine", PyvtkHigherOrderHexahedron_IntersectWithLine, METH_VARARGS,
  ...
  {"Triangulate", PyvtkHigherOrderHexahedron_Triangulate, METH_VARARGS,
  ...
  {"Derivatives", PyvtkHigherOrderHexahedron_Derivatives, METH_VARARGS,
  ...
  {"SetParametricCoords", PyvtkHigherOrderHexahedron_SetParametricCoords, METH_VARARGS,
   "SetParametricCoords(self) -> None\nC++: void SetParametricCoords()\n\n"},
  {"GetParametricCoords", PyvtkHigherOrderHexahedron_GetParametricCoords, METH_VARARGS,
  ...
  {"GetParametricCenter", PyvtkHigherOrderHexahedron_GetParametricCenter, METH_VARARGS,
  ...
  {"GetParametricDistance", PyvtkHigherOrderHexahedron_GetParametricDistance, METH_VARARGS,
  ...
  {"SetOrderFromCellData", PyvtkHigherOrderHexahedron_SetOrderFromCellData, METH_VARARGS,
  ...
  {"SetUniformOrderFromNumPoints", PyvtkHigherOrderHexahedron_SetUniformOrderFromNumPoints, METH_VARARGS,
   "SetUniformOrderFromNumPoints(self, numPts:int) -> None\nC++: virtual void SetUniformOrderFromNumPoints(vtkIdType numPts)\n\n"},
  {"SetOrder", PyvtkHigherOrderHexahedron_SetOrder, METH_VARARGS,
   "SetOrder(self, s:int, t:int, u:int) -> None\nC++: virtual void SetOrder(int s, int t, int u)\n\n"},
  {"GetOrder", PyvtkHigherOrderHexahedron_GetOrder, METH_VARARGS,
   "GetOrder(self) -> Pointer\nC++: virtual const int *GetOrder()\nGetOrder(self, i:int) -> int\nC++: virtual int GetOrder(int i)\n\n"},
  {"PointCountSupportsUniformOrder", PyvtkHigherOrderHexahedron_PointCountSupportsUniformOrder, METH_VARARGS,
  ...
  {"InterpolateFunctions", PyvtkHigherOrderHexahedron_InterpolateFunctions, METH_VARARGS,
  ...
  {"InterpolateDerivs", PyvtkHigherOrderHexahedron_InterpolateDerivs, METH_VARARGS,
   "InterpolateDerivs(self, pcoords:(float, float, float),\n    derivs:[float, ...]) -> None\nC++: void InterpolateDerivs(const double pcoords[3],\n    double *derivs) override = 0;\n\n"},
  {"SubCellCoordinatesFromId", PyvtkHigherOrderHexahedron_SubCellCoordinatesFromId, METH_VARARGS,
  ...
  {"PointIndexFromIJK", PyvtkHigherOrderHexahedron_PointIndexFromIJK, METH_VARARGS,
  ...
  {"TransformApproxToCellParams", PyvtkHigherOrderHexahedron_TransformApproxToCellParams, METH_VARARGS,
   "TransformApproxToCellParams(self, subCell:int, pcoords:[float,\n    ...]) -> bool\nC++: bool TransformApproxToCellParams(int subCell,\n    double *pcoords)\n\n"},
  {"TransformFaceToCellParams", PyvtkHigherOrderHexahedron_TransformFaceToCellParams, METH_VARARGS,
   "TransformFaceToCellParams(self, bdyFace:int, pcoords:[float, ...])\n     -> bool\nC++: bool TransformFaceToCellParams(int bdyFace, double *pcoords)\n\n"},
  {"GetEdgeCell", PyvtkHigherOrderHexahedron_GetEdgeCell, METH_VARARGS,
   "GetEdgeCell(self) -> vtkHigherOrderCurve\nC++: virtual vtkHigherOrderCurve *GetEdgeCell()\n\n"},
  {"GetFaceCell", PyvtkHigherOrderHexahedron_GetFaceCell, METH_VARARGS,
   "GetFaceCell(self) -> vtkHigherOrderQuadrilateral\nC++: virtual vtkHigherOrderQuadrilateral *GetFaceCell()\n\n"},
  {"GetInterpolation", PyvtkHigherOrderHexahedron_GetInterpolation, METH_VARARGS,
   "GetInterpolation(self) -> vtkHigherOrderInterpolation\nC++: virtual vtkHigherOrderInterpolation *GetInterpolation()\n\n"},
  {"NodeNumberingMappingFromVTK8To9", PyvtkHigherOrderHexahedron_NodeNumberingMappingFromVTK8To9, METH_VARARGS,
   "NodeNumberingMappingFromVTK8To9(order:(int, int, int),\n    node_id_vtk8:int) -> int\nC++: static vtkIdType NodeNumberingMappingFromVTK8To9(\n    const int order[3], vtkIdType node_id_vtk8)\n\n"},
  {nullptr, nullptr, 0, nullptr}
};

static const char *PyvtkHigherOrderHexahedron_Doc =
...
static PyTypeObject PyvtkHigherOrderHexahedron_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonDataModel.vtkHigherOrderHexahedron", // tp_name
  ...
  PyvtkHigherOrderHexahedron_Doc, // tp_doc
...
PyObject *PyvtkHigherOrderHexahedron_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkHigherOrderHexahedron_Type, PyvtkHigherOrderHexahedron_Methods,
...
void PyVTKAddFile_vtkHigherOrderHexahedron(
  PyObject *dict)
{
  PyObject *o;
  o = PyvtkHigherOrderHexahedron_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkHigherOrderHexahedron", o) != 0)
  {
    Py_DECREF(o);
  }
