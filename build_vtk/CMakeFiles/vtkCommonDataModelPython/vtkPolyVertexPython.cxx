...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkPolyVertex(PyObject *dict); }
extern "C" { PyObject *PyvtkPolyVertex_ClassNew(); }
...
static PyObject *
PyvtkPolyVertex_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkPolyVertex::IsTypeOf(temp0);
...
static PyObject *
PyvtkPolyVertex_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPolyVertex_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkPolyVertex::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkPolyVertex_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkPolyVertex::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkPolyVertex_Methods[] = {
  {"IsTypeOf", PyvtkPolyVertex_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkPolyVertex_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkPolyVertex_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkPolyVertex\nC++: static vtkPolyVertex *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkPolyVertex_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkPolyVertex\nC++: vtkPolyVertex *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkPolyVertex_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkPolyVertex_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetCellType", PyvtkPolyVertex_GetCellType, METH_VARARGS,
   "GetCellType(self) -> int\nC++: int GetCellType() override;\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {"GetCellDimension", PyvtkPolyVertex_GetCellDimension, METH_VARARGS,
   "GetCellDimension(self) -> int\nC++: int GetCellDimension() override;\n\nReturn the topological dimensional of the cell (0,1,2, or 3).\n"},
  {"GetNumberOfEdges", PyvtkPolyVertex_GetNumberOfEdges, METH_VARARGS,
   "GetNumberOfEdges(self) -> int\nC++: int GetNumberOfEdges() override;\n\nReturn the number of edges in the cell.\n"},
  {"GetNumberOfFaces", PyvtkPolyVertex_GetNumberOfFaces, METH_VARARGS,
   "GetNumberOfFaces(self) -> int\nC++: int GetNumberOfFaces() override;\n\nReturn the number of faces in the cell.\n"},
  {"GetEdge", PyvtkPolyVertex_GetEdge, METH_VARARGS,
   "GetEdge(self, edgeId:int) -> vtkCell\nC++: vtkCell *GetEdge(int edgeId) override;\n\nReturn the edge cell from the edgeId of the cell.\n"},
  {"GetFace", PyvtkPolyVertex_GetFace, METH_VARARGS,
  ...
  {"CellBoundary", PyvtkPolyVertex_CellBoundary, METH_VARARGS,
  ...
  {"Contour", PyvtkPolyVertex_Contour, METH_VARARGS,
  ...
  {"Clip", PyvtkPolyVertex_Clip, METH_VARARGS,
  ...
  {"EvaluatePosition", PyvtkPolyVertex_EvaluatePosition, METH_VARARGS,
  ...
  {"EvaluateLocation", PyvtkPolyVertex_EvaluateLocation, METH_VARARGS,
  ...
  {"IntersectWithLine", PyvtkPolyVertex_IntersectWithLine, METH_VARARGS,
  ...
  {"Triangulate", PyvtkPolyVertex_Triangulate, METH_VARARGS,
  ...
  {"Derivatives", PyvtkPolyVertex_Derivatives, METH_VARARGS,
  ...
  {"IsPrimaryCell", PyvtkPolyVertex_IsPrimaryCell, METH_VARARGS,
  ...
  {"GetParametricCenter", PyvtkPolyVertex_GetParametricCenter, METH_VARARGS,
...
static PyTypeObject PyvtkPolyVertex_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonDataModel.vtkPolyVertex", // tp_name
...
PyObject *PyvtkPolyVertex_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkPolyVertex_Type, PyvtkPolyVertex_Methods,
    "vtkPolyVertex",
 &PyvtkPolyVertex_StaticNew);
...
{
  PyObject *o;
  o = PyvtkPolyVertex_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkPolyVertex", o) != 0)
  {
    Py_DECREF(o);
  }
