...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkTriQuadraticHexahedron(PyObject *dict); }
extern "C" { PyObject *PyvtkTriQuadraticHexahedron_ClassNew(); }
...
static PyObject *
PyvtkTriQuadraticHexahedron_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkTriQuadraticHexahedron::IsTypeOf(temp0);
...
static PyObject *
PyvtkTriQuadraticHexahedron_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkTriQuadraticHexahedron_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkTriQuadraticHexahedron::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkTriQuadraticHexahedron_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkTriQuadraticHexahedron::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkTriQuadraticHexahedron_InterpolationFunctions(PyObject * /*unused*/, PyObject *args)
{
  vtkPythonArgs ap(args, "InterpolationFunctions");

  const size_t size0 = 3;
  double temp0[3];
  const size_t size1 = 27;
  double temp1[27];
  double save1[27];
  PyObject *result = nullptr;
...
static PyObject *
PyvtkTriQuadraticHexahedron_InterpolationDerivs(PyObject * /*unused*/, PyObject *args)
{
  vtkPythonArgs ap(args, "InterpolationDerivs");

  const size_t size0 = 3;
  double temp0[3];
  const size_t size1 = 81;
  double temp1[81];
  double save1[81];
  PyObject *result = nullptr;
...
static PyObject *
PyvtkTriQuadraticHexahedron_GetEdgeArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkTriQuadraticHexahedron::GetEdgeArray(temp0);
...
static PyObject *
PyvtkTriQuadraticHexahedron_GetFaceArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkTriQuadraticHexahedron::GetFaceArray(temp0);
...
static PyMethodDef PyvtkTriQuadraticHexahedron_Methods[] = {
  {"IsTypeOf", PyvtkTriQuadraticHexahedron_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkTriQuadraticHexahedron_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkTriQuadraticHexahedron_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkTriQuadraticHexahedron\nC++: static vtkTriQuadraticHexahedron *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkTriQuadraticHexahedron_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkTriQuadraticHexahedron\nC++: vtkTriQuadraticHexahedron *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkTriQuadraticHexahedron_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkTriQuadraticHexahedron_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetCellType", PyvtkTriQuadraticHexahedron_GetCellType, METH_VARARGS,
   "GetCellType(self) -> int\nC++: int GetCellType() override;\n\nImplement the vtkCell API. See the vtkCell API for descriptions\nof these methods.\n"},
  {"GetCellDimension", PyvtkTriQuadraticHexahedron_GetCellDimension, METH_VARARGS,
   "GetCellDimension(self) -> int\nC++: int GetCellDimension() override;\n\nReturn the topological dimensional of the cell (0,1,2, or 3).\n"},
  {"GetNumberOfEdges", PyvtkTriQuadraticHexahedron_GetNumberOfEdges, METH_VARARGS,
   "GetNumberOfEdges(self) -> int\nC++: int GetNumberOfEdges() override;\n\nReturn the number of edges in the cell.\n"},
  {"GetNumberOfFaces", PyvtkTriQuadraticHexahedron_GetNumberOfFaces, METH_VARARGS,
   "GetNumberOfFaces(self) -> int\nC++: int GetNumberOfFaces() override;\n\nReturn the number of faces in the cell.\n"},
  {"GetEdge", PyvtkTriQuadraticHexahedron_GetEdge, METH_VARARGS,
   "GetEdge(self, __a:int) -> vtkCell\nC++: vtkCell *GetEdge(int) override;\n\nReturn the edge cell from the edgeId of the cell.\n"},
  {"GetFace", PyvtkTriQuadraticHexahedron_GetFace, METH_VARARGS,
  ...
  {"CellBoundary", PyvtkTriQuadraticHexahedron_CellBoundary, METH_VARARGS,
  ...
  {"Contour", PyvtkTriQuadraticHexahedron_Contour, METH_VARARGS,
  ...
  {"EvaluatePosition", PyvtkTriQuadraticHexahedron_EvaluatePosition, METH_VARARGS,
  ...
  {"EvaluateLocation", PyvtkTriQuadraticHexahedron_EvaluateLocation, METH_VARARGS,
  ...
  {"Triangulate", PyvtkTriQuadraticHexahedron_Triangulate, METH_VARARGS,
  ...
  {"Derivatives", PyvtkTriQuadraticHexahedron_Derivatives, METH_VARARGS,
  ...
  {"GetParametricCoords", PyvtkTriQuadraticHexahedron_GetParametricCoords, METH_VARARGS,
  ...
  {"Clip", PyvtkTriQuadraticHexahedron_Clip, METH_VARARGS,
  ...
  {"IntersectWithLine", PyvtkTriQuadraticHexahedron_IntersectWithLine, METH_VARARGS,
  ...
  {"InterpolationFunctions", PyvtkTriQuadraticHexahedron_InterpolationFunctions, METH_VARARGS,
  ...
  {"GetFaceArray", PyvtkTriQuadraticHexahedron_GetFaceArray, METH_VARARGS,
...
static PyTypeObject PyvtkTriQuadraticHexahedron_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonDataModel.vtkTriQuadraticHexahedron", // tp_name
  ...
  PyvtkTriQuadraticHexahedron_Doc, // tp_doc
...
PyObject *PyvtkTriQuadraticHexahedron_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkTriQuadraticHexahedron_Type, PyvtkTriQuadraticHexahedron_Methods,
    "vtkTriQuadraticHexahedron",
 &PyvtkTriQuadraticHexahedron_StaticNew);
...
{
  PyObject *o;
  o = PyvtkTriQuadraticHexahedron_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkTriQuadraticHexahedron", o) != 0)
  {
    Py_DECREF(o);
  }
