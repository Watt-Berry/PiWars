...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkPyramid(PyObject *dict); }
extern "C" { PyObject *PyvtkPyramid_ClassNew(); }
...
static PyObject *
PyvtkPyramid_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkPyramid::IsTypeOf(temp0);
...
static PyObject *
PyvtkPyramid_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPyramid_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkPyramid::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkPyramid_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkPyramid::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkPyramid_GetEdgePoints(PyObject *self, PyObject *args)
{
                      ...
                      "0 <= edgeId && edgeId < GetNumberOfEdges()"))
  {
    ...
    {
      op->vtkPyramid::GetEdgePoints(temp0, temp1c);
    }
...
static PyObject *
PyvtkPyramid_GetFacePoints(PyObject *self, PyObject *args)
{
                      ...
                      "0 <= faceId && faceId < GetNumberOfFaces()"))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkPyramid::GetFacePoints(temp0, temp1c));
...
static PyObject *
PyvtkPyramid_GetEdgeToAdjacentFaces(PyObject *self, PyObject *args)
{
                      ...
                      "0 <= edgeId && edgeId < GetNumberOfEdges()"))
  {
    ...
    {
      op->vtkPyramid::GetEdgeToAdjacentFaces(temp0, temp1c);
    }
...
static PyObject *
PyvtkPyramid_GetFaceToAdjacentFaces(PyObject *self, PyObject *args)
{
                      ...
                      "0 <= faceId && faceId < GetNumberOfFaces()"))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkPyramid::GetFaceToAdjacentFaces(temp0, temp1c));
...
static PyObject *
PyvtkPyramid_GetPointToIncidentEdges(PyObject *self, PyObject *args)
{
                      ...
                      "0 <= pointId && pointId < GetNumberOfPoints()"))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkPyramid::GetPointToIncidentEdges(temp0, temp1c));
...
static PyObject *
PyvtkPyramid_GetPointToIncidentFaces(PyObject *self, PyObject *args)
{
                      ...
                      "0 <= pointId && pointId < GetNumberOfPoints()"))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkPyramid::GetPointToIncidentFaces(temp0, temp1c));
...
static PyObject *
PyvtkPyramid_GetPointToOneRingPoints(PyObject *self, PyObject *args)
{
                      ...
                      "0 <= pointId && pointId < GetNumberOfPoints()"))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkPyramid::GetPointToOneRingPoints(temp0, temp1c));
...
static PyObject *
PyvtkPyramid_GetCentroid(PyObject *self, PyObject *args)
{
      ...
      ap.GetArray(temp0, size0))
  {
    ...
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkPyramid::GetCentroid(temp0));
...
static PyObject *
PyvtkPyramid_IsInsideOut(PyObject *self, PyObject *args)
{
...
static PyObject *
PyvtkPyramid_GetTriangleCases(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int *tempr = vtkPyramid::GetTriangleCases(temp0);
...
static PyObject *
PyvtkPyramid_InterpolationFunctions(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPyramid_InterpolationDerivs(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPyramid_GetEdgeArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkPyramid::GetEdgeArray(temp0);
...
static PyObject *
PyvtkPyramid_GetFaceArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkPyramid::GetFaceArray(temp0);
...
static PyObject *
PyvtkPyramid_GetEdgeToAdjacentFacesArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkPyramid::GetEdgeToAdjacentFacesArray(temp0);
...
static PyObject *
PyvtkPyramid_GetFaceToAdjacentFacesArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkPyramid::GetFaceToAdjacentFacesArray(temp0);
...
static PyObject *
PyvtkPyramid_GetPointToIncidentEdgesArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkPyramid::GetPointToIncidentEdgesArray(temp0);
...
static PyObject *
PyvtkPyramid_GetPointToIncidentFacesArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkPyramid::GetPointToIncidentFacesArray(temp0);
...
static PyObject *
PyvtkPyramid_GetPointToOneRingPointsArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkPyramid::GetPointToOneRingPointsArray(temp0);
...
static PyObject *
PyvtkPyramid_ComputeCentroid(PyObject * /*unused*/, PyObject *args)
{
      ...
      ap.GetArray(temp2, size2))
  {
    ...
    bool tempr = vtkPyramid::ComputeCentroid(temp0, temp1, temp2);
...
static PyMethodDef PyvtkPyramid_Methods[] = {
  {"IsTypeOf", PyvtkPyramid_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkPyramid_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkPyramid_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkPyramid\nC++: static vtkPyramid *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkPyramid_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkPyramid\nC++: vtkPyramid *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkPyramid_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkPyramid_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetEdgePoints", PyvtkPyramid_GetEdgePoints, METH_VARARGS,
   "GetEdgePoints(self, edgeId:int, pts:(int, int)) -> None\nC++: void GetEdgePoints(vtkIdType edgeId, const vtkIdType *&pts)\n    override;\n\nSee vtkCell3D API for description of these methods.\n"},
  {"GetFacePoints", PyvtkPyramid_GetFacePoints, METH_VARARGS,
  ...
  {"GetEdgeToAdjacentFaces", PyvtkPyramid_GetEdgeToAdjacentFaces, METH_VARARGS,
  ...
  {"GetFaceToAdjacentFaces", PyvtkPyramid_GetFaceToAdjacentFaces, METH_VARARGS,
  ...
  {"GetPointToIncidentEdges", PyvtkPyramid_GetPointToIncidentEdges, METH_VARARGS,
  ...
  {"GetPointToIncidentFaces", PyvtkPyramid_GetPointToIncidentFaces, METH_VARARGS,
  ...
  {"GetPointToOneRingPoints", PyvtkPyramid_GetPointToOneRingPoints, METH_VARARGS,
  ...
  {"GetCellType", PyvtkPyramid_GetCellType, METH_VARARGS,
   "GetCellType(self) -> int\nC++: int GetCellType() override;\n\nSee the vtkCell API for descriptions of these methods.\n"},
  {"GetCellDimension", PyvtkPyramid_GetCellDimension, METH_VARARGS,
   "GetCellDimension(self) -> int\nC++: int GetCellDimension() override;\n\nThe topological dimension of the cell. (Satisfies vtkCell API.)\n"},
  {"GetNumberOfEdges", PyvtkPyramid_GetNumberOfEdges, METH_VARARGS,
   "GetNumberOfEdges(self) -> int\nC++: int GetNumberOfEdges() override;\n\nReturn the number of edges in the cell.\n"},
  {"GetNumberOfFaces", PyvtkPyramid_GetNumberOfFaces, METH_VARARGS,
   "GetNumberOfFaces(self) -> int\nC++: int GetNumberOfFaces() override;\n\nReturn the number of faces in the cell.\n"},
  {"GetEdge", PyvtkPyramid_GetEdge, METH_VARARGS,
   "GetEdge(self, edgeId:int) -> vtkCell\nC++: vtkCell *GetEdge(int edgeId) override;\n\nReturn the edge cell from the edgeId of the cell.\n"},
  {"GetFace", PyvtkPyramid_GetFace, METH_VARARGS,
  ...
  {"CellBoundary", PyvtkPyramid_CellBoundary, METH_VARARGS,
  ...
  {"Contour", PyvtkPyramid_Contour, METH_VARARGS,
  ...
  {"EvaluatePosition", PyvtkPyramid_EvaluatePosition, METH_VARARGS,
  ...
  {"EvaluateLocation", PyvtkPyramid_EvaluateLocation, METH_VARARGS,
  ...
  {"IntersectWithLine", PyvtkPyramid_IntersectWithLine, METH_VARARGS,
  ...
  {"Triangulate", PyvtkPyramid_Triangulate, METH_VARARGS,
  ...
  {"Derivatives", PyvtkPyramid_Derivatives, METH_VARARGS,
  ...
  {"GetParametricCoords", PyvtkPyramid_GetParametricCoords, METH_VARARGS,
  ...
  {"GetTriangleCases", PyvtkPyramid_GetTriangleCases, METH_VARARGS,
  ...
  {"GetParametricCenter", PyvtkPyramid_GetParametricCenter, METH_VARARGS,
   "GetParametricCenter(self, pcoords:[float, float, float]) -> int\nC++: int GetParametricCenter(double pcoords[3]) override;\n\nReturn the center of the pyramid in parametric coordinates.\n"},
  {"InterpolationFunctions", PyvtkPyramid_InterpolationFunctions, METH_VARARGS,
   "InterpolationFunctions(pcoords:(float, float, float),\n    weights:[float, float, float, float, float]) -> None\nC++: static void InterpolationFunctions(const double pcoords[3],\n    double weights[5])\n\n"},
  {"InterpolationDerivs", PyvtkPyramid_InterpolationDerivs, METH_VARARGS,
  ...
  {"GetFaceArray", PyvtkPyramid_GetFaceArray, METH_VARARGS,
   "GetFaceArray(faceId:int) -> (int, int, int, int)\nC++: static const vtkIdType *GetFaceArray(vtkIdType faceId)\n\n"},
  {"GetEdgeToAdjacentFacesArray", PyvtkPyramid_GetEdgeToAdjacentFacesArray, METH_VARARGS,
   "GetEdgeToAdjacentFacesArray(edgeId:int) -> (int, int)\nC++: static const vtkIdType *GetEdgeToAdjacentFacesArray(\n    vtkIdType edgeId)\n\nStatic method version of GetEdgeToAdjacentFaces.\n"},
  {"GetFaceToAdjacentFacesArray", PyvtkPyramid_GetFaceToAdjacentFacesArray, METH_VARARGS,
   "GetFaceToAdjacentFacesArray(faceId:int) -> (int, int, int, int)\nC++: static const vtkIdType *GetFaceToAdjacentFacesArray(\n    vtkIdType faceId)\n\nStatic method version of GetFaceToAdjacentFaces.\n"},
  {"GetPointToIncidentEdgesArray", PyvtkPyramid_GetPointToIncidentEdgesArray, METH_VARARGS,
   "GetPointToIncidentEdgesArray(pointId:int) -> (int, int, int, int)\nC++: static const vtkIdType *GetPointToIncidentEdgesArray(\n    vtkIdType pointId)\n\nStatic method version of GetPointToIncidentEdgesArray.\n"},
  {"GetPointToIncidentFacesArray", PyvtkPyramid_GetPointToIncidentFacesArray, METH_VARARGS,
   "GetPointToIncidentFacesArray(pointId:int) -> (int, int, int, int)\nC++: static const vtkIdType *GetPointToIncidentFacesArray(\n    vtkIdType pointId)\n\nStatic method version of GetPointToIncidentFacesArray.\n"},
  {"GetPointToOneRingPointsArray", PyvtkPyramid_GetPointToOneRingPointsArray, METH_VARARGS,
   "GetPointToOneRingPointsArray(pointId:int) -> (int, int, int, int)\nC++: static const vtkIdType *GetPointToOneRingPointsArray(\n    vtkIdType pointId)\n\nStatic method version of GetPointToOneRingPoints.\n"},
  {"ComputeCentroid", PyvtkPyramid_ComputeCentroid, METH_VARARGS,
...
static PyTypeObject PyvtkPyramid_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonDataModel.vtkPyramid", // tp_name
...
PyObject *PyvtkPyramid_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkPyramid_Type, PyvtkPyramid_Methods,
    "vtkPyramid",
 &PyvtkPyramid_StaticNew);
...
{
  PyObject *o;
  o = PyvtkPyramid_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkPyramid", o) != 0)
  {
    Py_DECREF(o);
  }
