...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkQuadraticEdge(PyObject *dict); }
extern "C" { PyObject *PyvtkQuadraticEdge_ClassNew(); }
...
static PyObject *
PyvtkQuadraticEdge_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkQuadraticEdge::IsTypeOf(temp0);
...
static PyObject *
PyvtkQuadraticEdge_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkQuadraticEdge_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkQuadraticEdge::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkQuadraticEdge_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkQuadraticEdge::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkQuadraticEdge_InterpolationFunctions(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkQuadraticEdge_InterpolationDerivs(PyObject * /*unused*/, PyObject *args)
{
...
static PyMethodDef PyvtkQuadraticEdge_Methods[] = {
  {"IsTypeOf", PyvtkQuadraticEdge_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkQuadraticEdge_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkQuadraticEdge_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkQuadraticEdge\nC++: static vtkQuadraticEdge *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkQuadraticEdge_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkQuadraticEdge\nC++: vtkQuadraticEdge *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkQuadraticEdge_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkQuadraticEdge_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetCellType", PyvtkQuadraticEdge_GetCellType, METH_VARARGS,
   "GetCellType(self) -> int\nC++: int GetCellType() override;\n\nImplement the vtkCell API. See the vtkCell API for descriptions\nof these methods.\n"},
  {"GetCellDimension", PyvtkQuadraticEdge_GetCellDimension, METH_VARARGS,
   "GetCellDimension(self) -> int\nC++: int GetCellDimension() override;\n\nReturn the topological dimensional of the cell (0,1,2, or 3).\n"},
  {"GetNumberOfEdges", PyvtkQuadraticEdge_GetNumberOfEdges, METH_VARARGS,
   "GetNumberOfEdges(self) -> int\nC++: int GetNumberOfEdges() override;\n\nReturn the number of edges in the cell.\n"},
  {"GetNumberOfFaces", PyvtkQuadraticEdge_GetNumberOfFaces, METH_VARARGS,
   "GetNumberOfFaces(self) -> int\nC++: int GetNumberOfFaces() override;\n\nReturn the number of faces in the cell.\n"},
  {"GetEdge", PyvtkQuadraticEdge_GetEdge, METH_VARARGS,
   "GetEdge(self, __a:int) -> vtkCell\nC++: vtkCell *GetEdge(int) override;\n\nReturn the edge cell from the edgeId of the cell.\n"},
  {"GetFace", PyvtkQuadraticEdge_GetFace, METH_VARARGS,
  ...
  {"CellBoundary", PyvtkQuadraticEdge_CellBoundary, METH_VARARGS,
  ...
  {"Contour", PyvtkQuadraticEdge_Contour, METH_VARARGS,
  ...
  {"EvaluatePosition", PyvtkQuadraticEdge_EvaluatePosition, METH_VARARGS,
  ...
  {"EvaluateLocation", PyvtkQuadraticEdge_EvaluateLocation, METH_VARARGS,
  ...
  {"Triangulate", PyvtkQuadraticEdge_Triangulate, METH_VARARGS,
  ...
  {"Derivatives", PyvtkQuadraticEdge_Derivatives, METH_VARARGS,
  ...
  {"GetParametricCoords", PyvtkQuadraticEdge_GetParametricCoords, METH_VARARGS,
  ...
  {"Clip", PyvtkQuadraticEdge_Clip, METH_VARARGS,
  ...
  {"IntersectWithLine", PyvtkQuadraticEdge_IntersectWithLine, METH_VARARGS,
  ...
  {"GetParametricCenter", PyvtkQuadraticEdge_GetParametricCenter, METH_VARARGS,
  ...
  {"InterpolationFunctions", PyvtkQuadraticEdge_InterpolationFunctions, METH_VARARGS,
   "InterpolationFunctions(pcoords:(float, float, float),\n    weights:[float, float, float]) -> None\nC++: static void InterpolationFunctions(const double pcoords[3],\n    double weights[3])\n\n"},
  {"InterpolationDerivs", PyvtkQuadraticEdge_InterpolationDerivs, METH_VARARGS,
   "InterpolationDerivs(pcoords:(float, float, float), derivs:[float,\n    float, float]) -> None\nC++: static void InterpolationDerivs(const double pcoords[3],\n    double derivs[3])\n\n"},
  {"InterpolateFunctions", PyvtkQuadraticEdge_InterpolateFunctions, METH_VARARGS,
  ...
  {"InterpolateDerivs", PyvtkQuadraticEdge_InterpolateDerivs, METH_VARARGS,
...
static PyTypeObject PyvtkQuadraticEdge_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonDataModel.vtkQuadraticEdge", // tp_name
...
PyObject *PyvtkQuadraticEdge_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkQuadraticEdge_Type, PyvtkQuadraticEdge_Methods,
    "vtkQuadraticEdge",
 &PyvtkQuadraticEdge_StaticNew);
...
{
  PyObject *o;
  o = PyvtkQuadraticEdge_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkQuadraticEdge", o) != 0)
  {
    Py_DECREF(o);
  }
