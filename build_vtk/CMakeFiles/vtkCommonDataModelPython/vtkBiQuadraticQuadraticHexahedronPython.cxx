...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkBiQuadraticQuadraticHexahedron(PyObject *dict); }
extern "C" { PyObject *PyvtkBiQuadraticQuadraticHexahedron_ClassNew(); }
...
static PyObject *
PyvtkBiQuadraticQuadraticHexahedron_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkBiQuadraticQuadraticHexahedron::IsTypeOf(temp0);
...
static PyObject *
PyvtkBiQuadraticQuadraticHexahedron_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkBiQuadraticQuadraticHexahedron_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkBiQuadraticQuadraticHexahedron::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkBiQuadraticQuadraticHexahedron_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkBiQuadraticQuadraticHexahedron::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkBiQuadraticQuadraticHexahedron_InterpolationFunctions(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkBiQuadraticQuadraticHexahedron_InterpolationDerivs(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkBiQuadraticQuadraticHexahedron_GetEdgeArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkBiQuadraticQuadraticHexahedron::GetEdgeArray(temp0);
...
static PyObject *
PyvtkBiQuadraticQuadraticHexahedron_GetFaceArray(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    const long long *tempr = vtkBiQuadraticQuadraticHexahedron::GetFaceArray(temp0);
...
static PyMethodDef PyvtkBiQuadraticQuadraticHexahedron_Methods[] = {
  {"IsTypeOf", PyvtkBiQuadraticQuadraticHexahedron_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkBiQuadraticQuadraticHexahedron_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkBiQuadraticQuadraticHexahedron_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkBiQuadraticQuadraticHexahedron\nC++: static vtkBiQuadraticQuadraticHexahedron *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkBiQuadraticQuadraticHexahedron_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkBiQuadraticQuadraticHexahedron\nC++: vtkBiQuadraticQuadraticHexahedron *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkBiQuadraticQuadraticHexahedron_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkBiQuadraticQuadraticHexahedron_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetCellType", PyvtkBiQuadraticQuadraticHexahedron_GetCellType, METH_VARARGS,
   "GetCellType(self) -> int\nC++: int GetCellType() override;\n\nImplement the vtkCell API. See the vtkCell API for descriptions\nof these methods.\n"},
  {"GetCellDimension", PyvtkBiQuadraticQuadraticHexahedron_GetCellDimension, METH_VARARGS,
   "GetCellDimension(self) -> int\nC++: int GetCellDimension() override;\n\nReturn the topological dimensional of the cell (0,1,2, or 3).\n"},
  {"GetNumberOfEdges", PyvtkBiQuadraticQuadraticHexahedron_GetNumberOfEdges, METH_VARARGS,
   "GetNumberOfEdges(self) -> int\nC++: int GetNumberOfEdges() override;\n\nReturn the number of edges in the cell.\n"},
  {"GetNumberOfFaces", PyvtkBiQuadraticQuadraticHexahedron_GetNumberOfFaces, METH_VARARGS,
   "GetNumberOfFaces(self) -> int\nC++: int GetNumberOfFaces() override;\n\nReturn the number of faces in the cell.\n"},
  {"GetEdge", PyvtkBiQuadraticQuadraticHexahedron_GetEdge, METH_VARARGS,
   "GetEdge(self, __a:int) -> vtkCell\nC++: vtkCell *GetEdge(int) override;\n\nReturn the edge cell from the edgeId of the cell.\n"},
  {"GetFace", PyvtkBiQuadraticQuadraticHexahedron_GetFace, METH_VARARGS,
  ...
  {"CellBoundary", PyvtkBiQuadraticQuadraticHexahedron_CellBoundary, METH_VARARGS,
  ...
  {"Contour", PyvtkBiQuadraticQuadraticHexahedron_Contour, METH_VARARGS,
  ...
  {"EvaluatePosition", PyvtkBiQuadraticQuadraticHexahedron_EvaluatePosition, METH_VARARGS,
  ...
  {"EvaluateLocation", PyvtkBiQuadraticQuadraticHexahedron_EvaluateLocation, METH_VARARGS,
  ...
  {"Triangulate", PyvtkBiQuadraticQuadraticHexahedron_Triangulate, METH_VARARGS,
  ...
  {"Derivatives", PyvtkBiQuadraticQuadraticHexahedron_Derivatives, METH_VARARGS,
  ...
  {"GetParametricCoords", PyvtkBiQuadraticQuadraticHexahedron_GetParametricCoords, METH_VARARGS,
  ...
  {"Clip", PyvtkBiQuadraticQuadraticHexahedron_Clip, METH_VARARGS,
  ...
  {"IntersectWithLine", PyvtkBiQuadraticQuadraticHexahedron_IntersectWithLine, METH_VARARGS,
  ...
  {"InterpolationFunctions", PyvtkBiQuadraticQuadraticHexahedron_InterpolationFunctions, METH_VARARGS,
  ...
  {"InterpolationDerivs", PyvtkBiQuadraticQuadraticHexahedron_InterpolationDerivs, METH_VARARGS,
   "InterpolationDerivs(pcoords:(float, float, float), derivs:[float,\n    float, float, float, float, float, float, float, float, float,\n     float, float, float, float, float, float, float, float,\n    float, float, float, float, float, float, float, float, float,\n     float, float, float, float, float, float, float, float,\n    float, float, float, float, float, float, float, float, float,\n     float, float, float, float, float, float, float, float,\n    float, float, float, float, float, float, float, float, float,\n     float, float, float, float, float, float, float, float,\n    float, float, float]) -> None\nC++: static void InterpolationDerivs(const double pcoords[3],\n    double derivs[72])\n\n"},
  {"InterpolateFunctions", PyvtkBiQuadraticQuadraticHexahedron_InterpolateFunctions, METH_VARARGS,
  ...
  {"InterpolateDerivs", PyvtkBiQuadraticQuadraticHexahedron_InterpolateDerivs, METH_VARARGS,
   "InterpolateDerivs(self, pcoords:(float, float, float),\n    derivs:[float, float, float, float, float, float, float,\n    float, float, float, float, float, float, float, float, float,\n     float, float, float, float, float, float, float, float,\n    float, float, float, float, float, float, float, float, float,\n     float, float, float, float, float, float, float, float,\n    float, float, float, float, float, float, float, float, float,\n     float, float, float, float, float, float, float, float,\n    float, float, float, float, float, float, float, float, float,\n     float, float, float, float, float]) -> None\nC++: void InterpolateDerivs(const double pcoords[3],\n    double derivs[72]) override;\n\n"},
  {"GetEdgeArray", PyvtkBiQuadraticQuadraticHexahedron_GetEdgeArray, METH_VARARGS,
  ...
  {"GetFaceArray", PyvtkBiQuadraticQuadraticHexahedron_GetFaceArray, METH_VARARGS,
...
static PyTypeObject PyvtkBiQuadraticQuadraticHexahedron_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonDataModel.vtkBiQuadraticQuadraticHexahedron", // tp_name
  ...
  PyvtkBiQuadraticQuadraticHexahedron_Doc, // tp_doc
...
PyObject *PyvtkBiQuadraticQuadraticHexahedron_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkBiQuadraticQuadraticHexahedron_Type, PyvtkBiQuadraticQuadraticHexahedron_Methods,
    "vtkBiQuadraticQuadraticHexahedron",
 &PyvtkBiQuadraticQuadraticHexahedron_StaticNew);
...
{
  PyObject *o;
  o = PyvtkBiQuadraticQuadraticHexahedron_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkBiQuadraticQuadraticHexahedron", o) != 0)
  {
    Py_DECREF(o);
  }
