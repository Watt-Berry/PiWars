...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkQuadraticLinearQuad(PyObject *dict); }
extern "C" { PyObject *PyvtkQuadraticLinearQuad_ClassNew(); }
...
static PyObject *
PyvtkQuadraticLinearQuad_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkQuadraticLinearQuad::IsTypeOf(temp0);
...
static PyObject *
PyvtkQuadraticLinearQuad_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkQuadraticLinearQuad_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkQuadraticLinearQuad::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkQuadraticLinearQuad_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkQuadraticLinearQuad::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkQuadraticLinearQuad_InterpolationFunctions(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkQuadraticLinearQuad_InterpolationDerivs(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkQuadraticLinearQuad_GetEdgeArray(PyObject * /*unused*/, PyObject *args)
{
...
static PyMethodDef PyvtkQuadraticLinearQuad_Methods[] = {
  {"IsTypeOf", PyvtkQuadraticLinearQuad_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkQuadraticLinearQuad_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkQuadraticLinearQuad_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkQuadraticLinearQuad\nC++: static vtkQuadraticLinearQuad *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkQuadraticLinearQuad_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkQuadraticLinearQuad\nC++: vtkQuadraticLinearQuad *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkQuadraticLinearQuad_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkQuadraticLinearQuad_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetCellType", PyvtkQuadraticLinearQuad_GetCellType, METH_VARARGS,
   "GetCellType(self) -> int\nC++: int GetCellType() override;\n\nImplement the vtkCell API. See the vtkCell API for descriptions\nof these methods.\n"},
  {"GetCellDimension", PyvtkQuadraticLinearQuad_GetCellDimension, METH_VARARGS,
   "GetCellDimension(self) -> int\nC++: int GetCellDimension() override;\n\nReturn the topological dimensional of the cell (0,1,2, or 3).\n"},
  {"GetNumberOfEdges", PyvtkQuadraticLinearQuad_GetNumberOfEdges, METH_VARARGS,
   "GetNumberOfEdges(self) -> int\nC++: int GetNumberOfEdges() override;\n\nReturn the number of edges in the cell.\n"},
  {"GetNumberOfFaces", PyvtkQuadraticLinearQuad_GetNumberOfFaces, METH_VARARGS,
   "GetNumberOfFaces(self) -> int\nC++: int GetNumberOfFaces() override;\n\nReturn the number of faces in the cell.\n"},
  {"GetEdge", PyvtkQuadraticLinearQuad_GetEdge, METH_VARARGS,
   "GetEdge(self, __a:int) -> vtkCell\nC++: vtkCell *GetEdge(int) override;\n\nReturn the edge cell from the edgeId of the cell.\n"},
  {"GetFace", PyvtkQuadraticLinearQuad_GetFace, METH_VARARGS,
  ...
  {"CellBoundary", PyvtkQuadraticLinearQuad_CellBoundary, METH_VARARGS,
  ...
  {"Contour", PyvtkQuadraticLinearQuad_Contour, METH_VARARGS,
  ...
  {"EvaluatePosition", PyvtkQuadraticLinearQuad_EvaluatePosition, METH_VARARGS,
  ...
  {"EvaluateLocation", PyvtkQuadraticLinearQuad_EvaluateLocation, METH_VARARGS,
  ...
  {"Triangulate", PyvtkQuadraticLinearQuad_Triangulate, METH_VARARGS,
  ...
  {"Derivatives", PyvtkQuadraticLinearQuad_Derivatives, METH_VARARGS,
  ...
  {"GetParametricCoords", PyvtkQuadraticLinearQuad_GetParametricCoords, METH_VARARGS,
  ...
  {"Clip", PyvtkQuadraticLinearQuad_Clip, METH_VARARGS,
  ...
  {"IntersectWithLine", PyvtkQuadraticLinearQuad_IntersectWithLine, METH_VARARGS,
  ...
  {"GetParametricCenter", PyvtkQuadraticLinearQuad_GetParametricCenter, METH_VARARGS,
   "GetParametricCenter(self, pcoords:[float, float, float]) -> int\nC++: int GetParametricCenter(double pcoords[3]) override;\n\nReturn the center of the pyramid in parametric coordinates.\n"},
  {"InterpolationFunctions", PyvtkQuadraticLinearQuad_InterpolationFunctions, METH_VARARGS,
  ...
  {"InterpolationDerivs", PyvtkQuadraticLinearQuad_InterpolationDerivs, METH_VARARGS,
  ...
  {"InterpolateFunctions", PyvtkQuadraticLinearQuad_InterpolateFunctions, METH_VARARGS,
  ...
  {"InterpolateDerivs", PyvtkQuadraticLinearQuad_InterpolateDerivs, METH_VARARGS,
...
static PyTypeObject PyvtkQuadraticLinearQuad_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonDataModel.vtkQuadraticLinearQuad", // tp_name
  ...
  PyvtkQuadraticLinearQuad_Doc, // tp_doc
...
PyObject *PyvtkQuadraticLinearQuad_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkQuadraticLinearQuad_Type, PyvtkQuadraticLinearQuad_Methods,
    "vtkQuadraticLinearQuad",
 &PyvtkQuadraticLinearQuad_StaticNew);
...
{
  PyObject *o;
  o = PyvtkQuadraticLinearQuad_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkQuadraticLinearQuad", o) != 0)
  {
    Py_DECREF(o);
  }
