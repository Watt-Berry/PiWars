...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkType(PyObject *dict); }
  ...
  PyObject *dict)
{
  ...
  for (int c = 0; c < 2; c++)
  {
    static const struct { const char *name; char value; }
      constants[2] = {
        { "VTK_CHAR_MIN", VTK_TYPE_CAST(char, 0u) },
        { "VTK_CHAR_MAX", VTK_TYPE_CAST(char, 0xffu) },
      };
