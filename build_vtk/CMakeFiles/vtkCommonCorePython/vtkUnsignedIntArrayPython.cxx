...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkUnsignedIntArray(PyObject *dict); }
extern "C" { PyObject *PyvtkUnsignedIntArray_ClassNew(); }
...
static PyObject *
PyvtkUnsignedIntArray_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkUnsignedIntArray::IsTypeOf(temp0);
...
static PyObject *
PyvtkUnsignedIntArray_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkUnsignedIntArray_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkUnsignedIntArray::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkUnsignedIntArray_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkUnsignedIntArray::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkUnsignedIntArray_ExtendedNew(PyObject * /*unused*/, PyObject *args)
{
  ...
  {
    vtkUnsignedIntArray *tempr = vtkUnsignedIntArray::ExtendedNew();
...
static PyObject *
PyvtkUnsignedIntArray_GetTypedTuple(PyObject *self, PyObject *args)
{
                      ...
                      "0 <= i && i < GetNumberOfTuples()"))
  {
    ...
    {
      op->vtkUnsignedIntArray::GetTypedTuple(temp0, temp1);
    }
...
static PyObject *
PyvtkUnsignedIntArray_SetTypedTuple(PyObject *self, PyObject *args)
{
                      ...
                      "0 <= i && i < GetNumberOfTuples()"))
  {
    ...
    {
      op->vtkUnsignedIntArray::SetTypedTuple(temp0, temp1);
    }
...
static PyObject *
PyvtkUnsignedIntArray_InsertTypedTuple(PyObject *self, PyObject *args)
{
      ...
      ap.CheckPrecond((0 <= temp0), "0 <= i"))
  {
    ...
    {
      op->vtkUnsignedIntArray::InsertTypedTuple(temp0, temp1);
    }
...
static PyObject *
PyvtkUnsignedIntArray_InsertNextTypedTuple(PyObject *self, PyObject *args)
{
      ...
      ap.CheckSizeHint(0, size0, op->GetNumberOfComponents()))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkUnsignedIntArray::InsertNextTypedTuple(temp0));
...
static PyObject *
PyvtkUnsignedIntArray_SetArray_s1(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp2))
  {
    ...
    {
      op->vtkUnsignedIntArray::SetArray(temp0, temp1, temp2);
    }
...
static PyObject *
PyvtkUnsignedIntArray_SetArray_s2(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "SetArray");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkUnsignedIntArray *op = static_cast<vtkUnsignedIntArray *>(vp);
      ...
      ap.GetValue(temp3))
  {
    ...
    {
      op->vtkUnsignedIntArray::SetArray(temp0, temp1, temp2, temp3);
    }
...
static PyObject *
PyvtkUnsignedIntArray_SetArray(PyObject *self, PyObject *args)
{
  int nargs = vtkPythonArgs::GetArgCount(self, args);
  ...
  {
    case 3:
      return PyvtkUnsignedIntArray_SetArray_s1(self, args);
    case 4:
      return PyvtkUnsignedIntArray_SetArray_s2(self, args);
  }
...
static PyObject *
PyvtkUnsignedIntArray_FastDownCast(PyObject * /*unused*/, PyObject *args)
{
  ...
  {
    vtkUnsignedIntArray *tempr = vtkUnsignedIntArray::FastDownCast(temp0);
...
static PyObject *
PyvtkUnsignedIntArray_GetDataTypeValueMin(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkUnsignedIntArray_GetDataTypeValueMax(PyObject * /*unused*/, PyObject *args)
{
...
static PyMethodDef PyvtkUnsignedIntArray_Methods[] = {
  {"IsTypeOf", PyvtkUnsignedIntArray_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkUnsignedIntArray_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkUnsignedIntArray_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkUnsignedIntArray\nC++: static vtkUnsignedIntArray *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkUnsignedIntArray_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkUnsignedIntArray\nC++: vtkUnsignedIntArray *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkUnsignedIntArray_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkUnsignedIntArray_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"ExtendedNew", PyvtkUnsignedIntArray_ExtendedNew, METH_VARARGS,
   "ExtendedNew() -> vtkUnsignedIntArray\nC++: static vtkUnsignedIntArray *ExtendedNew()\n\n"},
  {"GetDataType", PyvtkUnsignedIntArray_GetDataType, METH_VARARGS,
   "GetDataType(self) -> int\nC++: int GetDataType() override;\n\nReturn the underlying data type. An integer indicating data type\nis returned as specified in vtkType.h.\n"},
  {"GetTypedTuple", PyvtkUnsignedIntArray_GetTypedTuple, METH_VARARGS,
   "GetTypedTuple(self, i:int, tuple:[int, ...]) -> None\nC++: void GetTypedTuple(vtkIdType i, unsigned int *tuple)\n\n"},
  {"SetTypedTuple", PyvtkUnsignedIntArray_SetTypedTuple, METH_VARARGS,
   "SetTypedTuple(self, i:int, tuple:(int, ...)) -> None\nC++: void SetTypedTuple(vtkIdType i, const unsigned int *tuple)\n\n"},
  {"InsertTypedTuple", PyvtkUnsignedIntArray_InsertTypedTuple, METH_VARARGS,
   "InsertTypedTuple(self, i:int, tuple:(int, ...)) -> None\nC++: void InsertTypedTuple(vtkIdType i, const unsigned int *tuple)\n\n"},
  {"InsertNextTypedTuple", PyvtkUnsignedIntArray_InsertNextTypedTuple, METH_VARARGS,
   "InsertNextTypedTuple(self, tuple:(int, ...)) -> int\nC++: vtkIdType InsertNextTypedTuple(const unsigned int *tuple)\n\n"},
  {"GetValue", PyvtkUnsignedIntArray_GetValue, METH_VARARGS,
   "GetValue(self, id:int) -> int\nC++: unsigned int GetValue(vtkIdType id)\n\n"},
  {"SetValue", PyvtkUnsignedIntArray_SetValue, METH_VARARGS,
   "SetValue(self, id:int, value:int) -> None\nC++: void SetValue(vtkIdType id, unsigned int value)\n\n"},
  {"SetNumberOfValues", PyvtkUnsignedIntArray_SetNumberOfValues, METH_VARARGS,
  ...
  {"InsertValue", PyvtkUnsignedIntArray_InsertValue, METH_VARARGS,
   "InsertValue(self, id:int, f:int) -> None\nC++: void InsertValue(vtkIdType id, unsigned int f)\n\n"},
  {"InsertNextValue", PyvtkUnsignedIntArray_InsertNextValue, METH_VARARGS,
   "InsertNextValue(self, f:int) -> int\nC++: vtkIdType InsertNextValue(unsigned int f)\n\n"},
  {"GetValueRange", PyvtkUnsignedIntArray_GetValueRange, METH_VARARGS,
  ...
  {"WritePointer", PyvtkUnsignedIntArray_WritePointer, METH_VARARGS,
   "WritePointer(self, id:int, number:int) -> Pointer\nC++: unsigned int *WritePointer(vtkIdType id, vtkIdType number)\n\n"},
  {"GetPointer", PyvtkUnsignedIntArray_GetPointer, METH_VARARGS,
   "GetPointer(self, id:int) -> Pointer\nC++: unsigned int *GetPointer(vtkIdType id)\n\n"},
  {"SetArray", PyvtkUnsignedIntArray_SetArray, METH_VARARGS,
  ...
  {"FastDownCast", PyvtkUnsignedIntArray_FastDownCast, METH_VARARGS,
   "FastDownCast(source:vtkAbstractArray) -> vtkUnsignedIntArray\nC++: static vtkUnsignedIntArray *FastDownCast(\n    vtkAbstractArray *source)\n\nA faster alternative to SafeDownCast for downcasting\nvtkAbstractArrays.\n"},
  {"GetDataTypeValueMin", PyvtkUnsignedIntArray_GetDataTypeValueMin, METH_VARARGS,
   "GetDataTypeValueMin() -> int\nC++: static unsigned int GetDataTypeValueMin()\n\nGet the minimum data value in its native type.\n"},
  {"GetDataTypeValueMax", PyvtkUnsignedIntArray_GetDataTypeValueMax, METH_VARARGS,
...
static PyTypeObject PyvtkUnsignedIntArray_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonCore.vtkUnsignedIntArray", // tp_name
  ...
  PyvtkUnsignedIntArray_Doc, // tp_doc
...
PyObject *PyvtkUnsignedIntArray_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkUnsignedIntArray_Type, PyvtkUnsignedIntArray_Methods,
    "vtkUnsignedIntArray",
 &PyvtkUnsignedIntArray_StaticNew);
...
{
  PyObject *o;
  o = PyvtkUnsignedIntArray_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkUnsignedIntArray", o) != 0)
  {
    Py_DECREF(o);
  }
