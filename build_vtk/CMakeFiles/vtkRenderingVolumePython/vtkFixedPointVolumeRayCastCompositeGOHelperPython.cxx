...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkFixedPointVolumeRayCastCompositeGOHelper(PyObject *dict); }
extern "C" { PyObject *PyvtkFixedPointVolumeRayCastCompositeGOHelper_ClassNew(); }
...
static PyObject *
PyvtkFixedPointVolumeRayCastCompositeGOHelper_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkFixedPointVolumeRayCastCompositeGOHelper::IsTypeOf(temp0);
...
static PyObject *
PyvtkFixedPointVolumeRayCastCompositeGOHelper_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkFixedPointVolumeRayCastCompositeGOHelper_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkFixedPointVolumeRayCastCompositeGOHelper::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkFixedPointVolumeRayCastCompositeGOHelper_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkFixedPointVolumeRayCastCompositeGOHelper::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkFixedPointVolumeRayCastCompositeGOHelper_Methods[] = {
  {"IsTypeOf", PyvtkFixedPointVolumeRayCastCompositeGOHelper_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkFixedPointVolumeRayCastCompositeGOHelper_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkFixedPointVolumeRayCastCompositeGOHelper_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase)\n    -> vtkFixedPointVolumeRayCastCompositeGOHelper\nC++: static vtkFixedPointVolumeRayCastCompositeGOHelper *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkFixedPointVolumeRayCastCompositeGOHelper_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkFixedPointVolumeRayCastCompositeGOHelper\nC++: vtkFixedPointVolumeRayCastCompositeGOHelper *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkFixedPointVolumeRayCastCompositeGOHelper_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkFixedPointVolumeRayCastCompositeGOHelper_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GenerateImage", PyvtkFixedPointVolumeRayCastCompositeGOHelper_GenerateImage, METH_VARARGS,
...
static PyTypeObject PyvtkFixedPointVolumeRayCastCompositeGOHelper_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkRenderingVolume.vtkFixedPointVolumeRayCastCompositeGOHelper", // tp_name
  ...
  PyvtkFixedPointVolumeRayCastCompositeGOHelper_Doc, // tp_doc
...
PyObject *PyvtkFixedPointVolumeRayCastCompositeGOHelper_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkFixedPointVolumeRayCastCompositeGOHelper_Type, PyvtkFixedPointVolumeRayCastCompositeGOHelper_Methods,
    "vtkFixedPointVolumeRayCastCompositeGOHelper",
 &PyvtkFixedPointVolumeRayCastCompositeGOHelper_StaticNew);
...
{
  PyObject *o;
  o = PyvtkFixedPointVolumeRayCastCompositeGOHelper_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkFixedPointVolumeRayCastCompositeGOHelper", o) != 0)
  {
    Py_DECREF(o);
  }
