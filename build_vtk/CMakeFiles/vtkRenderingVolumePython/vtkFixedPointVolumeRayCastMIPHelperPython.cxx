...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkFixedPointVolumeRayCastMIPHelper(PyObject *dict); }
extern "C" { PyObject *PyvtkFixedPointVolumeRayCastMIPHelper_ClassNew(); }
...
static PyObject *
PyvtkFixedPointVolumeRayCastMIPHelper_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkFixedPointVolumeRayCastMIPHelper::IsTypeOf(temp0);
...
static PyObject *
PyvtkFixedPointVolumeRayCastMIPHelper_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkFixedPointVolumeRayCastMIPHelper_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkFixedPointVolumeRayCastMIPHelper::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkFixedPointVolumeRayCastMIPHelper_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkFixedPointVolumeRayCastMIPHelper::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkFixedPointVolumeRayCastMIPHelper_Methods[] = {
  {"IsTypeOf", PyvtkFixedPointVolumeRayCastMIPHelper_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkFixedPointVolumeRayCastMIPHelper_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkFixedPointVolumeRayCastMIPHelper_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase)\n    -> vtkFixedPointVolumeRayCastMIPHelper\nC++: static vtkFixedPointVolumeRayCastMIPHelper *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkFixedPointVolumeRayCastMIPHelper_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkFixedPointVolumeRayCastMIPHelper\nC++: vtkFixedPointVolumeRayCastMIPHelper *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkFixedPointVolumeRayCastMIPHelper_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkFixedPointVolumeRayCastMIPHelper_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GenerateImage", PyvtkFixedPointVolumeRayCastMIPHelper_GenerateImage, METH_VARARGS,
...
static PyTypeObject PyvtkFixedPointVolumeRayCastMIPHelper_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkRenderingVolume.vtkFixedPointVolumeRayCastMIPHelper", // tp_name
  ...
  PyvtkFixedPointVolumeRayCastMIPHelper_Doc, // tp_doc
...
PyObject *PyvtkFixedPointVolumeRayCastMIPHelper_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkFixedPointVolumeRayCastMIPHelper_Type, PyvtkFixedPointVolumeRayCastMIPHelper_Methods,
    "vtkFixedPointVolumeRayCastMIPHelper",
 &PyvtkFixedPointVolumeRayCastMIPHelper_StaticNew);
...
{
  PyObject *o;
  o = PyvtkFixedPointVolumeRayCastMIPHelper_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkFixedPointVolumeRayCastMIPHelper", o) != 0)
  {
    Py_DECREF(o);
  }
