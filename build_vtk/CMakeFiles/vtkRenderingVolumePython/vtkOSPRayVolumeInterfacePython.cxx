...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkOSPRayVolumeInterface(PyObject *dict); }
extern "C" { PyObject *PyvtkOSPRayVolumeInterface_ClassNew(); }
...
static PyObject *
PyvtkOSPRayVolumeInterface_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkOSPRayVolumeInterface_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkOSPRayVolumeInterface_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkOSPRayVolumeInterface::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkOSPRayVolumeInterface_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkOSPRayVolumeInterface::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkOSPRayVolumeInterface_Methods[] = {
  ...
  {"SafeDownCast", PyvtkOSPRayVolumeInterface_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkOSPRayVolumeInterface\nC++: static vtkOSPRayVolumeInterface *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkOSPRayVolumeInterface_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkOSPRayVolumeInterface\nC++: vtkOSPRayVolumeInterface *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkOSPRayVolumeInterface_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkOSPRayVolumeInterface_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkOSPRayVolumeInterface_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkRenderingVolume.vtkOSPRayVolumeInterface", // tp_name
