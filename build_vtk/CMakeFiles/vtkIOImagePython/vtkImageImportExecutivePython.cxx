...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkImageImportExecutive(PyObject *dict); }
extern "C" { PyObject *PyvtkImageImportExecutive_ClassNew(); }


static PyObject *
PyvtkImageImportExecutive_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkImageImportExecutive_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkImageImportExecutive_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkImageImportExecutive::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkImageImportExecutive_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkImageImportExecutive::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkImageImportExecutive_Methods[] = {
  ...
  {"SafeDownCast", PyvtkImageImportExecutive_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkImageImportExecutive\nC++: static vtkImageImportExecutive *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkImageImportExecutive_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkImageImportExecutive\nC++: vtkImageImportExecutive *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkImageImportExecutive_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkImageImportExecutive_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkImageImportExecutive_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkIOImage.vtkImageImportExecutive", // tp_name
...
PyObject *PyvtkImageImportExecutive_ClassNew()
{
 ...
 &PyvtkImageImportExecutive_StaticNew);
  ...
  pytype->tp_base = vtkPythonUtil::FindBaseTypeObject("vtkStreamingDemandDrivenPipeline");
