...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkNrrdReader(PyObject *dict); }
extern "C" { PyObject *PyvtkNrrdReader_ClassNew(); }
...
static PyObject *
PyvtkNrrdReader_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkNrrdReader_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkNrrdReader_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkNrrdReader::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkNrrdReader_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkNrrdReader::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkNrrdReader_Methods[] = {
  ...
  {"SafeDownCast", PyvtkNrrdReader_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkNrrdReader\nC++: static vtkNrrdReader *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkNrrdReader_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkNrrdReader\nC++: vtkNrrdReader *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkNrrdReader_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkNrrdReader_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static const char *PyvtkNrrdReader_Doc =
  ...
  "read.  This reader only supports nrrd files in raw, ascii and gzip\n"
  "format.  Other encodings like hex will result in errors.  When\n"
  "reading in detached headers, this only supports reading one file that\n"
  "is detached.\n\n";
...
static PyTypeObject PyvtkNrrdReader_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkIOImage.vtkNrrdReader", // tp_name
