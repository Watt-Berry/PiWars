...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkSquarifyLayoutStrategy(PyObject *dict); }
extern "C" { PyObject *PyvtkSquarifyLayoutStrategy_ClassNew(); }
...
static PyObject *
PyvtkSquarifyLayoutStrategy_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkSquarifyLayoutStrategy::IsTypeOf(temp0);
...
PyvtkSquarifyLayoutStrategy_IsA(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    int tempr = (ap.IsBound() ?
      op->IsA(temp0) :
      op->vtkSquarifyLayoutStrategy::IsA(temp0));
...
static PyObject *
PyvtkSquarifyLayoutStrategy_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
  ...
  {
    vtkSquarifyLayoutStrategy *tempr = vtkSquarifyLayoutStrategy::SafeDownCast(temp0);
...
PyvtkSquarifyLayoutStrategy_NewInstance(PyObject *self, PyObject *args)
{
  ...
  {
    vtkSquarifyLayoutStrategy *tempr = (ap.IsBound() ?
      op->NewInstance() :
      op->vtkSquarifyLayoutStrategy::NewInstance());
...
static PyObject *
PyvtkSquarifyLayoutStrategy_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkSquarifyLayoutStrategy::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkSquarifyLayoutStrategy_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkSquarifyLayoutStrategy::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkSquarifyLayoutStrategy_Methods[] = {
  {"IsTypeOf", PyvtkSquarifyLayoutStrategy_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkSquarifyLayoutStrategy_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkSquarifyLayoutStrategy_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkSquarifyLayoutStrategy\nC++: static vtkSquarifyLayoutStrategy *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkSquarifyLayoutStrategy_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkSquarifyLayoutStrategy\nC++: vtkSquarifyLayoutStrategy *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkSquarifyLayoutStrategy_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkSquarifyLayoutStrategy_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"Layout", PyvtkSquarifyLayoutStrategy_Layout, METH_VARARGS,
...
static PyTypeObject PyvtkSquarifyLayoutStrategy_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkInfovisLayout.vtkSquarifyLayoutStrategy", // tp_name
  ...
  PyvtkSquarifyLayoutStrategy_Doc, // tp_doc
...
PyObject *PyvtkSquarifyLayoutStrategy_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkSquarifyLayoutStrategy_Type, PyvtkSquarifyLayoutStrategy_Methods,
    "vtkSquarifyLayoutStrategy",
 &PyvtkSquarifyLayoutStrategy_StaticNew);
...
{
  PyObject *o;
  o = PyvtkSquarifyLayoutStrategy_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkSquarifyLayoutStrategy", o) != 0)
  {
    Py_DECREF(o);
  }
