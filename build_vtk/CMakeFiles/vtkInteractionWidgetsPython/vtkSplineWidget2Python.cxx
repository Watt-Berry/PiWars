...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkSplineWidget2(PyObject *dict); }
extern "C" { PyObject *PyvtkSplineWidget2_ClassNew(); }
...
static PyObject *
PyvtkSplineWidget2_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkSplineWidget2_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkSplineWidget2_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkSplineWidget2::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkSplineWidget2_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkSplineWidget2::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkSplineWidget2_SetEnabled(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    ...
    {
      op->vtkSplineWidget2::SetEnabled(temp0);
    }
...
static PyTypeObject PyvtkSplineWidget2_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkInteractionWidgets.vtkSplineWidget2", // tp_name
