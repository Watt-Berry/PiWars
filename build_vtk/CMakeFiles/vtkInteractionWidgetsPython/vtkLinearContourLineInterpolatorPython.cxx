...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkLinearContourLineInterpolator(PyObject *dict); }
extern "C" { PyObject *PyvtkLinearContourLineInterpolator_ClassNew(); }
...
static PyObject *
PyvtkLinearContourLineInterpolator_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkLinearContourLineInterpolator::IsTypeOf(temp0);
...
static PyObject *
PyvtkLinearContourLineInterpolator_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkLinearContourLineInterpolator_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkLinearContourLineInterpolator::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkLinearContourLineInterpolator_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkLinearContourLineInterpolator::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkLinearContourLineInterpolator_Methods[] = {
  {"IsTypeOf", PyvtkLinearContourLineInterpolator_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkLinearContourLineInterpolator_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkLinearContourLineInterpolator_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkLinearContourLineInterpolator\nC++: static vtkLinearContourLineInterpolator *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkLinearContourLineInterpolator_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkLinearContourLineInterpolator\nC++: vtkLinearContourLineInterpolator *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkLinearContourLineInterpolator_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkLinearContourLineInterpolator_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"InterpolateLine", PyvtkLinearContourLineInterpolator_InterpolateLine, METH_VARARGS,
...
static PyTypeObject PyvtkLinearContourLineInterpolator_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkInteractionWidgets.vtkLinearContourLineInterpolator", // tp_name
  ...
  PyvtkLinearContourLineInterpolator_Doc, // tp_doc
...
PyObject *PyvtkLinearContourLineInterpolator_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkLinearContourLineInterpolator_Type, PyvtkLinearContourLineInterpolator_Methods,
    "vtkLinearContourLineInterpolator",
 &PyvtkLinearContourLineInterpolator_StaticNew);
...
{
  PyObject *o;
  o = PyvtkLinearContourLineInterpolator_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkLinearContourLineInterpolator", o) != 0)
  {
    Py_DECREF(o);
  }
