...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkParametricCrossCap(PyObject *dict); }
extern "C" { PyObject *PyvtkParametricCrossCap_ClassNew(); }
...
static PyObject *
PyvtkParametricCrossCap_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkParametricCrossCap::IsTypeOf(temp0);
...
static PyObject *
PyvtkParametricCrossCap_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkParametricCrossCap_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkParametricCrossCap::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkParametricCrossCap_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkParametricCrossCap::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkParametricCrossCap_Methods[] = {
  {"IsTypeOf", PyvtkParametricCrossCap_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkParametricCrossCap_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkParametricCrossCap_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkParametricCrossCap\nC++: static vtkParametricCrossCap *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkParametricCrossCap_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkParametricCrossCap\nC++: vtkParametricCrossCap *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkParametricCrossCap_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkParametricCrossCap_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetDimension", PyvtkParametricCrossCap_GetDimension, METH_VARARGS,
   "GetDimension(self) -> int\nC++: int GetDimension() override;\n\nReturn the parametric dimension of the class.\n"},
  {"Evaluate", PyvtkParametricCrossCap_Evaluate, METH_VARARGS,
  ...
  {"EvaluateScalar", PyvtkParametricCrossCap_EvaluateScalar, METH_VARARGS,
...
static PyTypeObject PyvtkParametricCrossCap_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonComputationalGeometry.vtkParametricCrossCap", // tp_name
  ...
  PyvtkParametricCrossCap_Doc, // tp_doc
...
PyObject *PyvtkParametricCrossCap_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkParametricCrossCap_Type, PyvtkParametricCrossCap_Methods,
    "vtkParametricCrossCap",
 &PyvtkParametricCrossCap_StaticNew);
...
{
  PyObject *o;
  o = PyvtkParametricCrossCap_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkParametricCrossCap", o) != 0)
  {
    Py_DECREF(o);
  }
