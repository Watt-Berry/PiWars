...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkParametricKlein(PyObject *dict); }
extern "C" { PyObject *PyvtkParametricKlein_ClassNew(); }
...
static PyObject *
PyvtkParametricKlein_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkParametricKlein::IsTypeOf(temp0);
...
static PyObject *
PyvtkParametricKlein_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkParametricKlein_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkParametricKlein::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkParametricKlein_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkParametricKlein::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkParametricKlein_Methods[] = {
  {"IsTypeOf", PyvtkParametricKlein_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkParametricKlein_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkParametricKlein_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkParametricKlein\nC++: static vtkParametricKlein *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkParametricKlein_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkParametricKlein\nC++: vtkParametricKlein *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkParametricKlein_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkParametricKlein_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetDimension", PyvtkParametricKlein_GetDimension, METH_VARARGS,
   "GetDimension(self) -> int\nC++: int GetDimension() override;\n\nReturn the parametric dimension of the class.\n"},
  {"Evaluate", PyvtkParametricKlein_Evaluate, METH_VARARGS,
  ...
  {"EvaluateScalar", PyvtkParametricKlein_EvaluateScalar, METH_VARARGS,
...
static PyTypeObject PyvtkParametricKlein_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonComputationalGeometry.vtkParametricKlein", // tp_name
  ...
  PyvtkParametricKlein_Doc, // tp_doc
...
PyObject *PyvtkParametricKlein_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkParametricKlein_Type, PyvtkParametricKlein_Methods,
    "vtkParametricKlein",
 &PyvtkParametricKlein_StaticNew);
  ...
  PyObject *dict)
{
  ...
  if (o && PyDict_SetItemString(dict, "vtkParametricKlein", o) != 0)
  {
    Py_DECREF(o);
  }
