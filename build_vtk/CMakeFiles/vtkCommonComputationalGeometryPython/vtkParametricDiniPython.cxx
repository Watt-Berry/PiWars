...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkParametricDini(PyObject *dict); }
extern "C" { PyObject *PyvtkParametricDini_ClassNew(); }
...
static PyObject *
PyvtkParametricDini_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkParametricDini::IsTypeOf(temp0);
...
static PyObject *
PyvtkParametricDini_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkParametricDini_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkParametricDini::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkParametricDini_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkParametricDini::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkParametricDini_Methods[] = {
  {"IsTypeOf", PyvtkParametricDini_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkParametricDini_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkParametricDini_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkParametricDini\nC++: static vtkParametricDini *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkParametricDini_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkParametricDini\nC++: vtkParametricDini *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkParametricDini_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkParametricDini_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetDimension", PyvtkParametricDini_GetDimension, METH_VARARGS,
   "GetDimension(self) -> int\nC++: int GetDimension() override;\n\nReturn the parametric dimension of the class.\n"},
  {"SetA", PyvtkParametricDini_SetA, METH_VARARGS,
  ...
  {"GetA", PyvtkParametricDini_GetA, METH_VARARGS,
   "GetA(self) -> float\nC++: virtual double GetA()\n\n"},
  {"SetB", PyvtkParametricDini_SetB, METH_VARARGS,
   "SetB(self, _arg:float) -> None\nC++: virtual void SetB(double _arg)\n\nSet/Get the scale factor. See the definition in Parametric\nsurfaces referred to above. Default is 0.2\n"},
  {"GetB", PyvtkParametricDini_GetB, METH_VARARGS,
   "GetB(self) -> float\nC++: virtual double GetB()\n\n"},
  {"Evaluate", PyvtkParametricDini_Evaluate, METH_VARARGS,
  ...
  {"EvaluateScalar", PyvtkParametricDini_EvaluateScalar, METH_VARARGS,
...
static PyTypeObject PyvtkParametricDini_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonComputationalGeometry.vtkParametricDini", // tp_name
  ...
  PyvtkParametricDini_Doc, // tp_doc
...
PyObject *PyvtkParametricDini_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkParametricDini_Type, PyvtkParametricDini_Methods,
    "vtkParametricDini",
 &PyvtkParametricDini_StaticNew);
...
{
  PyObject *o;
  o = PyvtkParametricDini_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkParametricDini", o) != 0)
  {
    Py_DECREF(o);
  }
