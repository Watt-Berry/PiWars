...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkPipelineGraphSource(PyObject *dict); }
extern "C" { PyObject *PyvtkPipelineGraphSource_ClassNew(); }


static PyObject *
PyvtkPipelineGraphSource_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPipelineGraphSource_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPipelineGraphSource_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkPipelineGraphSource::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkPipelineGraphSource_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkPipelineGraphSource::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkPipelineGraphSource_Methods[] = {
  ...
  {"SafeDownCast", PyvtkPipelineGraphSource_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkPipelineGraphSource\nC++: static vtkPipelineGraphSource *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkPipelineGraphSource_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkPipelineGraphSource\nC++: vtkPipelineGraphSource *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkPipelineGraphSource_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkPipelineGraphSource_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"AddSink", PyvtkPipelineGraphSource_AddSink, METH_VARARGS,
   "AddSink(self, sink:vtkObject) -> None\nC++: void AddSink(vtkObject *sink)\n\n"},
  {"RemoveSink", PyvtkPipelineGraphSource_RemoveSink, METH_VARARGS,
   "RemoveSink(self, sink:vtkObject) -> None\nC++: void RemoveSink(vtkObject *sink)\n\n"},
...
static PyTypeObject PyvtkPipelineGraphSource_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkInfovisCore.vtkPipelineGraphSource", // tp_name
