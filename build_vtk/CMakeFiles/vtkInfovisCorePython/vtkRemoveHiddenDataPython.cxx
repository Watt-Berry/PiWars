...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkRemoveHiddenData(PyObject *dict); }
extern "C" { PyObject *PyvtkRemoveHiddenData_ClassNew(); }


static PyObject *
PyvtkRemoveHiddenData_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkRemoveHiddenData_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkRemoveHiddenData_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkRemoveHiddenData::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkRemoveHiddenData_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkRemoveHiddenData::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkRemoveHiddenData_Methods[] = {
  ...
  {"SafeDownCast", PyvtkRemoveHiddenData_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkRemoveHiddenData\nC++: static vtkRemoveHiddenData *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkRemoveHiddenData_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkRemoveHiddenData\nC++: vtkRemoveHiddenData *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkRemoveHiddenData_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkRemoveHiddenData_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkRemoveHiddenData_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkInfovisCore.vtkRemoveHiddenData", // tp_name
