...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkXMLPUnstructuredDataWriter(PyObject *dict); }
...
static PyObject *
PyvtkXMLPUnstructuredDataWriter_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkXMLPUnstructuredDataWriter_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkXMLPUnstructuredDataWriter_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkXMLPUnstructuredDataWriter::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkXMLPUnstructuredDataWriter_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkXMLPUnstructuredDataWriter::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkXMLPUnstructuredDataWriter_Methods[] = {
  ...
  {"SafeDownCast", PyvtkXMLPUnstructuredDataWriter_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkXMLPUnstructuredDataWriter\nC++: static vtkXMLPUnstructuredDataWriter *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkXMLPUnstructuredDataWriter_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkXMLPUnstructuredDataWriter\nC++: vtkXMLPUnstructuredDataWriter *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkXMLPUnstructuredDataWriter_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkXMLPUnstructuredDataWriter_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkXMLPUnstructuredDataWriter_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkIOParallelXML.vtkXMLPUnstructuredDataWriter", // tp_name
