...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkXMLPartitionedDataSetCollectionWriter(PyObject *dict); }
extern "C" { PyObject *PyvtkXMLPartitionedDataSetCollectionWriter_ClassNew(); }
...
static PyObject *
PyvtkXMLPartitionedDataSetCollectionWriter_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkXMLPartitionedDataSetCollectionWriter_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkXMLPartitionedDataSetCollectionWriter_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkXMLPartitionedDataSetCollectionWriter::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkXMLPartitionedDataSetCollectionWriter_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkXMLPartitionedDataSetCollectionWriter::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkXMLPartitionedDataSetCollectionWriter_SetInputData(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp0, "vtkPartitionedDataSetCollection"))
  {
    ...
    {
      op->vtkXMLPartitionedDataSetCollectionWriter::SetInputData(temp0);
    }
...
static PyMethodDef PyvtkXMLPartitionedDataSetCollectionWriter_Methods[] = {
  ...
  {"NewInstance", PyvtkXMLPartitionedDataSetCollectionWriter_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkXMLPartitionedDataSetCollectionWriter\nC++: vtkXMLPartitionedDataSetCollectionWriter *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkXMLPartitionedDataSetCollectionWriter_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkXMLPartitionedDataSetCollectionWriter_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SetInputData", PyvtkXMLPartitionedDataSetCollectionWriter_SetInputData, METH_VARARGS,
   "SetInputData(self, pd:vtkPartitionedDataSetCollection) -> None\nC++: void SetInputData(vtkPartitionedDataSetCollection *pd)\n\nPrimarily for backwards compatibility. `SetInputDataObject` is\nthe preferred API to use to set input.\n"},
...
static const char *PyvtkXMLPartitionedDataSetCollectionWriter_Doc =
  ...
  "vtkXMLPartitionedDataSetCollectionWriter is a writer for\n"
  "vtkPartitionedDataSetCollection. This writer supports distributed\n"
  "use-cases as well. Use `SetController` to set the controller to use\n"
  "in case of distributed execution. In that case, the meta-file is\n"
  "written only on the root node.\n\n";
...
static PyTypeObject PyvtkXMLPartitionedDataSetCollectionWriter_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkIOParallelXML.vtkXMLPartitionedDataSetCollectionWriter", // tp_name
