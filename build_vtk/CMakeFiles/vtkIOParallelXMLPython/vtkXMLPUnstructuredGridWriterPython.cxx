...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkXMLPUnstructuredGridWriter(PyObject *dict); }
extern "C" { PyObject *PyvtkXMLPUnstructuredGridWriter_ClassNew(); }
...
static PyObject *
PyvtkXMLPUnstructuredGridWriter_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkXMLPUnstructuredGridWriter_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkXMLPUnstructuredGridWriter_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkXMLPUnstructuredGridWriter::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkXMLPUnstructuredGridWriter_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkXMLPUnstructuredGridWriter::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkXMLPUnstructuredGridWriter_Methods[] = {
  ...
  {"SafeDownCast", PyvtkXMLPUnstructuredGridWriter_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkXMLPUnstructuredGridWriter\nC++: static vtkXMLPUnstructuredGridWriter *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkXMLPUnstructuredGridWriter_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkXMLPUnstructuredGridWriter\nC++: vtkXMLPUnstructuredGridWriter *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkXMLPUnstructuredGridWriter_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkXMLPUnstructuredGridWriter_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkXMLPUnstructuredGridWriter_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkIOParallelXML.vtkXMLPUnstructuredGridWriter", // tp_name
