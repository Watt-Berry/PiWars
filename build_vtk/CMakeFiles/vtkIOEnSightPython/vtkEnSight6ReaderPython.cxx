...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkEnSight6Reader(PyObject *dict); }
extern "C" { PyObject *PyvtkEnSight6Reader_ClassNew(); }
...
static PyObject *
PyvtkEnSight6Reader_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkEnSight6Reader::IsTypeOf(temp0);
...
static PyObject *
PyvtkEnSight6Reader_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkEnSight6Reader_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkEnSight6Reader::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkEnSight6Reader_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkEnSight6Reader::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkEnSight6Reader_Methods[] = {
  {"IsTypeOf", PyvtkEnSight6Reader_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkEnSight6Reader_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkEnSight6Reader_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkEnSight6Reader\nC++: static vtkEnSight6Reader *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkEnSight6Reader_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkEnSight6Reader\nC++: vtkEnSight6Reader *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkEnSight6Reader_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkEnSight6Reader_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkEnSight6Reader_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkIOEnSight.vtkEnSight6Reader", // tp_name
  ...
  PyvtkEnSight6Reader_Doc, // tp_doc
...
PyObject *PyvtkEnSight6Reader_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkEnSight6Reader_Type, PyvtkEnSight6Reader_Methods,
    "vtkEnSight6Reader",
 &PyvtkEnSight6Reader_StaticNew);
...
{
  PyObject *o;
  o = PyvtkEnSight6Reader_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkEnSight6Reader", o) != 0)
  {
    Py_DECREF(o);
  }
