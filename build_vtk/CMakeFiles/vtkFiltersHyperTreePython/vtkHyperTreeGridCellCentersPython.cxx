...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkHyperTreeGridCellCenters(PyObject *dict); }
extern "C" { PyObject *PyvtkHyperTreeGridCellCenters_ClassNew(); }


static PyObject *
PyvtkHyperTreeGridCellCenters_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkHyperTreeGridCellCenters_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkHyperTreeGridCellCenters_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkHyperTreeGridCellCenters::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkHyperTreeGridCellCenters_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkHyperTreeGridCellCenters::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkHyperTreeGridCellCenters_Methods[] = {
  ...
  {"SafeDownCast", PyvtkHyperTreeGridCellCenters_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkHyperTreeGridCellCenters\nC++: static vtkHyperTreeGridCellCenters *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkHyperTreeGridCellCenters_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkHyperTreeGridCellCenters\nC++: vtkHyperTreeGridCellCenters *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkHyperTreeGridCellCenters_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkHyperTreeGridCellCenters_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkHyperTreeGridCellCenters_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkFiltersHyperTree.vtkHyperTreeGridCellCenters", // tp_name
...
PyObject *PyvtkHyperTreeGridCellCenters_ClassNew()
{
 ...
 &PyvtkHyperTreeGridCellCenters_StaticNew);
  ...
  pytype->tp_base = vtkPythonUtil::FindBaseTypeObject("vtkCellCenters");
