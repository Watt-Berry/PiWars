...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkHierarchicalDataExtractLevel(PyObject *dict); }
extern "C" { PyObject *PyvtkHierarchicalDataExtractLevel_ClassNew(); }
...
static PyObject *
PyvtkHierarchicalDataExtractLevel_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkHierarchicalDataExtractLevel_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkHierarchicalDataExtractLevel_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkHierarchicalDataExtractLevel::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkHierarchicalDataExtractLevel_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkHierarchicalDataExtractLevel::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkHierarchicalDataExtractLevel_Methods[] = {
  ...
  {"SafeDownCast", PyvtkHierarchicalDataExtractLevel_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkHierarchicalDataExtractLevel\nC++: static vtkHierarchicalDataExtractLevel *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkHierarchicalDataExtractLevel_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkHierarchicalDataExtractLevel\nC++: vtkHierarchicalDataExtractLevel *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkHierarchicalDataExtractLevel_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkHierarchicalDataExtractLevel_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkHierarchicalDataExtractLevel_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkFiltersExtraction.vtkHierarchicalDataExtractLevel", // tp_name
