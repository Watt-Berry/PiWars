...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkProbeSelectedLocations(PyObject *dict); }
extern "C" { PyObject *PyvtkProbeSelectedLocations_ClassNew(); }


static PyObject *
PyvtkProbeSelectedLocations_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkProbeSelectedLocations_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkProbeSelectedLocations_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkProbeSelectedLocations::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkProbeSelectedLocations_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkProbeSelectedLocations::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkProbeSelectedLocations_Methods[] = {
  ...
  {"SafeDownCast", PyvtkProbeSelectedLocations_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkProbeSelectedLocations\nC++: static vtkProbeSelectedLocations *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkProbeSelectedLocations_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkProbeSelectedLocations\nC++: vtkProbeSelectedLocations *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkProbeSelectedLocations_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkProbeSelectedLocations_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkProbeSelectedLocations_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkFiltersExtraction.vtkProbeSelectedLocations", // tp_name
