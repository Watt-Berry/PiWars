...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkGridSynchronizedTemplates3D(PyObject *dict); }
extern "C" { PyObject *PyvtkGridSynchronizedTemplates3D_ClassNew(); }


static PyObject *
PyvtkGridSynchronizedTemplates3D_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkGridSynchronizedTemplates3D::IsTypeOf(temp0);
...
static PyObject *
PyvtkGridSynchronizedTemplates3D_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkGridSynchronizedTemplates3D_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkGridSynchronizedTemplates3D::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkGridSynchronizedTemplates3D_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkGridSynchronizedTemplates3D::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkGridSynchronizedTemplates3D_Methods[] = {
  {"IsTypeOf", PyvtkGridSynchronizedTemplates3D_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkGridSynchronizedTemplates3D_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkGridSynchronizedTemplates3D_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkGridSynchronizedTemplates3D\nC++: static vtkGridSynchronizedTemplates3D *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkGridSynchronizedTemplates3D_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkGridSynchronizedTemplates3D\nC++: vtkGridSynchronizedTemplates3D *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkGridSynchronizedTemplates3D_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkGridSynchronizedTemplates3D_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetMTime", PyvtkGridSynchronizedTemplates3D_GetMTime, METH_VARARGS,
   "GetMTime(self) -> int\nC++: vtkMTimeType GetMTime() override;\n\nBecause we delegate to vtkContourValues\n"},
  {"SetComputeNormals", PyvtkGridSynchronizedTemplates3D_SetComputeNormals, METH_VARARGS,
  ...
  {"GetComputeNormals", PyvtkGridSynchronizedTemplates3D_GetComputeNormals, METH_VARARGS,
   "GetComputeNormals(self) -> int\nC++: virtual vtkTypeBool GetComputeNormals()\n\n"},
  {"ComputeNormalsOn", PyvtkGridSynchronizedTemplates3D_ComputeNormalsOn, METH_VARARGS,
   "ComputeNormalsOn(self) -> None\nC++: virtual void ComputeNormalsOn()\n\n"},
  {"ComputeNormalsOff", PyvtkGridSynchronizedTemplates3D_ComputeNormalsOff, METH_VARARGS,
   "ComputeNormalsOff(self) -> None\nC++: virtual void ComputeNormalsOff()\n\n"},
  {"SetComputeGradients", PyvtkGridSynchronizedTemplates3D_SetComputeGradients, METH_VARARGS,
  ...
  {"GetComputeGradients", PyvtkGridSynchronizedTemplates3D_GetComputeGradients, METH_VARARGS,
   "GetComputeGradients(self) -> int\nC++: virtual vtkTypeBool GetComputeGradients()\n\n"},
  {"ComputeGradientsOn", PyvtkGridSynchronizedTemplates3D_ComputeGradientsOn, METH_VARARGS,
   "ComputeGradientsOn(self) -> None\nC++: virtual void ComputeGradientsOn()\n\n"},
  {"ComputeGradientsOff", PyvtkGridSynchronizedTemplates3D_ComputeGradientsOff, METH_VARARGS,
   "ComputeGradientsOff(self) -> None\nC++: virtual void ComputeGradientsOff()\n\n"},
  {"SetComputeScalars", PyvtkGridSynchronizedTemplates3D_SetComputeScalars, METH_VARARGS,
   "SetComputeScalars(self, _arg:int) -> None\nC++: virtual void SetComputeScalars(vtkTypeBool _arg)\n\nSet/Get the computation of scalars.\n"},
  {"GetComputeScalars", PyvtkGridSynchronizedTemplates3D_GetComputeScalars, METH_VARARGS,
   "GetComputeScalars(self) -> int\nC++: virtual vtkTypeBool GetComputeScalars()\n\n"},
  {"ComputeScalarsOn", PyvtkGridSynchronizedTemplates3D_ComputeScalarsOn, METH_VARARGS,
   "ComputeScalarsOn(self) -> None\nC++: virtual void ComputeScalarsOn()\n\n"},
  {"ComputeScalarsOff", PyvtkGridSynchronizedTemplates3D_ComputeScalarsOff, METH_VARARGS,
   "ComputeScalarsOff(self) -> None\nC++: virtual void ComputeScalarsOff()\n\n"},
  {"SetGenerateTriangles", PyvtkGridSynchronizedTemplates3D_SetGenerateTriangles, METH_VARARGS,
   "SetGenerateTriangles(self, _arg:int) -> None\nC++: virtual void SetGenerateTriangles(vtkTypeBool _arg)\n\nIf this is enabled (by default), the output will be triangles\notherwise, the output will be the intersection polygons\n"},
  {"GetGenerateTriangles", PyvtkGridSynchronizedTemplates3D_GetGenerateTriangles, METH_VARARGS,
   "GetGenerateTriangles(self) -> int\nC++: virtual vtkTypeBool GetGenerateTriangles()\n\n"},
  {"GenerateTrianglesOn", PyvtkGridSynchronizedTemplates3D_GenerateTrianglesOn, METH_VARARGS,
   "GenerateTrianglesOn(self) -> None\nC++: virtual void GenerateTrianglesOn()\n\n"},
  {"GenerateTrianglesOff", PyvtkGridSynchronizedTemplates3D_GenerateTrianglesOff, METH_VARARGS,
   "GenerateTrianglesOff(self) -> None\nC++: virtual void GenerateTrianglesOff()\n\n"},
  {"SetValue", PyvtkGridSynchronizedTemplates3D_SetValue, METH_VARARGS,
  ...
  {"GetValue", PyvtkGridSynchronizedTemplates3D_GetValue, METH_VARARGS,
   "GetValue(self, i:int) -> float\nC++: double GetValue(int i)\n\nGet the ith contour value.\n"},
  {"GetValues", PyvtkGridSynchronizedTemplates3D_GetValues, METH_VARARGS,
   "GetValues(self) -> Pointer\nC++: double *GetValues()\nGetValues(self, contourValues:[float, ...]) -> None\nC++: void GetValues(double *contourValues)\n\nGet a pointer to an array of contour values. There will be\nGetNumberOfContours() values in the list.\n"},
  {"SetNumberOfContours", PyvtkGridSynchronizedTemplates3D_SetNumberOfContours, METH_VARARGS,
  ...
  {"GetNumberOfContours", PyvtkGridSynchronizedTemplates3D_GetNumberOfContours, METH_VARARGS,
   "GetNumberOfContours(self) -> int\nC++: vtkIdType GetNumberOfContours()\n\nGet the number of contours in the list of contour values.\n"},
  {"GenerateValues", PyvtkGridSynchronizedTemplates3D_GenerateValues, METH_VARARGS,
  ...
  {"SetInputMemoryLimit", PyvtkGridSynchronizedTemplates3D_SetInputMemoryLimit, METH_VARARGS,
   "SetInputMemoryLimit(self, limit:int) -> None\nC++: void SetInputMemoryLimit(long limit)\n\nThis filter will initiate streaming so that no piece requested\nfrom the input will be larger than this value (KiloBytes).\n"},
  {"SetOutputPointsPrecision", PyvtkGridSynchronizedTemplates3D_SetOutputPointsPrecision, METH_VARARGS,
   "SetOutputPointsPrecision(self, _arg:int) -> None\nC++: virtual void SetOutputPointsPrecision(int _arg)\n\nSet/get the desired precision for the output types. See the\ndocumentation for the vtkAlgorithm::DesiredOutputPrecision enum\nfor an explanation of the available precision settings.\n"},
  {"GetOutputPointsPrecisionMinValue", PyvtkGridSynchronizedTemplates3D_GetOutputPointsPrecisionMinValue, METH_VARARGS,
   "GetOutputPointsPrecisionMinValue(self) -> int\nC++: virtual int GetOutputPointsPrecisionMinValue()\n\n"},
  {"GetOutputPointsPrecisionMaxValue", PyvtkGridSynchronizedTemplates3D_GetOutputPointsPrecisionMaxValue, METH_VARARGS,
   "GetOutputPointsPrecisionMaxValue(self) -> int\nC++: virtual int GetOutputPointsPrecisionMaxValue()\n\n"},
  {"GetOutputPointsPrecision", PyvtkGridSynchronizedTemplates3D_GetOutputPointsPrecision, METH_VARARGS,
...
static PyTypeObject PyvtkGridSynchronizedTemplates3D_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkFiltersCore.vtkGridSynchronizedTemplates3D", // tp_name
  ...
  PyvtkGridSynchronizedTemplates3D_Doc, // tp_doc
...
PyObject *PyvtkGridSynchronizedTemplates3D_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkGridSynchronizedTemplates3D_Type, PyvtkGridSynchronizedTemplates3D_Methods,
    "vtkGridSynchronizedTemplates3D",
 &PyvtkGridSynchronizedTemplates3D_StaticNew);
...
{
  PyObject *o;
  o = PyvtkGridSynchronizedTemplates3D_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkGridSynchronizedTemplates3D", o) != 0)
  {
    Py_DECREF(o);
  }
