...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkGlyph2D(PyObject *dict); }
extern "C" { PyObject *PyvtkGlyph2D_ClassNew(); }
...
static PyObject *
PyvtkGlyph2D_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkGlyph2D_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkGlyph2D_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkGlyph2D::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkGlyph2D_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkGlyph2D::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkGlyph2D_Methods[] = {
  ...
  {"SafeDownCast", PyvtkGlyph2D_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkGlyph2D\nC++: static vtkGlyph2D *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkGlyph2D_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkGlyph2D\nC++: vtkGlyph2D *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkGlyph2D_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkGlyph2D_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkGlyph2D_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkFiltersCore.vtkGlyph2D", // tp_name
