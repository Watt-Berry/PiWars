...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkStreamerBase(PyObject *dict); }
extern "C" { PyObject *PyvtkStreamerBase_ClassNew(); }


static PyObject *
PyvtkStreamerBase_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkStreamerBase_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkStreamerBase_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkStreamerBase::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkStreamerBase_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkStreamerBase::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkStreamerBase_Methods[] = {
  ...
  {"SafeDownCast", PyvtkStreamerBase_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkStreamerBase\nC++: static vtkStreamerBase *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkStreamerBase_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkStreamerBase\nC++: vtkStreamerBase *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkStreamerBase_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkStreamerBase_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkStreamerBase_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkFiltersCore.vtkStreamerBase", // tp_name
