...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkX3D(PyObject *dict); }
...
static PyTypeObject PyvtkX3D_X3DTypes_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkCommonCore.vtkX3D.X3DTypes", // tp_name
...
template<class T>
PyObject *PyvtkX3D_X3DTypes_FromEnum(T val)
{
  return PyVTKEnum_New(&PyvtkX3D_X3DTypes_Type, static_cast<int>(val));
}
...
static PyTypeObject PyvtkX3D_X3DElement_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonCore.vtkX3D.X3DElement", // tp_name
  sizeof(PyLongObject), // tp_basicsize
  0, // tp_itemsize
  nullptr, // tp_dealloc
#if PY_VERSION_HEX >= 0x03080000
...
template<class T>
PyObject *PyvtkX3D_X3DElement_FromEnum(T val)
{
  return PyVTKEnum_New(&PyvtkX3D_X3DElement_Type, static_cast<int>(val));
}
...
static PyTypeObject PyvtkX3D_X3DAttribute_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonCore.vtkX3D.X3DAttribute", // tp_name
  sizeof(PyLongObject), // tp_basicsize
  0, // tp_itemsize
  nullptr, // tp_dealloc
#if PY_VERSION_HEX >= 0x03080000
...
template<class T>
PyObject *PyvtkX3D_X3DAttribute_FromEnum(T val)
{
  return PyVTKEnum_New(&PyvtkX3D_X3DAttribute_Type, static_cast<int>(val));
}
...
static PyObject *PyVTKNamespace_vtkX3D()
{
  ...
  PyVTKEnum_Add(&PyvtkX3D_X3DTypes_Type, "vtkX3D.X3DTypes");
  ...
  PyVTKEnum_Add(&PyvtkX3D_X3DElement_Type, "vtkX3D.X3DElement");
  ...
  PyVTKEnum_Add(&PyvtkX3D_X3DAttribute_Type, "vtkX3D.X3DAttribute");
