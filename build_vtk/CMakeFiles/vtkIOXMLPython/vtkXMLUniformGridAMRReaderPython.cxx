...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkXMLUniformGridAMRReader(PyObject *dict); }
...
static PyObject *
PyvtkXMLUniformGridAMRReader_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkXMLUniformGridAMRReader::IsTypeOf(temp0);
...
static PyObject *
PyvtkXMLUniformGridAMRReader_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkXMLUniformGridAMRReader_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkXMLUniformGridAMRReader::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkXMLUniformGridAMRReader_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkXMLUniformGridAMRReader::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkXMLUniformGridAMRReader_Methods[] = {
  {"IsTypeOf", PyvtkXMLUniformGridAMRReader_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkXMLUniformGridAMRReader_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkXMLUniformGridAMRReader_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkXMLUniformGridAMRReader\nC++: static vtkXMLUniformGridAMRReader *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkXMLUniformGridAMRReader_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkXMLUniformGridAMRReader\nC++: vtkXMLUniformGridAMRReader *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkXMLUniformGridAMRReader_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkXMLUniformGridAMRReader_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SetMaximumLevelsToReadByDefault", PyvtkXMLUniformGridAMRReader_SetMaximumLevelsToReadByDefault, METH_VARARGS,
   "SetMaximumLevelsToReadByDefault(self, _arg:int) -> None\nC++: virtual void SetMaximumLevelsToReadByDefault(\n    unsigned int _arg)\n\nThis reader supports demand-driven heavy data reading i.e.\ndownstream pipeline can request specific blocks from the AMR\nusing vtkCompositeDataPipeline::UPDATE_COMPOSITE_INDICES() key in\nRequestUpdateExtent() pass. However, when down-stream doesn't\nprovide any specific keys, the default behavior can be setup to\nread at-most N levels by default. The number of levels read can\nbe set using this method. Set this to 0 to imply no limit.\nDefault is 0.\n"},
  {"GetMaximumLevelsToReadByDefault", PyvtkXMLUniformGridAMRReader_GetMaximumLevelsToReadByDefault, METH_VARARGS,
   "GetMaximumLevelsToReadByDefault(self) -> int\nC++: virtual unsigned int GetMaximumLevelsToReadByDefault()\n\n"},
...
static PyTypeObject PyvtkXMLUniformGridAMRReader_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkIOXML.vtkXMLUniformGridAMRReader", // tp_name
  ...
  PyvtkXMLUniformGridAMRReader_Doc, // tp_doc
...
PyObject *PyvtkXMLUniformGridAMRReader_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkXMLUniformGridAMRReader_Type, PyvtkXMLUniformGridAMRReader_Methods,
    "vtkXMLUniformGridAMRReader",
 &PyvtkXMLUniformGridAMRReader_StaticNew);
...
{
  PyObject *o;
  o = PyvtkXMLUniformGridAMRReader_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkXMLUniformGridAMRReader", o) != 0)
  {
    Py_DECREF(o);
  }
