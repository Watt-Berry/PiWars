...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkXMLMultiBlockDataReader(PyObject *dict); }
...
static PyObject *
PyvtkXMLMultiBlockDataReader_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkXMLMultiBlockDataReader_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkXMLMultiBlockDataReader_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkXMLMultiBlockDataReader::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkXMLMultiBlockDataReader_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkXMLMultiBlockDataReader::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkXMLMultiBlockDataReader_Methods[] = {
  ...
  {"SafeDownCast", PyvtkXMLMultiBlockDataReader_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkXMLMultiBlockDataReader\nC++: static vtkXMLMultiBlockDataReader *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkXMLMultiBlockDataReader_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkXMLMultiBlockDataReader\nC++: vtkXMLMultiBlockDataReader *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkXMLMultiBlockDataReader_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkXMLMultiBlockDataReader_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkXMLMultiBlockDataReader_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkIOXML.vtkXMLMultiBlockDataReader", // tp_name
