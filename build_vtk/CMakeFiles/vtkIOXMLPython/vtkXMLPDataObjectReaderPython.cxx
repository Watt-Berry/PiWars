...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkXMLPDataObjectReader(PyObject *dict); }
...
static PyObject *
PyvtkXMLPDataObjectReader_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkXMLPDataObjectReader_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkXMLPDataObjectReader_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkXMLPDataObjectReader::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkXMLPDataObjectReader_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkXMLPDataObjectReader::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkXMLPDataObjectReader_Methods[] = {
  ...
  {"SafeDownCast", PyvtkXMLPDataObjectReader_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkXMLPDataObjectReader\nC++: static vtkXMLPDataObjectReader *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkXMLPDataObjectReader_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkXMLPDataObjectReader\nC++: vtkXMLPDataObjectReader *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkXMLPDataObjectReader_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkXMLPDataObjectReader_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkXMLPDataObjectReader_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkIOXML.vtkXMLPDataObjectReader", // tp_name
