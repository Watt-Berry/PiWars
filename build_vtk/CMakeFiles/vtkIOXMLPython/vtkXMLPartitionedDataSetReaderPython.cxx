...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkXMLPartitionedDataSetReader(PyObject *dict); }
extern "C" { PyObject *PyvtkXMLPartitionedDataSetReader_ClassNew(); }
...
static PyObject *
PyvtkXMLPartitionedDataSetReader_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkXMLPartitionedDataSetReader_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkXMLPartitionedDataSetReader_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkXMLPartitionedDataSetReader::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkXMLPartitionedDataSetReader_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkXMLPartitionedDataSetReader::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkXMLPartitionedDataSetReader_Methods[] = {
  ...
  {"SafeDownCast", PyvtkXMLPartitionedDataSetReader_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkXMLPartitionedDataSetReader\nC++: static vtkXMLPartitionedDataSetReader *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkXMLPartitionedDataSetReader_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkXMLPartitionedDataSetReader\nC++: vtkXMLPartitionedDataSetReader *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkXMLPartitionedDataSetReader_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkXMLPartitionedDataSetReader_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkXMLPartitionedDataSetReader_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkIOXML.vtkXMLPartitionedDataSetReader", // tp_name
