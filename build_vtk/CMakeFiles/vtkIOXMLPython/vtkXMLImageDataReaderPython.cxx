...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkXMLImageDataReader(PyObject *dict); }
extern "C" { PyObject *PyvtkXMLImageDataReader_ClassNew(); }
...
static PyObject *
PyvtkXMLImageDataReader_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkXMLImageDataReader::IsTypeOf(temp0);
...
static PyObject *
PyvtkXMLImageDataReader_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkXMLImageDataReader_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkXMLImageDataReader::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkXMLImageDataReader_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkXMLImageDataReader::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkXMLImageDataReader_Methods[] = {
  {"IsTypeOf", PyvtkXMLImageDataReader_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkXMLImageDataReader_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkXMLImageDataReader_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkXMLImageDataReader\nC++: static vtkXMLImageDataReader *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkXMLImageDataReader_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkXMLImageDataReader\nC++: vtkXMLImageDataReader *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkXMLImageDataReader_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkXMLImageDataReader_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetOutput", PyvtkXMLImageDataReader_GetOutput, METH_VARARGS,
  ...
  {"CopyOutputInformation", PyvtkXMLImageDataReader_CopyOutputInformation, METH_VARARGS,
...
static PyTypeObject PyvtkXMLImageDataReader_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkIOXML.vtkXMLImageDataReader", // tp_name
  ...
  PyvtkXMLImageDataReader_Doc, // tp_doc
...
PyObject *PyvtkXMLImageDataReader_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkXMLImageDataReader_Type, PyvtkXMLImageDataReader_Methods,
    "vtkXMLImageDataReader",
 &PyvtkXMLImageDataReader_StaticNew);
...
{
  PyObject *o;
  o = PyvtkXMLImageDataReader_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkXMLImageDataReader", o) != 0)
  {
    Py_DECREF(o);
  }
