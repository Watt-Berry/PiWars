...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkXMLPartitionedDataSetCollectionReader(PyObject *dict); }
extern "C" { PyObject *PyvtkXMLPartitionedDataSetCollectionReader_ClassNew(); }
...
static PyObject *
PyvtkXMLPartitionedDataSetCollectionReader_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkXMLPartitionedDataSetCollectionReader_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkXMLPartitionedDataSetCollectionReader_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkXMLPartitionedDataSetCollectionReader::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkXMLPartitionedDataSetCollectionReader_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkXMLPartitionedDataSetCollectionReader::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkXMLPartitionedDataSetCollectionReader_Methods[] = {
  ...
  {"NewInstance", PyvtkXMLPartitionedDataSetCollectionReader_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkXMLPartitionedDataSetCollectionReader\nC++: vtkXMLPartitionedDataSetCollectionReader *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkXMLPartitionedDataSetCollectionReader_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkXMLPartitionedDataSetCollectionReader_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkXMLPartitionedDataSetCollectionReader_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkIOXML.vtkXMLPartitionedDataSetCollectionReader", // tp_name
