...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkXMLPRectilinearGridReader(PyObject *dict); }
extern "C" { PyObject *PyvtkXMLPRectilinearGridReader_ClassNew(); }
...
static PyObject *
PyvtkXMLPRectilinearGridReader_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkXMLPRectilinearGridReader::IsTypeOf(temp0);
...
static PyObject *
PyvtkXMLPRectilinearGridReader_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkXMLPRectilinearGridReader_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkXMLPRectilinearGridReader::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkXMLPRectilinearGridReader_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkXMLPRectilinearGridReader::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkXMLPRectilinearGridReader_Methods[] = {
  {"IsTypeOf", PyvtkXMLPRectilinearGridReader_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkXMLPRectilinearGridReader_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkXMLPRectilinearGridReader_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkXMLPRectilinearGridReader\nC++: static vtkXMLPRectilinearGridReader *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkXMLPRectilinearGridReader_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkXMLPRectilinearGridReader\nC++: vtkXMLPRectilinearGridReader *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkXMLPRectilinearGridReader_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkXMLPRectilinearGridReader_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetOutput", PyvtkXMLPRectilinearGridReader_GetOutput, METH_VARARGS,
...
static PyTypeObject PyvtkXMLPRectilinearGridReader_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkIOXML.vtkXMLPRectilinearGridReader", // tp_name
  ...
  PyvtkXMLPRectilinearGridReader_Doc, // tp_doc
...
PyObject *PyvtkXMLPRectilinearGridReader_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkXMLPRectilinearGridReader_Type, PyvtkXMLPRectilinearGridReader_Methods,
    "vtkXMLPRectilinearGridReader",
 &PyvtkXMLPRectilinearGridReader_StaticNew);
...
{
  PyObject *o;
  o = PyvtkXMLPRectilinearGridReader_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkXMLPRectilinearGridReader", o) != 0)
  {
    Py_DECREF(o);
  }
