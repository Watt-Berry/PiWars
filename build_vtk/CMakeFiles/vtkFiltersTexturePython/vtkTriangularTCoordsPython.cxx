...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkTriangularTCoords(PyObject *dict); }
extern "C" { PyObject *PyvtkTriangularTCoords_ClassNew(); }


static PyObject *
PyvtkTriangularTCoords_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkTriangularTCoords_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkTriangularTCoords_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkTriangularTCoords::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkTriangularTCoords_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkTriangularTCoords::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkTriangularTCoords_Methods[] = {
  ...
  {"SafeDownCast", PyvtkTriangularTCoords_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkTriangularTCoords\nC++: static vtkTriangularTCoords *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkTriangularTCoords_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkTriangularTCoords\nC++: vtkTriangularTCoords *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkTriangularTCoords_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkTriangularTCoords_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkTriangularTCoords_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkFiltersTexture.vtkTriangularTCoords", // tp_name
