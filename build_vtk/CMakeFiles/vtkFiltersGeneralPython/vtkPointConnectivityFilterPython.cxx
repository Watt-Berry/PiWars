...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkPointConnectivityFilter(PyObject *dict); }
extern "C" { PyObject *PyvtkPointConnectivityFilter_ClassNew(); }


static PyObject *
PyvtkPointConnectivityFilter_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPointConnectivityFilter_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPointConnectivityFilter_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkPointConnectivityFilter::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkPointConnectivityFilter_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkPointConnectivityFilter::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkPointConnectivityFilter_Methods[] = {
  ...
  {"SafeDownCast", PyvtkPointConnectivityFilter_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkPointConnectivityFilter\nC++: static vtkPointConnectivityFilter *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkPointConnectivityFilter_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkPointConnectivityFilter\nC++: vtkPointConnectivityFilter *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkPointConnectivityFilter_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkPointConnectivityFilter_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkPointConnectivityFilter_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkFiltersGeneral.vtkPointConnectivityFilter", // tp_name
