...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkMultiBlockMergeFilter(PyObject *dict); }
extern "C" { PyObject *PyvtkMultiBlockMergeFilter_ClassNew(); }


static PyObject *
PyvtkMultiBlockMergeFilter_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkMultiBlockMergeFilter::IsTypeOf(temp0);
...
static PyObject *
PyvtkMultiBlockMergeFilter_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkMultiBlockMergeFilter_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkMultiBlockMergeFilter::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkMultiBlockMergeFilter_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkMultiBlockMergeFilter::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkMultiBlockMergeFilter_Methods[] = {
  {"IsTypeOf", PyvtkMultiBlockMergeFilter_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkMultiBlockMergeFilter_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkMultiBlockMergeFilter_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkMultiBlockMergeFilter\nC++: static vtkMultiBlockMergeFilter *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkMultiBlockMergeFilter_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkMultiBlockMergeFilter\nC++: vtkMultiBlockMergeFilter *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkMultiBlockMergeFilter_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkMultiBlockMergeFilter_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"AddInputData", PyvtkMultiBlockMergeFilter_AddInputData, METH_VARARGS,
...
static PyTypeObject PyvtkMultiBlockMergeFilter_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkFiltersGeneral.vtkMultiBlockMergeFilter", // tp_name
  ...
  PyvtkMultiBlockMergeFilter_Doc, // tp_doc
...
PyObject *PyvtkMultiBlockMergeFilter_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkMultiBlockMergeFilter_Type, PyvtkMultiBlockMergeFilter_Methods,
    "vtkMultiBlockMergeFilter",
 &PyvtkMultiBlockMergeFilter_StaticNew);
...
{
  PyObject *o;
  o = PyvtkMultiBlockMergeFilter_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkMultiBlockMergeFilter", o) != 0)
  {
    Py_DECREF(o);
  }
