...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkRectilinearGridToPointSet(PyObject *dict); }
extern "C" { PyObject *PyvtkRectilinearGridToPointSet_ClassNew(); }


static PyObject *
PyvtkRectilinearGridToPointSet_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkRectilinearGridToPointSet_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkRectilinearGridToPointSet_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkRectilinearGridToPointSet::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkRectilinearGridToPointSet_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkRectilinearGridToPointSet::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkRectilinearGridToPointSet_Methods[] = {
  ...
  {"SafeDownCast", PyvtkRectilinearGridToPointSet_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkRectilinearGridToPointSet\nC++: static vtkRectilinearGridToPointSet *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkRectilinearGridToPointSet_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkRectilinearGridToPointSet\nC++: vtkRectilinearGridToPointSet *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkRectilinearGridToPointSet_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkRectilinearGridToPointSet_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkRectilinearGridToPointSet_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkFiltersGeneral.vtkRectilinearGridToPointSet", // tp_name
