...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkLevelIdScalars(PyObject *dict); }
...
static PyObject *
PyvtkLevelIdScalars_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkLevelIdScalars_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkLevelIdScalars_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkLevelIdScalars::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkLevelIdScalars_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkLevelIdScalars::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkLevelIdScalars_Methods[] = {
  ...
  {"SafeDownCast", PyvtkLevelIdScalars_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkLevelIdScalars\nC++: static vtkLevelIdScalars *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkLevelIdScalars_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkLevelIdScalars\nC++: vtkLevelIdScalars *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkLevelIdScalars_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkLevelIdScalars_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkLevelIdScalars_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkFiltersGeneral.vtkLevelIdScalars", // tp_name
