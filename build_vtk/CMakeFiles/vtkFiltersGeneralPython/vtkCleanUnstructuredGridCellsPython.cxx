...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkCleanUnstructuredGridCells(PyObject *dict); }
extern "C" { PyObject *PyvtkCleanUnstructuredGridCells_ClassNew(); }


static PyObject *
PyvtkCleanUnstructuredGridCells_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkCleanUnstructuredGridCells_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkCleanUnstructuredGridCells_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkCleanUnstructuredGridCells::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkCleanUnstructuredGridCells_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkCleanUnstructuredGridCells::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkCleanUnstructuredGridCells_Methods[] = {
  ...
  {"SafeDownCast", PyvtkCleanUnstructuredGridCells_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkCleanUnstructuredGridCells\nC++: static vtkCleanUnstructuredGridCells *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkCleanUnstructuredGridCells_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkCleanUnstructuredGridCells\nC++: vtkCleanUnstructuredGridCells *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkCleanUnstructuredGridCells_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkCleanUnstructuredGridCells_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkCleanUnstructuredGridCells_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkFiltersGeneral.vtkCleanUnstructuredGridCells", // tp_name
