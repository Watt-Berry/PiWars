...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkImageDataToPointSet(PyObject *dict); }
extern "C" { PyObject *PyvtkImageDataToPointSet_ClassNew(); }


static PyObject *
PyvtkImageDataToPointSet_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkImageDataToPointSet_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkImageDataToPointSet_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkImageDataToPointSet::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkImageDataToPointSet_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkImageDataToPointSet::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkImageDataToPointSet_Methods[] = {
  ...
  {"SafeDownCast", PyvtkImageDataToPointSet_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkImageDataToPointSet\nC++: static vtkImageDataToPointSet *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkImageDataToPointSet_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkImageDataToPointSet\nC++: vtkImageDataToPointSet *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkImageDataToPointSet_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkImageDataToPointSet_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkImageDataToPointSet_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkFiltersGeneral.vtkImageDataToPointSet", // tp_name
