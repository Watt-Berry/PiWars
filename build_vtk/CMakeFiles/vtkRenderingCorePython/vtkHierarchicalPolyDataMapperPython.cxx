...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkHierarchicalPolyDataMapper(PyObject *dict); }
extern "C" { PyObject *PyvtkHierarchicalPolyDataMapper_ClassNew(); }
...
static PyObject *
PyvtkHierarchicalPolyDataMapper_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkHierarchicalPolyDataMapper_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkHierarchicalPolyDataMapper_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkHierarchicalPolyDataMapper::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkHierarchicalPolyDataMapper_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkHierarchicalPolyDataMapper::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkHierarchicalPolyDataMapper_Methods[] = {
  ...
  {"SafeDownCast", PyvtkHierarchicalPolyDataMapper_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkHierarchicalPolyDataMapper\nC++: static vtkHierarchicalPolyDataMapper *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkHierarchicalPolyDataMapper_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkHierarchicalPolyDataMapper\nC++: vtkHierarchicalPolyDataMapper *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkHierarchicalPolyDataMapper_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkHierarchicalPolyDataMapper_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkHierarchicalPolyDataMapper_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkRenderingCore.vtkHierarchicalPolyDataMapper", // tp_name
