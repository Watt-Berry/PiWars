...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkPropCollection(PyObject *dict); }
extern "C" { PyObject *PyvtkPropCollection_ClassNew(); }


static PyObject *
PyvtkPropCollection_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkPropCollection::IsTypeOf(temp0);
...
static PyObject *
PyvtkPropCollection_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPropCollection_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkPropCollection::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkPropCollection_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkPropCollection::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkPropCollection_Methods[] = {
  {"IsTypeOf", PyvtkPropCollection_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkPropCollection_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkPropCollection_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkPropCollection\nC++: static vtkPropCollection *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkPropCollection_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkPropCollection\nC++: vtkPropCollection *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkPropCollection_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkPropCollection_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"AddItem", PyvtkPropCollection_AddItem, METH_VARARGS,
   "AddItem(self, a:vtkProp) -> None\nC++: void AddItem(vtkProp *a)\n\nAdd a Prop to the bottom of the list.\n"},
  {"GetNextProp", PyvtkPropCollection_GetNextProp, METH_VARARGS,
   "GetNextProp(self) -> vtkProp\nC++: vtkProp *GetNextProp()\n\nGet the next Prop in the list.\n"},
  {"GetLastProp", PyvtkPropCollection_GetLastProp, METH_VARARGS,
   "GetLastProp(self) -> vtkProp\nC++: vtkProp *GetLastProp()\n\nGet the last Prop in the list.\n"},
  {"GetNumberOfPaths", PyvtkPropCollection_GetNumberOfPaths, METH_VARARGS,
...
static PyTypeObject PyvtkPropCollection_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkRenderingCore.vtkPropCollection", // tp_name
  ...
  PyvtkPropCollection_Doc, // tp_doc
...
PyObject *PyvtkPropCollection_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkPropCollection_Type, PyvtkPropCollection_Methods,
    "vtkPropCollection",
 &PyvtkPropCollection_StaticNew);
...
{
  PyObject *o;
  o = PyvtkPropCollection_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkPropCollection", o) != 0)
  {
    Py_DECREF(o);
  }
