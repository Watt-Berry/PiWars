...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkOBJReader(PyObject *dict); }
extern "C" { PyObject *PyvtkOBJReader_ClassNew(); }
...
static PyObject *
PyvtkOBJReader_SetStream(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp0, "vtkResourceStream"))
  {
    ...
    {
      op->vtkOBJReader::SetStream(temp0);
    }
...
static PyObject *
PyvtkOBJReader_GetStream(PyObject *self, PyObject *args)
{
...
static PyMethodDef PyvtkOBJReader_Methods[] = {
  ...
  {"SetStream", PyvtkOBJReader_SetStream, METH_VARARGS,
   "SetStream(self, _arg:vtkResourceStream) -> None\nC++: virtual void SetStream(vtkResourceStream *_arg)\n\nSpecify stream to read from When selecting input method, `Stream`\nhas an higher priority than `Filename`. If both are null, reader\noutputs nothing.\n"},
  {"GetStream", PyvtkOBJReader_GetStream, METH_VARARGS,
