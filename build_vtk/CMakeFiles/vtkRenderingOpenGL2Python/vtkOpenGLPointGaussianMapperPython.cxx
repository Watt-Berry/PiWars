...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkOpenGLPointGaussianMapper(PyObject *dict); }
extern "C" { PyObject *PyvtkOpenGLPointGaussianMapper_ClassNew(); }


static PyObject *
PyvtkOpenGLPointGaussianMapper_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkOpenGLPointGaussianMapper_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkOpenGLPointGaussianMapper_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkOpenGLPointGaussianMapper::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkOpenGLPointGaussianMapper_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkOpenGLPointGaussianMapper::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkOpenGLPointGaussianMapper_HasTranslucentPolygonalGeometry(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    bool tempr = (ap.IsBound() ?
      ...
      op->vtkOpenGLPointGaussianMapper::HasTranslucentPolygonalGeometry());
...
static PyObject *
PyvtkOpenGLPointGaussianMapper_ProcessSelectorPixelBuffers(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp2, "vtkProp"))
  {
    ...
    {
      op->vtkOpenGLPointGaussianMapper::ProcessSelectorPixelBuffers(temp0, temp1, temp2);
    }
...
static PyMethodDef PyvtkOpenGLPointGaussianMapper_Methods[] = {
  ...
  {"SafeDownCast", PyvtkOpenGLPointGaussianMapper_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkOpenGLPointGaussianMapper\nC++: static vtkOpenGLPointGaussianMapper *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkOpenGLPointGaussianMapper_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkOpenGLPointGaussianMapper\nC++: vtkOpenGLPointGaussianMapper *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkOpenGLPointGaussianMapper_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkOpenGLPointGaussianMapper_GetNumberOfGenerationsFromBase, METH_VARARGS,
  ...
  {"HasTranslucentPolygonalGeometry", PyvtkOpenGLPointGaussianMapper_HasTranslucentPolygonalGeometry, METH_VARARGS,
  ...
  {"ProcessSelectorPixelBuffers", PyvtkOpenGLPointGaussianMapper_ProcessSelectorPixelBuffers, METH_VARARGS,
...
static PyTypeObject PyvtkOpenGLPointGaussianMapper_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkRenderingOpenGL2.vtkOpenGLPointGaussianMapper", // tp_name
...
PyObject *PyvtkOpenGLPointGaussianMapper_ClassNew()
{
 ...
 &PyvtkOpenGLPointGaussianMapper_StaticNew);
  ...
  pytype->tp_base = vtkPythonUtil::FindBaseTypeObject("vtkPointGaussianMapper");
