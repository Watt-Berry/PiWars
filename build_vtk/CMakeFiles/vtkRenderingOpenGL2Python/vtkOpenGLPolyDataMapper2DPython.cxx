...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkOpenGLPolyDataMapper2D(PyObject *dict); }
extern "C" { PyObject *PyvtkOpenGLPolyDataMapper2D_ClassNew(); }


static PyObject *
PyvtkOpenGLPolyDataMapper2D_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkOpenGLPolyDataMapper2D_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkOpenGLPolyDataMapper2D_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkOpenGLPolyDataMapper2D::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkOpenGLPolyDataMapper2D_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkOpenGLPolyDataMapper2D::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkOpenGLPolyDataMapper2D_Methods[] = {
  ...
  {"SafeDownCast", PyvtkOpenGLPolyDataMapper2D_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkOpenGLPolyDataMapper2D\nC++: static vtkOpenGLPolyDataMapper2D *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkOpenGLPolyDataMapper2D_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkOpenGLPolyDataMapper2D\nC++: vtkOpenGLPolyDataMapper2D *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkOpenGLPolyDataMapper2D_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkOpenGLPolyDataMapper2D_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkOpenGLPolyDataMapper2D_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkRenderingOpenGL2.vtkOpenGLPolyDataMapper2D", // tp_name
...
PyObject *PyvtkOpenGLPolyDataMapper2D_ClassNew()
{
 ...
 &PyvtkOpenGLPolyDataMapper2D_StaticNew);
  ...
  pytype->tp_base = vtkPythonUtil::FindBaseTypeObject("vtkPolyDataMapper2D");
