...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkOpenGLLabeledContourMapper(PyObject *dict); }
extern "C" { PyObject *PyvtkOpenGLLabeledContourMapper_ClassNew(); }


static PyObject *
PyvtkOpenGLLabeledContourMapper_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkOpenGLLabeledContourMapper_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkOpenGLLabeledContourMapper_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkOpenGLLabeledContourMapper::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkOpenGLLabeledContourMapper_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkOpenGLLabeledContourMapper::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkOpenGLLabeledContourMapper_Methods[] = {
  ...
  {"SafeDownCast", PyvtkOpenGLLabeledContourMapper_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkOpenGLLabeledContourMapper\nC++: static vtkOpenGLLabeledContourMapper *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkOpenGLLabeledContourMapper_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkOpenGLLabeledContourMapper\nC++: vtkOpenGLLabeledContourMapper *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkOpenGLLabeledContourMapper_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkOpenGLLabeledContourMapper_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkOpenGLLabeledContourMapper_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkRenderingOpenGL2.vtkOpenGLLabeledContourMapper", // tp_name
...
PyObject *PyvtkOpenGLLabeledContourMapper_ClassNew()
{
 ...
 &PyvtkOpenGLLabeledContourMapper_StaticNew);
  ...
  pytype->tp_base = vtkPythonUtil::FindBaseTypeObject("vtkLabeledContourMapper");
