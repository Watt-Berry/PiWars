...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkOpenGLSphereMapper(PyObject *dict); }
extern "C" { PyObject *PyvtkOpenGLSphereMapper_ClassNew(); }
...
static PyObject *
PyvtkOpenGLSphereMapper_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkOpenGLSphereMapper_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkOpenGLSphereMapper_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkOpenGLSphereMapper::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkOpenGLSphereMapper_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkOpenGLSphereMapper::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkOpenGLSphereMapper_Methods[] = {
  ...
  {"SafeDownCast", PyvtkOpenGLSphereMapper_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkOpenGLSphereMapper\nC++: static vtkOpenGLSphereMapper *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkOpenGLSphereMapper_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkOpenGLSphereMapper\nC++: vtkOpenGLSphereMapper *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkOpenGLSphereMapper_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkOpenGLSphereMapper_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkOpenGLSphereMapper_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkRenderingOpenGL2.vtkOpenGLSphereMapper", // tp_name
