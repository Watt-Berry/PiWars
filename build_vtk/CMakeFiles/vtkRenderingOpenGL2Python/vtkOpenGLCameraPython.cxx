...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkOpenGLCamera(PyObject *dict); }
extern "C" { PyObject *PyvtkOpenGLCamera_ClassNew(); }


static PyObject *
PyvtkOpenGLCamera_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkOpenGLCamera_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkOpenGLCamera_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkOpenGLCamera::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkOpenGLCamera_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkOpenGLCamera::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkOpenGLCamera_Methods[] = {
  ...
  {"SafeDownCast", PyvtkOpenGLCamera_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkOpenGLCamera\nC++: static vtkOpenGLCamera *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkOpenGLCamera_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkOpenGLCamera\nC++: vtkOpenGLCamera *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkOpenGLCamera_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkOpenGLCamera_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkOpenGLCamera_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkRenderingOpenGL2.vtkOpenGLCamera", // tp_name
...
PyObject *PyvtkOpenGLCamera_ClassNew()
{
 ...
 &PyvtkOpenGLCamera_StaticNew);
  ...
  pytype->tp_base = vtkPythonUtil::FindBaseTypeObject("vtkCamera");
