...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkDepthImageProcessingPass(PyObject *dict); }
...
static PyObject *
PyvtkDepthImageProcessingPass_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkDepthImageProcessingPass_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkDepthImageProcessingPass_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkDepthImageProcessingPass::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkDepthImageProcessingPass_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkDepthImageProcessingPass::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkDepthImageProcessingPass_Methods[] = {
  ...
  {"SafeDownCast", PyvtkDepthImageProcessingPass_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkDepthImageProcessingPass\nC++: static vtkDepthImageProcessingPass *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkDepthImageProcessingPass_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkDepthImageProcessingPass\nC++: vtkDepthImageProcessingPass *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkDepthImageProcessingPass_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkDepthImageProcessingPass_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkDepthImageProcessingPass_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkRenderingOpenGL2.vtkDepthImageProcessingPass", // tp_name
