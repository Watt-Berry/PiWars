...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkDefaultPass(PyObject *dict); }
extern "C" { PyObject *PyvtkDefaultPass_ClassNew(); }


static PyObject *
PyvtkDefaultPass_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkDefaultPass_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkDefaultPass_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkDefaultPass::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkDefaultPass_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkDefaultPass::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkDefaultPass_Methods[] = {
  ...
  {"SafeDownCast", PyvtkDefaultPass_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkDefaultPass\nC++: static vtkDefaultPass *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkDefaultPass_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkDefaultPass\nC++: vtkDefaultPass *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkDefaultPass_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkDefaultPass_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkDefaultPass_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkRenderingOpenGL2.vtkDefaultPass", // tp_name
