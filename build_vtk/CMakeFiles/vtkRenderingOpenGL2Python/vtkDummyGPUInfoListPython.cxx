...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkDummyGPUInfoList(PyObject *dict); }
extern "C" { PyObject *PyvtkDummyGPUInfoList_ClassNew(); }


static PyObject *
PyvtkDummyGPUInfoList_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkDummyGPUInfoList_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkDummyGPUInfoList_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkDummyGPUInfoList::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkDummyGPUInfoList_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkDummyGPUInfoList::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkDummyGPUInfoList_Methods[] = {
  ...
  {"SafeDownCast", PyvtkDummyGPUInfoList_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkDummyGPUInfoList\nC++: static vtkDummyGPUInfoList *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkDummyGPUInfoList_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkDummyGPUInfoList\nC++: vtkDummyGPUInfoList *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkDummyGPUInfoList_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkDummyGPUInfoList_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkDummyGPUInfoList_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkRenderingOpenGL2.vtkDummyGPUInfoList", // tp_name
...
PyObject *PyvtkDummyGPUInfoList_ClassNew()
{
 ...
 &PyvtkDummyGPUInfoList_StaticNew);
  ...
  pytype->tp_base = vtkPythonUtil::FindBaseTypeObject("vtkGPUInfoList");
