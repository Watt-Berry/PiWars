...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkPDataSetWriter(PyObject *dict); }
extern "C" { PyObject *PyvtkPDataSetWriter_ClassNew(); }


static PyObject *
PyvtkPDataSetWriter_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkPDataSetWriter::IsTypeOf(temp0);
...
static PyObject *
PyvtkPDataSetWriter_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPDataSetWriter_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkPDataSetWriter::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkPDataSetWriter_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkPDataSetWriter::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkPDataSetWriter_Methods[] = {
  {"IsTypeOf", PyvtkPDataSetWriter_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkPDataSetWriter_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkPDataSetWriter_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkPDataSetWriter\nC++: static vtkPDataSetWriter *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkPDataSetWriter_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkPDataSetWriter\nC++: vtkPDataSetWriter *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkPDataSetWriter_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkPDataSetWriter_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"Write", PyvtkPDataSetWriter_Write, METH_VARARGS,
   "Write(self) -> int\nC++: int Write() override;\n\nWrite the pvtk file and corresponding vtk files.\n"},
  {"SetNumberOfPieces", PyvtkPDataSetWriter_SetNumberOfPieces, METH_VARARGS,
  ...
  {"GetNumberOfPieces", PyvtkPDataSetWriter_GetNumberOfPieces, METH_VARARGS,
   "GetNumberOfPieces(self) -> int\nC++: virtual int GetNumberOfPieces()\n\n"},
  {"SetGhostLevel", PyvtkPDataSetWriter_SetGhostLevel, METH_VARARGS,
  ...
  {"GetGhostLevel", PyvtkPDataSetWriter_GetGhostLevel, METH_VARARGS,
   "GetGhostLevel(self) -> int\nC++: virtual int GetGhostLevel()\n\n"},
  {"SetStartPiece", PyvtkPDataSetWriter_SetStartPiece, METH_VARARGS,
  ...
  {"GetStartPiece", PyvtkPDataSetWriter_GetStartPiece, METH_VARARGS,
   "GetStartPiece(self) -> int\nC++: virtual int GetStartPiece()\n\n"},
  {"SetEndPiece", PyvtkPDataSetWriter_SetEndPiece, METH_VARARGS,
   "SetEndPiece(self, _arg:int) -> None\nC++: virtual void SetEndPiece(int _arg)\n\n"},
  {"GetEndPiece", PyvtkPDataSetWriter_GetEndPiece, METH_VARARGS,
   "GetEndPiece(self) -> int\nC++: virtual int GetEndPiece()\n\n"},
  {"SetFilePattern", PyvtkPDataSetWriter_SetFilePattern, METH_VARARGS,
  ...
  {"GetFilePattern", PyvtkPDataSetWriter_GetFilePattern, METH_VARARGS,
   "GetFilePattern(self) -> str\nC++: virtual char *GetFilePattern()\n\n"},
  {"SetUseRelativeFileNames", PyvtkPDataSetWriter_SetUseRelativeFileNames, METH_VARARGS,
  ...
  {"GetUseRelativeFileNames", PyvtkPDataSetWriter_GetUseRelativeFileNames, METH_VARARGS,
   "GetUseRelativeFileNames(self) -> int\nC++: virtual vtkTypeBool GetUseRelativeFileNames()\n\n"},
  {"UseRelativeFileNamesOn", PyvtkPDataSetWriter_UseRelativeFileNamesOn, METH_VARARGS,
   "UseRelativeFileNamesOn(self) -> None\nC++: virtual void UseRelativeFileNamesOn()\n\n"},
  {"UseRelativeFileNamesOff", PyvtkPDataSetWriter_UseRelativeFileNamesOff, METH_VARARGS,
   "UseRelativeFileNamesOff(self) -> None\nC++: virtual void UseRelativeFileNamesOff()\n\n"},
  {"SetController", PyvtkPDataSetWriter_SetController, METH_VARARGS,
  ...
  {"GetController", PyvtkPDataSetWriter_GetController, METH_VARARGS,
...
static PyTypeObject PyvtkPDataSetWriter_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkIOParallel.vtkPDataSetWriter", // tp_name
  ...
  PyvtkPDataSetWriter_Doc, // tp_doc
...
PyObject *PyvtkPDataSetWriter_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkPDataSetWriter_Type, PyvtkPDataSetWriter_Methods,
    "vtkPDataSetWriter",
 &PyvtkPDataSetWriter_StaticNew);
  ...
  pytype->tp_base = vtkPythonUtil::FindBaseTypeObject("vtkDataSetWriter");
...
{
  PyObject *o;
  o = PyvtkPDataSetWriter_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkPDataSetWriter", o) != 0)
  {
    Py_DECREF(o);
  }
