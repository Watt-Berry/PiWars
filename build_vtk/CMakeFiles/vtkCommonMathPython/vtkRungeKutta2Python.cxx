...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkRungeKutta2(PyObject *dict); }
extern "C" { PyObject *PyvtkRungeKutta2_ClassNew(); }
...
static PyObject *
PyvtkRungeKutta2_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkRungeKutta2::IsTypeOf(temp0);
...
static PyObject *
PyvtkRungeKutta2_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkRungeKutta2_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkRungeKutta2::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkRungeKutta2_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkRungeKutta2::GetNumberOfGenerationsFromBase(temp0));
...
PyvtkRungeKutta2_ComputeNextStep_s2(PyObject *self, PyObject *args)
{
      ...
      ap.GetBuffer(temp7, &pbuf7))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkRungeKutta2::ComputeNextStep(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7));
...
PyvtkRungeKutta2_ComputeNextStep_s4(PyObject *self, PyObject *args)
{
      ...
      ap.GetBuffer(temp10, &pbuf10))
  {
    ...
    int tempr = (ap.IsBound() ?
      ...
      op->vtkRungeKutta2::ComputeNextStep(temp0, temp1, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9, temp10));
...
static PyObject *
PyvtkRungeKutta2_ComputeNextStep_s5(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "ComputeNextStep");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkRungeKutta2 *op = static_cast<vtkRungeKutta2 *>(vp);
...
static PyObject *
PyvtkRungeKutta2_ComputeNextStep_s6(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "ComputeNextStep");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkRungeKutta2 *op = static_cast<vtkRungeKutta2 *>(vp);
...
static PyObject *
PyvtkRungeKutta2_ComputeNextStep_s7(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "ComputeNextStep");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkRungeKutta2 *op = static_cast<vtkRungeKutta2 *>(vp);
...
static PyObject *
PyvtkRungeKutta2_ComputeNextStep_s8(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "ComputeNextStep");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkRungeKutta2 *op = static_cast<vtkRungeKutta2 *>(vp);
...
static PyMethodDef PyvtkRungeKutta2_ComputeNextStep_Methods[] = {
  {"ComputeNextStep", PyvtkRungeKutta2_ComputeNextStep_s1, METH_VARARGS,
   "@PPddddv *d *d"},
  {"ComputeNextStep", PyvtkRungeKutta2_ComputeNextStep_s3, METH_VARARGS,
   "@PPdddddddv *d *d"},
  {"ComputeNextStep", PyvtkRungeKutta2_ComputeNextStep_s6, METH_VARARGS,
   "@PPPdddd *d *d *d"},
  {"ComputeNextStep", PyvtkRungeKutta2_ComputeNextStep_s8, METH_VARARGS,
   "@PPPddddddd *d *d *d"},
...
{
  PyMethodDef *methods = PyvtkRungeKutta2_ComputeNextStep_Methods;
  ...
  switch(nargs)
  {
    ...
    case 6:
      return PyvtkRungeKutta2_ComputeNextStep_s5(self, args);
    case 9:
      return PyvtkRungeKutta2_ComputeNextStep_s7(self, args);
    case 7:
    case 10:
...
static PyMethodDef PyvtkRungeKutta2_Methods[] = {
  {"IsTypeOf", PyvtkRungeKutta2_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkRungeKutta2_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkRungeKutta2_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkRungeKutta2\nC++: static vtkRungeKutta2 *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkRungeKutta2_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkRungeKutta2\nC++: vtkRungeKutta2 *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkRungeKutta2_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkRungeKutta2_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"ComputeNextStep", PyvtkRungeKutta2_ComputeNextStep, METH_VARARGS,
...
static PyTypeObject PyvtkRungeKutta2_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonMath.vtkRungeKutta2", // tp_name
...
PyObject *PyvtkRungeKutta2_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkRungeKutta2_Type, PyvtkRungeKutta2_Methods,
    "vtkRungeKutta2",
 &PyvtkRungeKutta2_StaticNew);
...
{
  PyObject *o;
  o = PyvtkRungeKutta2_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkRungeKutta2", o) != 0)
  {
    Py_DECREF(o);
  }
