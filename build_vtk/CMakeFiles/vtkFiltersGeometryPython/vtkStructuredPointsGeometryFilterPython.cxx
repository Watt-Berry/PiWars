...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkStructuredPointsGeometryFilter(PyObject *dict); }
extern "C" { PyObject *PyvtkStructuredPointsGeometryFilter_ClassNew(); }
...
static PyObject *
PyvtkStructuredPointsGeometryFilter_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkStructuredPointsGeometryFilter_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkStructuredPointsGeometryFilter_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkStructuredPointsGeometryFilter::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkStructuredPointsGeometryFilter_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkStructuredPointsGeometryFilter::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkStructuredPointsGeometryFilter_Methods[] = {
  ...
  {"SafeDownCast", PyvtkStructuredPointsGeometryFilter_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkStructuredPointsGeometryFilter\nC++: static vtkStructuredPointsGeometryFilter *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkStructuredPointsGeometryFilter_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkStructuredPointsGeometryFilter\nC++: vtkStructuredPointsGeometryFilter *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkStructuredPointsGeometryFilter_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkStructuredPointsGeometryFilter_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkStructuredPointsGeometryFilter_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkFiltersGeometry.vtkStructuredPointsGeometryFilter", // tp_name
