...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkAbstractPolyDataReader(PyObject *dict); }
extern "C" { PyObject *PyvtkAbstractPolyDataReader_ClassNew(); }


static PyObject *
PyvtkAbstractPolyDataReader_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkAbstractPolyDataReader_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkAbstractPolyDataReader_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkAbstractPolyDataReader::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkAbstractPolyDataReader_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkAbstractPolyDataReader::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkAbstractPolyDataReader_Methods[] = {
  ...
  {"SafeDownCast", PyvtkAbstractPolyDataReader_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkAbstractPolyDataReader\nC++: static vtkAbstractPolyDataReader *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkAbstractPolyDataReader_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkAbstractPolyDataReader\nC++: vtkAbstractPolyDataReader *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkAbstractPolyDataReader_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkAbstractPolyDataReader_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkAbstractPolyDataReader_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkIOCore.vtkAbstractPolyDataReader", // tp_name
