...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkTextCodec(PyObject *dict); }
extern "C" { PyObject *PyvtkTextCodec_ClassNew(); }


static PyObject *
PyvtkTextCodec_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkTextCodec_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkTextCodec_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkTextCodec::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkTextCodec_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkTextCodec::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkTextCodec_Methods[] = {
  ...
  {"SafeDownCast", PyvtkTextCodec_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkTextCodec\nC++: static vtkTextCodec *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkTextCodec_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkTextCodec\nC++: vtkTextCodec *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkTextCodec_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkTextCodec_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkTextCodec_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkIOCore.vtkTextCodec", // tp_name
