...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkMNIObjectReader(PyObject *dict); }
extern "C" { PyObject *PyvtkMNIObjectReader_ClassNew(); }


static PyObject *
PyvtkMNIObjectReader_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkMNIObjectReader::IsTypeOf(temp0);
...
PyvtkMNIObjectReader_IsA(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    int tempr = (ap.IsBound() ?
      op->IsA(temp0) :
      op->vtkMNIObjectReader::IsA(temp0));
...
static PyObject *
PyvtkMNIObjectReader_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
  ...
  {
    vtkMNIObjectReader *tempr = vtkMNIObjectReader::SafeDownCast(temp0);
...
PyvtkMNIObjectReader_NewInstance(PyObject *self, PyObject *args)
{
  ...
  {
    vtkMNIObjectReader *tempr = (ap.IsBound() ?
      op->NewInstance() :
      op->vtkMNIObjectReader::NewInstance());
...
static PyObject *
PyvtkMNIObjectReader_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkMNIObjectReader::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkMNIObjectReader_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkMNIObjectReader::GetNumberOfGenerationsFromBase(temp0));
...
PyvtkMNIObjectReader_GetFileName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    char *tempr = (ap.IsBound() ?
      op->GetFileName() :
      op->vtkMNIObjectReader::GetFileName());
...
PyvtkMNIObjectReader_GetFileExtensions(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    const char *tempr = (ap.IsBound() ?
      ...
      op->vtkMNIObjectReader::GetFileExtensions());
...
PyvtkMNIObjectReader_GetDescriptiveName(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    const char *tempr = (ap.IsBound() ?
      ...
      op->vtkMNIObjectReader::GetDescriptiveName());
...
PyvtkMNIObjectReader_CanReadFile(PyObject *self, PyObject *args)
{
      ...
      ap.GetFilePath(temp0))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkMNIObjectReader::CanReadFile(temp0));
...
PyvtkMNIObjectReader_GetProperty(PyObject *self, PyObject *args)
{
  ...
  if (op && ap.CheckArgCount(0))
  {
    vtkProperty *tempr = (ap.IsBound() ?
      op->GetProperty() :
      op->vtkMNIObjectReader::GetProperty());
...
static PyMethodDef PyvtkMNIObjectReader_Methods[] = {
  {"IsTypeOf", PyvtkMNIObjectReader_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkMNIObjectReader_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkMNIObjectReader_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkMNIObjectReader\nC++: static vtkMNIObjectReader *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkMNIObjectReader_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkMNIObjectReader\nC++: vtkMNIObjectReader *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkMNIObjectReader_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkMNIObjectReader_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SetFileName", PyvtkMNIObjectReader_SetFileName, METH_VARARGS,
   "SetFileName(self, _arg:str) -> None\nC++: virtual void SetFileName(const char *_arg)\n\nSet the file name.\n"},
  {"GetFileName", PyvtkMNIObjectReader_GetFileName, METH_VARARGS,
   "GetFileName(self) -> str\nC++: virtual char *GetFileName()\n\n"},
  {"GetFileExtensions", PyvtkMNIObjectReader_GetFileExtensions, METH_VARARGS,
   "GetFileExtensions(self) -> str\nC++: virtual const char *GetFileExtensions()\n\nGet the extension for this file format.\n"},
  {"GetDescriptiveName", PyvtkMNIObjectReader_GetDescriptiveName, METH_VARARGS,
   "GetDescriptiveName(self) -> str\nC++: virtual const char *GetDescriptiveName()\n\nGet the name of this file format.\n"},
  {"CanReadFile", PyvtkMNIObjectReader_CanReadFile, METH_VARARGS,
   "CanReadFile(self, name:str) -> int\nC++: virtual int CanReadFile(const char *name)\n\nTest whether the specified file can be read.\n"},
  {"GetProperty", PyvtkMNIObjectReader_GetProperty, METH_VARARGS,
...
static PyTypeObject PyvtkMNIObjectReader_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkIOMINC.vtkMNIObjectReader", // tp_name
  ...
  PyvtkMNIObjectReader_Doc, // tp_doc
...
PyObject *PyvtkMNIObjectReader_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkMNIObjectReader_Type, PyvtkMNIObjectReader_Methods,
    "vtkMNIObjectReader",
 &PyvtkMNIObjectReader_StaticNew);
...
{
  PyObject *o;
  o = PyvtkMNIObjectReader_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkMNIObjectReader", o) != 0)
  {
    Py_DECREF(o);
  }
