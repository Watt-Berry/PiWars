...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkMultiNewickTreeReader(PyObject *dict); }
extern "C" { PyObject *PyvtkMultiNewickTreeReader_ClassNew(); }


static PyObject *
PyvtkMultiNewickTreeReader_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkMultiNewickTreeReader_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkMultiNewickTreeReader_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkMultiNewickTreeReader::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkMultiNewickTreeReader_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkMultiNewickTreeReader::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkMultiNewickTreeReader_ReadMeshSimple(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp1, "vtkDataObject"))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkMultiNewickTreeReader::ReadMeshSimple(temp0, temp1));
...
static PyTypeObject PyvtkMultiNewickTreeReader_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkIOInfovis.vtkMultiNewickTreeReader", // tp_name
...
PyObject *PyvtkMultiNewickTreeReader_ClassNew()
{
 ...
 &PyvtkMultiNewickTreeReader_StaticNew);
  ...
  pytype->tp_base = vtkPythonUtil::FindBaseTypeObject("vtkDataReader");
