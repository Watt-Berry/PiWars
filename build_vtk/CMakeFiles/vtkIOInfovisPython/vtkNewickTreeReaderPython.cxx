...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkNewickTreeReader(PyObject *dict); }
extern "C" { PyObject *PyvtkNewickTreeReader_ClassNew(); }


static PyObject *
PyvtkNewickTreeReader_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkNewickTreeReader_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkNewickTreeReader_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkNewickTreeReader::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkNewickTreeReader_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkNewickTreeReader::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkNewickTreeReader_ReadMeshSimple(PyObject *self, PyObject *args)
{
      ...
      ap.GetVTKObject(temp1, "vtkDataObject"))
  {
    int tempr = (ap.IsBound() ?
      ...
      op->vtkNewickTreeReader::ReadMeshSimple(temp0, temp1));
...
static PyMethodDef PyvtkNewickTreeReader_Methods[] = {
  ...
  {"SafeDownCast", PyvtkNewickTreeReader_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkNewickTreeReader\nC++: static vtkNewickTreeReader *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkNewickTreeReader_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkNewickTreeReader\nC++: vtkNewickTreeReader *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkNewickTreeReader_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkNewickTreeReader_GetNumberOfGenerationsFromBase, METH_VARARGS,
  ...
  {"ReadNewickTree", PyvtkNewickTreeReader_ReadNewickTree, METH_VARARGS,
   "ReadNewickTree(self, buffer:str, tree:vtkTree) -> int\nC++: int ReadNewickTree(const char *buffer, vtkTree &tree)\n\n"},
  {"ReadMeshSimple", PyvtkNewickTreeReader_ReadMeshSimple, METH_VARARGS,
...
static PyTypeObject PyvtkNewickTreeReader_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkIOInfovis.vtkNewickTreeReader", // tp_name
