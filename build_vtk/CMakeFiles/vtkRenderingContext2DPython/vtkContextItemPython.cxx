...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkContextItem(PyObject *dict); }
...
static PyObject *
PyvtkContextItem_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkContextItem::IsTypeOf(temp0);
...
static PyObject *
PyvtkContextItem_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkContextItem_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkContextItem::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkContextItem_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkContextItem::GetNumberOfGenerationsFromBase(temp0));
...
static PyObject *
PyvtkContextItem_SetTransform(PyObject *self, PyObject *args)
{
  vtkPythonArgs ap(self, args, "SetTransform");
  vtkObjectBase *vp = ap.GetSelfPointer(self, args);
  vtkContextItem *op = static_cast<vtkContextItem *>(vp);

  vtkContextTransform *temp0 = nullptr;
  PyObject *result = nullptr;

  if (op && ap.CheckArgCount(1) &&
      ap.GetVTKObject(temp0, "vtkContextTransform"))
  {
    if (ap.IsBound())
    {
    ...
    {
      op->vtkContextItem::SetTransform(temp0);
    }
...
static PyTypeObject PyvtkContextItem_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkRenderingContext2D.vtkContextItem", // tp_name
...
PyObject *PyvtkContextItem_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkContextItem_Type, PyvtkContextItem_Methods,
    "vtkContextItem",
 nullptr);
...
{
  PyObject *o;
  o = PyvtkContextItem_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkContextItem", o) != 0)
  {
    Py_DECREF(o);
  }
