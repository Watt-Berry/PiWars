...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkTransmitStructuredGridPiece(PyObject *dict); }
extern "C" { PyObject *PyvtkTransmitStructuredGridPiece_ClassNew(); }
...
static PyObject *
PyvtkTransmitStructuredGridPiece_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkTransmitStructuredGridPiece_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkTransmitStructuredGridPiece_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkTransmitStructuredGridPiece::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkTransmitStructuredGridPiece_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkTransmitStructuredGridPiece::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkTransmitStructuredGridPiece_Methods[] = {
  ...
  {"SafeDownCast", PyvtkTransmitStructuredGridPiece_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkTransmitStructuredGridPiece\nC++: static vtkTransmitStructuredGridPiece *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkTransmitStructuredGridPiece_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkTransmitStructuredGridPiece\nC++: vtkTransmitStructuredGridPiece *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkTransmitStructuredGridPiece_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkTransmitStructuredGridPiece_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkTransmitStructuredGridPiece_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkFiltersParallel.vtkTransmitStructuredGridPiece", // tp_name
