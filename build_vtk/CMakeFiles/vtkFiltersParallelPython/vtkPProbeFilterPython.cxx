...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkPProbeFilter(PyObject *dict); }
extern "C" { PyObject *PyvtkPProbeFilter_ClassNew(); }


static PyObject *
PyvtkPProbeFilter_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPProbeFilter_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPProbeFilter_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkPProbeFilter::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkPProbeFilter_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkPProbeFilter::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkPProbeFilter_Methods[] = {
  ...
  {"SafeDownCast", PyvtkPProbeFilter_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkPProbeFilter\nC++: static vtkPProbeFilter *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkPProbeFilter_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkPProbeFilter\nC++: vtkPProbeFilter *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkPProbeFilter_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkPProbeFilter_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkPProbeFilter_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkFiltersParallel.vtkPProbeFilter", // tp_name
...
PyObject *PyvtkPProbeFilter_ClassNew()
{
 ...
 &PyvtkPProbeFilter_StaticNew);
  ...
  pytype->tp_base = vtkPythonUtil::FindBaseTypeObject("vtkCompositeDataProbeFilter");
