...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkPExtractDataArraysOverTime(PyObject *dict); }
extern "C" { PyObject *PyvtkPExtractDataArraysOverTime_ClassNew(); }


static PyObject *
PyvtkPExtractDataArraysOverTime_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPExtractDataArraysOverTime_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPExtractDataArraysOverTime_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkPExtractDataArraysOverTime::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkPExtractDataArraysOverTime_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkPExtractDataArraysOverTime::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkPExtractDataArraysOverTime_Methods[] = {
  ...
  {"SafeDownCast", PyvtkPExtractDataArraysOverTime_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkPExtractDataArraysOverTime\nC++: static vtkPExtractDataArraysOverTime *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkPExtractDataArraysOverTime_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkPExtractDataArraysOverTime\nC++: vtkPExtractDataArraysOverTime *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkPExtractDataArraysOverTime_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkPExtractDataArraysOverTime_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static const char *PyvtkPExtractDataArraysOverTime_Doc =
  ...
  "rank=<rank num>to each of the block names, as appropriate. In future,\n"
  "we plan to fix this to correctly compute stats in parallel for each\n"
  "block.\n\n";
...
static PyTypeObject PyvtkPExtractDataArraysOverTime_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkFiltersParallel.vtkPExtractDataArraysOverTime", // tp_name
...
PyObject *PyvtkPExtractDataArraysOverTime_ClassNew()
{
 ...
 &PyvtkPExtractDataArraysOverTime_StaticNew);
  ...
  pytype->tp_base = vtkPythonUtil::FindBaseTypeObject("vtkExtractDataArraysOverTime");
