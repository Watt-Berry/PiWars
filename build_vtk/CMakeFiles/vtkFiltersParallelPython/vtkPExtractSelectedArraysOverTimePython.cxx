...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkPExtractSelectedArraysOverTime(PyObject *dict); }
extern "C" { PyObject *PyvtkPExtractSelectedArraysOverTime_ClassNew(); }


static PyObject *
PyvtkPExtractSelectedArraysOverTime_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPExtractSelectedArraysOverTime_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPExtractSelectedArraysOverTime_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkPExtractSelectedArraysOverTime::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkPExtractSelectedArraysOverTime_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkPExtractSelectedArraysOverTime::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkPExtractSelectedArraysOverTime_Methods[] = {
  ...
  {"SafeDownCast", PyvtkPExtractSelectedArraysOverTime_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkPExtractSelectedArraysOverTime\nC++: static vtkPExtractSelectedArraysOverTime *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkPExtractSelectedArraysOverTime_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkPExtractSelectedArraysOverTime\nC++: vtkPExtractSelectedArraysOverTime *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkPExtractSelectedArraysOverTime_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkPExtractSelectedArraysOverTime_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkPExtractSelectedArraysOverTime_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkFiltersParallel.vtkPExtractSelectedArraysOverTime", // tp_name
...
PyObject *PyvtkPExtractSelectedArraysOverTime_ClassNew()
{
 ...
 &PyvtkPExtractSelectedArraysOverTime_StaticNew);
  ...
  pytype->tp_base = vtkPythonUtil::FindBaseTypeObject("vtkExtractSelectedArraysOverTime");
