...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkPMaskPoints(PyObject *dict); }
extern "C" { PyObject *PyvtkPMaskPoints_ClassNew(); }


static PyObject *
PyvtkPMaskPoints_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPMaskPoints_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkPMaskPoints_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkPMaskPoints::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkPMaskPoints_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkPMaskPoints::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkPMaskPoints_Methods[] = {
  ...
  {"SafeDownCast", PyvtkPMaskPoints_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkPMaskPoints\nC++: static vtkPMaskPoints *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkPMaskPoints_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkPMaskPoints\nC++: vtkPMaskPoints *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkPMaskPoints_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkPMaskPoints_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkPMaskPoints_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkFiltersParallel.vtkPMaskPoints", // tp_name
...
PyObject *PyvtkPMaskPoints_ClassNew()
{
 ...
 &PyvtkPMaskPoints_StaticNew);
  ...
  pytype->tp_base = vtkPythonUtil::FindBaseTypeObject("vtkMaskPoints");
