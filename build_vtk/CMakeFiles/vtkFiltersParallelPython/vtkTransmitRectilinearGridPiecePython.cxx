...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkTransmitRectilinearGridPiece(PyObject *dict); }
extern "C" { PyObject *PyvtkTransmitRectilinearGridPiece_ClassNew(); }
...
static PyObject *
PyvtkTransmitRectilinearGridPiece_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkTransmitRectilinearGridPiece_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkTransmitRectilinearGridPiece_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkTransmitRectilinearGridPiece::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkTransmitRectilinearGridPiece_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkTransmitRectilinearGridPiece::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkTransmitRectilinearGridPiece_Methods[] = {
  ...
  {"SafeDownCast", PyvtkTransmitRectilinearGridPiece_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkTransmitRectilinearGridPiece\nC++: static vtkTransmitRectilinearGridPiece *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkTransmitRectilinearGridPiece_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkTransmitRectilinearGridPiece\nC++: vtkTransmitRectilinearGridPiece *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkTransmitRectilinearGridPiece_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkTransmitRectilinearGridPiece_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkTransmitRectilinearGridPiece_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkFiltersParallel.vtkTransmitRectilinearGridPiece", // tp_name
