...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkMultiBlockDataSetAlgorithm(PyObject *dict); }
...
static PyObject *
PyvtkMultiBlockDataSetAlgorithm_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkMultiBlockDataSetAlgorithm::IsTypeOf(temp0);
...
static PyObject *
PyvtkMultiBlockDataSetAlgorithm_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkMultiBlockDataSetAlgorithm_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkMultiBlockDataSetAlgorithm::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkMultiBlockDataSetAlgorithm_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkMultiBlockDataSetAlgorithm::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkMultiBlockDataSetAlgorithm_Methods[] = {
  {"IsTypeOf", PyvtkMultiBlockDataSetAlgorithm_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkMultiBlockDataSetAlgorithm_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkMultiBlockDataSetAlgorithm_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkMultiBlockDataSetAlgorithm\nC++: static vtkMultiBlockDataSetAlgorithm *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkMultiBlockDataSetAlgorithm_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkMultiBlockDataSetAlgorithm\nC++: vtkMultiBlockDataSetAlgorithm *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkMultiBlockDataSetAlgorithm_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkMultiBlockDataSetAlgorithm_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetOutput", PyvtkMultiBlockDataSetAlgorithm_GetOutput, METH_VARARGS,
  ...
  {"SetInputData", PyvtkMultiBlockDataSetAlgorithm_SetInputData, METH_VARARGS,
...
static PyTypeObject PyvtkMultiBlockDataSetAlgorithm_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonExecutionModel.vtkMultiBlockDataSetAlgorithm", // tp_name
  ...
  PyvtkMultiBlockDataSetAlgorithm_Doc, // tp_doc
...
PyObject *PyvtkMultiBlockDataSetAlgorithm_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkMultiBlockDataSetAlgorithm_Type, PyvtkMultiBlockDataSetAlgorithm_Methods,
    "vtkMultiBlockDataSetAlgorithm",
 &PyvtkMultiBlockDataSetAlgorithm_StaticNew);
...
{
  PyObject *o;
  o = PyvtkMultiBlockDataSetAlgorithm_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkMultiBlockDataSetAlgorithm", o) != 0)
  {
    Py_DECREF(o);
  }
