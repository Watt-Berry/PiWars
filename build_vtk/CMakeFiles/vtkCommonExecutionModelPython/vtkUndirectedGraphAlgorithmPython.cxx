...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkUndirectedGraphAlgorithm(PyObject *dict); }
...
static PyObject *
PyvtkUndirectedGraphAlgorithm_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkUndirectedGraphAlgorithm::IsTypeOf(temp0);
...
static PyObject *
PyvtkUndirectedGraphAlgorithm_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkUndirectedGraphAlgorithm_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkUndirectedGraphAlgorithm::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkUndirectedGraphAlgorithm_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkUndirectedGraphAlgorithm::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkUndirectedGraphAlgorithm_Methods[] = {
  {"IsTypeOf", PyvtkUndirectedGraphAlgorithm_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkUndirectedGraphAlgorithm_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkUndirectedGraphAlgorithm_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkUndirectedGraphAlgorithm\nC++: static vtkUndirectedGraphAlgorithm *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkUndirectedGraphAlgorithm_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkUndirectedGraphAlgorithm\nC++: vtkUndirectedGraphAlgorithm *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkUndirectedGraphAlgorithm_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkUndirectedGraphAlgorithm_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetOutput", PyvtkUndirectedGraphAlgorithm_GetOutput, METH_VARARGS,
   "GetOutput(self) -> vtkUndirectedGraph\nC++: vtkUndirectedGraph *GetOutput()\nGetOutput(self, index:int) -> vtkUndirectedGraph\nC++: vtkUndirectedGraph *GetOutput(int index)\n\nGet the output data object for a port on this algorithm.\n"},
  {"SetInputData", PyvtkUndirectedGraphAlgorithm_SetInputData, METH_VARARGS,
   "SetInputData(self, obj:vtkDataObject) -> None\nC++: void SetInputData(vtkDataObject *obj)\nSetInputData(self, index:int, obj:vtkDataObject) -> None\nC++: void SetInputData(int index, vtkDataObject *obj)\n\nAssign a data object as input. Note that this method does not\nestablish a pipeline connection. Use SetInputConnection() to\nsetup a pipeline connection.\n"},
...
static PyTypeObject PyvtkUndirectedGraphAlgorithm_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonExecutionModel.vtkUndirectedGraphAlgorithm", // tp_name
  ...
  PyvtkUndirectedGraphAlgorithm_Doc, // tp_doc
...
PyObject *PyvtkUndirectedGraphAlgorithm_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkUndirectedGraphAlgorithm_Type, PyvtkUndirectedGraphAlgorithm_Methods,
    "vtkUndirectedGraphAlgorithm",
 &PyvtkUndirectedGraphAlgorithm_StaticNew);
...
{
  PyObject *o;
  o = PyvtkUndirectedGraphAlgorithm_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkUndirectedGraphAlgorithm", o) != 0)
  {
    Py_DECREF(o);
  }
