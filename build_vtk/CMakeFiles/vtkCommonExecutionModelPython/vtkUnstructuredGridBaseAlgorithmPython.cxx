...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkUnstructuredGridBaseAlgorithm(PyObject *dict); }
...
static PyObject *
PyvtkUnstructuredGridBaseAlgorithm_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkUnstructuredGridBaseAlgorithm_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkUnstructuredGridBaseAlgorithm_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkUnstructuredGridBaseAlgorithm::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkUnstructuredGridBaseAlgorithm_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkUnstructuredGridBaseAlgorithm::GetNumberOfGenerationsFromBase(temp0));
...
static PyTypeObject PyvtkUnstructuredGridBaseAlgorithm_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkCommonExecutionModel.vtkUnstructuredGridBaseAlgorithm", // tp_name
