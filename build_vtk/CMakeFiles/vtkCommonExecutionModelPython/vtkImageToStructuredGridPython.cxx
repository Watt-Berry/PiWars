...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkImageToStructuredGrid(PyObject *dict); }
extern "C" { PyObject *PyvtkImageToStructuredGrid_ClassNew(); }
...
static PyObject *
PyvtkImageToStructuredGrid_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkImageToStructuredGrid_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkImageToStructuredGrid_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkImageToStructuredGrid::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkImageToStructuredGrid_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkImageToStructuredGrid::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkImageToStructuredGrid_Methods[] = {
  ...
  {"SafeDownCast", PyvtkImageToStructuredGrid_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkImageToStructuredGrid\nC++: static vtkImageToStructuredGrid *SafeDownCast(\n    vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkImageToStructuredGrid_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkImageToStructuredGrid\nC++: vtkImageToStructuredGrid *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkImageToStructuredGrid_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkImageToStructuredGrid_GetNumberOfGenerationsFromBase, METH_VARARGS,
...
static PyTypeObject PyvtkImageToStructuredGrid_Type = {
  ...
  PYTHON_PACKAGE_SCOPE "vtkCommonExecutionModel.vtkImageToStructuredGrid", // tp_name
