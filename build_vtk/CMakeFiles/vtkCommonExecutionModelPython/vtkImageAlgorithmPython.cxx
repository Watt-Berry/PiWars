...
extern "C" { VTK_ABI_EXPORT void PyVTKAddFile_vtkImageAlgorithm(PyObject *dict); }
...
static PyObject *
PyvtkImageAlgorithm_IsTypeOf(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    int tempr = vtkImageAlgorithm::IsTypeOf(temp0);
...
static PyObject *
PyvtkImageAlgorithm_SafeDownCast(PyObject * /*unused*/, PyObject *args)
{
...
static PyObject *
PyvtkImageAlgorithm_GetNumberOfGenerationsFromBaseType(PyObject * /*unused*/, PyObject *args)
{
  ...
  if (ap.CheckArgCount(1) &&
      ap.GetValue(temp0))
  {
    long long tempr = vtkImageAlgorithm::GetNumberOfGenerationsFromBaseType(temp0);
...
static PyObject *
PyvtkImageAlgorithm_GetNumberOfGenerationsFromBase(PyObject *self, PyObject *args)
{
      ...
      ap.GetValue(temp0))
  {
    long long tempr = (ap.IsBound() ?
      ...
      op->vtkImageAlgorithm::GetNumberOfGenerationsFromBase(temp0));
...
static PyMethodDef PyvtkImageAlgorithm_Methods[] = {
  {"IsTypeOf", PyvtkImageAlgorithm_IsTypeOf, METH_VARARGS,
   "IsTypeOf(type:str) -> int\nC++: static vtkTypeBool IsTypeOf(const char *type)\n\nReturn 1 if this class type is the same type of (or a subclass\nof) the named class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"IsA", PyvtkImageAlgorithm_IsA, METH_VARARGS,
   "IsA(self, type:str) -> int\nC++: vtkTypeBool IsA(const char *type) override;\n\nReturn 1 if this class is the same type of (or a subclass of) the\nnamed class. Returns 0 otherwise. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"SafeDownCast", PyvtkImageAlgorithm_SafeDownCast, METH_VARARGS,
   "SafeDownCast(o:vtkObjectBase) -> vtkImageAlgorithm\nC++: static vtkImageAlgorithm *SafeDownCast(vtkObjectBase *o)\n\n"},
  {"NewInstance", PyvtkImageAlgorithm_NewInstance, METH_VARARGS,
   "NewInstance(self) -> vtkImageAlgorithm\nC++: vtkImageAlgorithm *NewInstance()\n\n"},
  {"GetNumberOfGenerationsFromBaseType", PyvtkImageAlgorithm_GetNumberOfGenerationsFromBaseType, METH_VARARGS,
   "GetNumberOfGenerationsFromBaseType(type:str) -> int\nC++: static vtkIdType GetNumberOfGenerationsFromBaseType(\n    const char *type)\n\nGiven a the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetNumberOfGenerationsFromBase", PyvtkImageAlgorithm_GetNumberOfGenerationsFromBase, METH_VARARGS,
   "GetNumberOfGenerationsFromBase(self, type:str) -> int\nC++: vtkIdType GetNumberOfGenerationsFromBase(const char *type)\n    override;\n\nGiven the name of a base class of this class type, return the\ndistance of inheritance between this class type and the named\nclass (how many generations of inheritance are there between this\nclass and the named class). If the named class is not in this\nclass's inheritance tree, return a negative value. Valid\nresponses will always be nonnegative. This method works in\ncombination with vtkTypeMacro found in vtkSetGet.h.\n"},
  {"GetOutput", PyvtkImageAlgorithm_GetOutput, METH_VARARGS,
   "GetOutput(self) -> vtkImageData\nC++: vtkImageData *GetOutput()\nGetOutput(self, __a:int) -> vtkImageData\nC++: vtkImageData *GetOutput(int)\n\nGet the output data object for a port on this algorithm.\n"},
  {"SetOutput", PyvtkImageAlgorithm_SetOutput, METH_VARARGS,
   "SetOutput(self, d:vtkDataObject) -> None\nC++: virtual void SetOutput(vtkDataObject *d)\n\n"},
  {"SetInputData", PyvtkImageAlgorithm_SetInputData, METH_VARARGS,
  ...
  {"GetInput", PyvtkImageAlgorithm_GetInput, METH_VARARGS,
  ...
  {"GetImageDataInput", PyvtkImageAlgorithm_GetImageDataInput, METH_VARARGS,
   "GetImageDataInput(self, port:int) -> vtkImageData\nC++: vtkImageData *GetImageDataInput(int port)\n\n"},
  {"AddInputData", PyvtkImageAlgorithm_AddInputData, METH_VARARGS,
...
static PyTypeObject PyvtkImageAlgorithm_Type = {
  PyVarObject_HEAD_INIT(&PyType_Type, 0)
  PYTHON_PACKAGE_SCOPE "vtkCommonExecutionModel.vtkImageAlgorithm", // tp_name
  ...
  PyvtkImageAlgorithm_Doc, // tp_doc
...
PyObject *PyvtkImageAlgorithm_ClassNew()
{
  PyTypeObject *pytype = PyVTKClass_Add(
    &PyvtkImageAlgorithm_Type, PyvtkImageAlgorithm_Methods,
    "vtkImageAlgorithm",
 nullptr);
...
{
  PyObject *o;
  o = PyvtkImageAlgorithm_ClassNew();

  if (o && PyDict_SetItemString(dict, "vtkImageAlgorithm", o) != 0)
  {
    Py_DECREF(o);
  }
